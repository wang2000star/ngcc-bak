...
/*************************************************
* Name:        litchi_512_init
*
* Description: Litchi-512 Initilizes
*
* Arguments:   - litchi_state *state: pointer to (uninitialized) state
**************************************************/
void litchi_512_init(litchi_state* state)
{
    litchi_init(state, 576, 0);
}

/*************************************************
* Name:        litchi_512_absorb
*
* Description: Absorb step of the litchi_512.
*
...
/*************************************************
* Name:        litchi_512_finalize
*
* Description: Finalize absorb step of the litchi_512.
*
* Arguments:   - litchi_state *state: pointer to state
**************************************************/
...
/*************************************************
* Name:        litchi_512_squeeze
*
* Description: Squeeze step of litchi_512. Squeezes 64
...
* Name:        litchi_512
*
* Description: litchi-512 with non-incremental API
*
...
void litchi_512(uint8_t h[64], const uint8_t* in, uint64_t inlen)
{
    ...
    litchi_512_init(&state);
    litchi_512_absorb(&state, in, inlen);
    litchi_512_finalize(&state);
    litchi_512_squeeze(h, 64, &state);
}
