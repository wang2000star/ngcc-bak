...
/*************************************************
* Name:        litchi_1024_init
*
* Description: Litchi-1024 Initilizes
*
* Arguments:   - litchi_state *state: pointer to (uninitialized) state
**************************************************/
void litchi_1024_init(litchi_state* state)
{
    litchi_init(state, 1088, 0);
}

/*************************************************
* Name:        litchi_1024_absorb
*
* Description: Absorb step of the litchi_1024.
*
...
/*************************************************
* Name:        litchi_1024_finalize
*
* Description: Finalize absorb step of the litchi_1024.
*
* Arguments:   - litchi_state *state: pointer to state
**************************************************/
...
/*************************************************
* Name:        litchi_1024_squeeze
*
* Description: Squeeze step of litchi_1024. Squeezes 128
...
void litchi_1024(uint8_t h[128], const uint8_t* in, uint64_t inlen)
{
    ...
    litchi_1024_absorb(&state, in, inlen);
    litchi_1024_finalize(&state);
    litchi_1024_squeeze(h, 128, &state);
}