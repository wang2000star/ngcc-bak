...
static inline void sbox128_avx512(__m128i *in0, __m128i *in1, __m128i *in2, __m128i *in3) {
    ...
    // __m128i out3 = _mm_ternarylogic_epi64(*in3, *in2, *in1, 0x78); // in1 ^ (in3 & in2)
    // __m128i out1 = _mm_ternarylogic_epi64(*in2, *in1, *in0, 0x1e); // in0 ^ (in2 | in1)
    // __m128i out0 = _mm_ternarylogic_epi64(out3, *in0, *in3, 0x78); // in3 ^ (out3 & in0)
    // __m128i out2 = _mm_ternarylogic_epi64(out1, *in3, *in2, 0x78); // in2 ^ (out1 & in3)
