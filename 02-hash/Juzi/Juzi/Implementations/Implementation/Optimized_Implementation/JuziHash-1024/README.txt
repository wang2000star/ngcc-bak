JuziHash-1024 optimized AVX2 implementation, GCC/Linux version

This folder contains the ICCS CryptHash API implementation and KAT generator for
JuziHash-1024.  Windows batch files have been removed; use the Makefile or the shell
script on Linux.
...
Compiler flags:
  ...
  gcc -std=c99 -O3 -mavx2 -Wall -Wextra

Requires an AVX2-capable x86-64 processor.
...
For this instance, digest_len_bits must be 1024.
