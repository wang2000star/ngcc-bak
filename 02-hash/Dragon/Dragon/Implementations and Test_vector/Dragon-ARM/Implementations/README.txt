Dragon ARM Implementations
==========================

This directory contains the ARM implementations of the Dragon hash family.
...
Implementations/
  ...
  Optimized_Implementation/
    Performance-optimized ARM implementations of the fixed-output Dragon hash
    instances.
  ...
  Additional_Implementation/
    Resource-optimized ARM implementations of the fixed-output Dragon hash
    instances.
