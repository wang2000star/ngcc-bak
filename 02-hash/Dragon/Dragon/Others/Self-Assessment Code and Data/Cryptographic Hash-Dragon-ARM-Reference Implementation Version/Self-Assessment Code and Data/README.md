...
~~~~bash
cd Dragon_ARM64/API_CryptHash/Implementations/Reference_Implementation/Dragon512
sh build.sh
~~~~
...
~~~~bash
./ngcc_bench \
  --lib ../../Dragon_ARM64/API_CryptHash/Implementations/Reference_Implementation/Dragon512/libDragon512ref.so \
  --test hash \
  --mode all \
  --digest-len-bits 512 \
  --kat ../../Dragon_ARM64/API_CryptHash/Test_Vector/Dragon512 \
  --json-out Dragon512ref_A64_report.json
~~~~
