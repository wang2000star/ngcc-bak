...
~~~~bash
cd Dragon_X86/API_CryptHash/Implementations/Optimized_Implementation/Dragon512
sh build.sh
~~~~
...
~~~~bash
./ngcc_bench \
  --lib ../../Dragon_X86/API_CryptHash/Implementations/Optimized_Implementation/Dragon512/libDragon512Opt.so \
  --test hash \
  --mode all \
  --digest-len-bits 512 \
  --kat ../../Dragon_X86/API_CryptHash/Test_Vector/Dragon512 \
  --json-out Dragon512opt_X86_report.json
~~~~
