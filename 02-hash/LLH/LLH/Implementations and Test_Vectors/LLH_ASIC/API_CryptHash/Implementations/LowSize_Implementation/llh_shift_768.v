...
//wire [191:0] dout_tmp = {din[95:0], din[95:0]} >> (96 - shift_num);
//assign dout = dout_tmp[127:0]; // 96bit循环左移
    assign dout = {
        din[127:96], // 高 32 位不变
        (din[95:0] << shift_num) | (din[95:0] >> (96 - shift_num))};
