...
#define W 96
#define LLH_W96_USE_BLOCK_LOOP_REGPIN 1

#define hash_init llh_hash_init
#define hash_absorb llh_hash_absorb
#define hash_final llh_hash_final
#define hash llh_hash
#define hash_absorb_i2 llh_hash_absorb_i2
#define hash_final_i2 llh_hash_final_i2
#define hash_i2 llh_hash_i2
#include "llh_core.c"
              ...
              unsigned char *digest)
{
...

    {
        ...
        if (full_bytes > 0U) {
            hash_absorb_i2(&ctx, msg, full_bytes);
        }
        ...
        hash_absorb_i2(&ctx, &last_byte, 1);
        hash_final_i2(&ctx, digest);
    }
