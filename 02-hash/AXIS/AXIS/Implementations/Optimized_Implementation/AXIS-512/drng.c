...
#define PUT32(a, b) ((a)[0] = (unsigned char)((b) >> 24), \
                     ...
                     (a)[3] = (unsigned char)(b))
/* Function: sm3_bit_init. Initializes the SM3 chaining state used by the ICCS deterministic random number generator. */
...
/* Function: sm3_bit_compress. Applies the SM3 compression function to a sequence of complete 512-bit blocks. */
...
/* Function: sm3_bit. Computes an SM3 digest for a bit-string input used by the deterministic random generator. */
...
/* Function: u32_to_u8_big_endian. Stores 32-bit words as big-endian bytes. */
...
/* Function: inc_Big_Number. Increments a big-endian byte-array counter by one. */
...
/* Function: plus_Big_Number. Adds two big-endian byte arrays and stores the bounded big-number result. */
...
/* Function: SM3_df. Implements the SM3-based derivation function used to expand entropy input for the DRNG. */
...
/* Function: SM3_DRNG_Instantiate. Initializes the SM3 DRNG state from entropy input, nonce, and personalization data. */
...
/* Function: SM3_DRNG_Generate. Generates pseudorandom bytes from the SM3 DRNG state and advances the internal counter. */
...
/* Function: init_random_number. Initializes the KAT random-number context with the supplied seed. */
...
/* Function: get_random_number. Fills a caller buffer with deterministic random bytes for KAT message generation. */
