...
CryptHash:
	...
	movq	%r12, %rdi
	vmovdqu	64(%rbx), %xmm4
	vpxor	32(%rsp), %ymm7, %ymm1
	vpxor	64(%rsp), %ymm2, %ymm3
	vpxor	96(%rsp), %xmm4, %xmm5
	vmovdqa	%ymm1, 32(%rsp)
	vmovdqa	%ymm3, 64(%rsp)
	vmovdqa	%xmm5, 96(%rsp)
...
.L97:
	...
	vmovdqu	(%rbx), %ymm6
	vmovdqu	32(%rbx), %ymm9
	vmovdqu	64(%rbx), %xmm11
	vpxor	32(%rsp), %ymm6, %ymm8
	vpxor	64(%rsp), %ymm9, %ymm10
	vpxor	96(%rsp), %xmm11, %xmm12
	vmovdqa	%ymm8, 32(%rsp)
...
.L96:
	...
	movq	%r12, %rdi
	vmovdqu	(%rbx), %ymm13
	vmovdqu	32(%rbx), %ymm15
	vmovdqu	64(%rbx), %xmm7
	vpxor	32(%rsp), %ymm13, %ymm14
	vpxor	64(%rsp), %ymm15, %ymm0
	vpxor	96(%rsp), %xmm7, %xmm1
...
.L45:
	...
	vmovdqu	32(%rbx), %ymm4
	vmovdqu	64(%rbx), %xmm6
	vpxor	64(%rsp), %ymm4, %ymm5
	vpxor	96(%rsp), %xmm6, %xmm8
	vmovdqu	(%rbx), %ymm2
	vpxor	32(%rsp), %ymm2, %ymm3
	vmovdqa	%ymm5, 64(%rsp)
	vmovdqa	%xmm8, 96(%rsp)
	vmovdqa	%ymm3, 32(%rsp)
	call	XRH_dmc_permute
	vmovdqu	120(%rbx), %ymm11
	movq	%r12, %rdi
	movq	168(%rbx), %r11
	xorq	%r11, 112(%rsp)
	vmovdqu	152(%rbx), %xmm13
	vmovdqu	88(%rbx), %ymm9
	vpxor	64(%rsp), %ymm11, %ymm12
	vpxor	32(%rsp), %ymm9, %ymm10
	vpxor	96(%rsp), %xmm13, %xmm14
	...
	movq	256(%rbx), %rcx
	xorq	%rcx, 112(%rsp)
	vmovdqu	176(%rbx), %ymm15
	vmovdqu	208(%rbx), %ymm7
	movq	%r12, %rdi
	vmovdqu	240(%rbx), %xmm2
	vpxor	32(%rsp), %ymm15, %ymm0
	vpxor	64(%rsp), %ymm7, %ymm1
	vpxor	96(%rsp), %xmm2, %xmm3
	vmovdqa	%ymm0, 32(%rsp)
	vmovdqa	%ymm1, 64(%rsp)
	vmovdqa	%xmm3, 96(%rsp)
	call	XRH_dmc_permute
	movq	344(%rbx), %rax
	xorq	%rax, 112(%rsp)
	vmovdqu	264(%rbx), %ymm4
	vmovdqu	296(%rbx), %ymm6
	movq	%r12, %rdi
	vmovdqu	328(%rbx), %xmm9
	vpxor	32(%rsp), %ymm4, %ymm5
	vpxor	64(%rsp), %ymm6, %ymm8
	vpxor	96(%rsp), %xmm9, %xmm10
	vmovdqa	%ymm5, 32(%rsp)
	vmovdqa	%ymm8, 64(%rsp)
...
.L44:
	...
	vpxor	64(%rsp), %ymm14, %ymm15
	vmovdqa	.LC41(%rip), %ymm13
