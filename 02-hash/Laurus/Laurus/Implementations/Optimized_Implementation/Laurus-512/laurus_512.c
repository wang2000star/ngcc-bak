...
/*************************************************
* Name:        laurus_512_init
*
* Description: Laurus-512 Initilizes
*
* Arguments:   - laurus_state *state: pointer to (uninitialized) state
**************************************************/
void laurus_512_init(laurus_state* state)
{
    laurus_init(state, 512, 0);
}

/*************************************************
* Name:        laurus_512_absorb
*
* Description: Absorb step of the laurus_512.
*
...
/*************************************************
* Name:        laurus_512_finalize
*
* Description: Finalize absorb step of the laurus_512.
*
* Arguments:   - laurus_state *state: pointer to state
**************************************************/
...
/*************************************************
* Name:        laurus_512_squeeze
*
* Description: Squeeze step of laurus_512. Squeezes 64
...
* Name:        laurus_512
*
* Description: laurus-512 with non-incremental API
*
...
void laurus_512(uint8_t h[64], const uint8_t* in, uint64_t inlen)
{
    ...
    laurus_512_init(&state);
    laurus_512_absorb(&state, in, inlen);
    laurus_512_finalize(&state);
    laurus_512_squeeze(h, 64, &state);
}