...
/*************************************************
* Name:        laurus_768_init
*
* Description: Laurus-768 Initilizes
*
* Arguments:   - laurus_state *state: pointer to (uninitialized) state
**************************************************/
void laurus_768_init(laurus_state* state)
{
    laurus_init(state, 768, 0);
}

/*************************************************
* Name:        laurus_768_absorb
*
* Description: Absorb step of the laurus_768.
*
...
/*************************************************
* Name:        laurus_768_finalize
*
* Description: Finalize absorb step of the laurus_768.
*
* Arguments:   - laurus_state *state: pointer to state
**************************************************/
...
/*************************************************
* Name:        laurus_768_squeeze
*
* Description: Squeeze step of laurus_768. Squeezes 96
...
void laurus_768(uint8_t h[96], const uint8_t* in, uint64_t inlen)
{
    ...
    laurus_768_absorb(&state, in, inlen);
    laurus_768_finalize(&state);
    laurus_768_squeeze(h, 96, &state);
}