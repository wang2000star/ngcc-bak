...
{
    laurus_init(state, 512, 1);
}

/*************************************************
* Name:        laurus_xof_absorb
*
* Description: Absorb step of the laurus_xof.
*
...
/*************************************************
* Name:        laurus_xof_finalize
*
* Description: Finalize absorb step of the laurus_xof.
*
* Arguments:   - laurus_state *state: pointer to state
**************************************************/
...
/*************************************************
* Name:        laurus_xof_squeezeblocks
*
* Description: Squeeze step of XOF. Squeezes full blocks of
*              laurus_512_RATE bytes each. Can be called multiple times
...
*                                 (written to output)
*              - laurus_state *s: pointer to input/output  state
**************************************************/
void laurus_xof_squeezeblocks(uint8_t* out, int nblocks, laurus_state* state)
{
    laurus_squeezeblocks(out, nblocks, state);
}

/*************************************************
* Name:        laurus_xof_squeeze
*
* Description: Squeeze step of laurus_xof XOF. Squeezes arbitraily many
...
void laurus_xof(uint8_t* out, uint64_t outlen, const uint8_t* in, uint64_t inlen)
{
    ...
    laurus_xof_absorb(&state, in, inlen);
    laurus_xof_finalize(&state);
    laurus_xof_squeeze(out, outlen, &state);
}