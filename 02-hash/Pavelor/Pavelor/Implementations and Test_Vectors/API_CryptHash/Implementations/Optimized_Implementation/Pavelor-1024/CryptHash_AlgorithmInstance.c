/*
 * Pavelor-1024 optimized implementation.
 * This file implements only the 1024-bit hash instance.
...
#define CH_DIGEST_BITS  1024u
#define CH_RATE_BITS    512u
#define CH_CAP_BITS     2048u
...
static CH_FORCE_INLINE void squeeze(CHState* st, uint8_t* digest)
{
    ...
    _mm_storeu_si128((__m128i*)(void*)(digest +  64), st->v[0]);
    _mm_storeu_si128((__m128i*)(void*)(digest +  80), st->v[1]);
    _mm_storeu_si128((__m128i*)(void*)(digest +  96), st->v[2]);
    _mm_storeu_si128((__m128i*)(void*)(digest + 112), st->v[3]);
}
...
/*
 * CryptHash API entry point for the 1024-bit instance.
 * Returns CH_ERR_BAD_DIGESTLEN unless digest_len_bits equals 1024.
 */
