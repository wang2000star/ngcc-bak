/*
 * Pavelor-768 optimized implementation.
 * This file implements only the 768-bit hash instance.
...
#define CH_DIGEST_BITS  768u
#define CH_RATE_BITS    1024u
#define CH_CAP_BITS     1536u
...
static CH_FORCE_INLINE void squeeze(CHState* st, uint8_t* digest)
{
    ...
    _mm_storeu_si128((__m128i*)(void*)(digest +  64), st->v[4]);
    _mm_storeu_si128((__m128i*)(void*)(digest +  80), st->v[5]);
}
...
/*
 * CryptHash API entry point for the 768-bit instance.
 * Returns CH_ERR_BAD_DIGESTLEN unless digest_len_bits equals 768.
 */
