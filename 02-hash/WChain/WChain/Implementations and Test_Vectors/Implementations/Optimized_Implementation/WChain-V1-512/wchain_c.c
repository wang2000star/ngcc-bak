...
static inline void wchain_v1_compress_loaded(uint64_t out[9], const uint64_t v[9], uint64_t b0[9], uint64_t b1[9]) {
    ...
    round_v1_inject_u64(x, b0, 0);
    round_v1_inject_u64(x, b1, 1);
    mef_v1_xor_u64(b2, b1, b0); round_v1_inject_u64(x, b2, 2);
    mef_v1_xor_u64(b0, b2, b1); round_v1_inject_u64(x, b0, 3);
    mef_v1_xor_u64(b1, b0, b2); round_v1_inject_u64(x, b1, 4);
    mef_v1_xor_u64(b2, b1, b0); round_v1_inject_u64(x, b2, 5);
    mef_v1_xor_u64(b0, b2, b1); round_v1_inject_u64(x, b0, 6);
    mef_v1_xor_u64(b1, b0, b2); round_v1_inject_u64(x, b1, 7);
    mef_v1_xor_u64(b2, b1, b0); round_v1_inject_u64(x, b2, 8);
    mef_v1_xor_u64(b0, b2, b1); round_v1_inject_u64(x, b0, 9);
    mef_v1_xor_u64(b1, b0, b2); round_v1_inject_u64(x, b1, 10);
    mef_v1_xor_u64(b2, b1, b0); round_v1_inject_u64(x, b2, 11);
    mef_v1_xor_u64(b0, b2, b1); round_v1_inject_u64(x, b0, 12);
    mef_v1_xor_u64(b1, b0, b2); round_v1_inject_u64(x, b1, 13);
    mef_v1_xor_u64(b2, b1, b0); round_v1_inject_u64(x, b2, 14);
    mef_v1_xor_u64(b0, b2, b1); round_v1_inject_u64(x, b0, 15);
    mef_v1_xor_u64(b1, b0, b2); round_v1_inject_u64(x, b1, 16);
    mef_v1_xor_u64(b2, b1, b0); round_v1_inject_u64(x, b2, 17);
    mef_v1_xor_u64(b0, b2, b1);
...
__attribute__((target("avx2")))
static inline void sbox9_256(__m256i x[9]) {
...
__attribute__((target("avx2")))
static inline void pi_mix_v1_256(__m256i x[9]) {
    const __m256i a0 = x[0], a1 = x[1], a2 = x[2], a3 = x[3], a4 = x[4];
    const __m256i a5 = x[5], a6 = x[6], a7 = x[7], a8 = x[8];
...
__attribute__((target("avx2")))
static inline void round_v1_inject_256(__m256i x[9], const __m256i inject[9], int r) {
    const uint64_t *rc = PI16_ROT[r];
...
__attribute__((target("avx2")))
static inline void mef_v1_xor_256(__m256i out[9], const __m256i prev1[9], const __m256i prev2[9]) {
    const __m256i all = _mm256_set1_epi64x(-1);
...
void wchain_v1_compress4_avx2(uint64_t out[4][9], uint64_t v[4][9], uint8_t blocks[4][144]) {
    __m256i b0[9], b1[9], b2[9], x[9], vv[9];
    for (int i = 0; i < 9; ++i) {
        vv[i] = _mm256_set_epi64x((int64_t)v[3][i], (int64_t)v[2][i], (int64_t)v[1][i], (int64_t)v[0][i]);
        x[i] = vv[i];
        b0[i] = _mm256_set_epi64x((int64_t)load64_be(blocks[3] + 8 * i), (int64_t)load64_be(blocks[2] + 8 * i), (int64_t)load64_be(blocks[1] + 8 * i), (int64_t)load64_be(blocks[0] + 8 * i));
        b1[i] = _mm256_set_epi64x((int64_t)load64_be(blocks[3] + 72 + 8 * i), (int64_t)load64_be(blocks[2] + 72 + 8 * i), (int64_t)load64_be(blocks[1] + 72 + 8 * i), (int64_t)load64_be(blocks[0] + 72 + 8 * i));
    }

    round_v1_inject_256(x, b0, 0);
    round_v1_inject_256(x, b1, 1);
    mef_v1_xor_256(b2, b1, b0); round_v1_inject_256(x, b2, 2);
    mef_v1_xor_256(b0, b2, b1); round_v1_inject_256(x, b0, 3);
    mef_v1_xor_256(b1, b0, b2); round_v1_inject_256(x, b1, 4);
    mef_v1_xor_256(b2, b1, b0); round_v1_inject_256(x, b2, 5);
    mef_v1_xor_256(b0, b2, b1); round_v1_inject_256(x, b0, 6);
    mef_v1_xor_256(b1, b0, b2); round_v1_inject_256(x, b1, 7);
    mef_v1_xor_256(b2, b1, b0); round_v1_inject_256(x, b2, 8);
    mef_v1_xor_256(b0, b2, b1); round_v1_inject_256(x, b0, 9);
    mef_v1_xor_256(b1, b0, b2); round_v1_inject_256(x, b1, 10);
    mef_v1_xor_256(b2, b1, b0); round_v1_inject_256(x, b2, 11);
    mef_v1_xor_256(b0, b2, b1); round_v1_inject_256(x, b0, 12);
    mef_v1_xor_256(b1, b0, b2); round_v1_inject_256(x, b1, 13);
    mef_v1_xor_256(b2, b1, b0); round_v1_inject_256(x, b2, 14);
    mef_v1_xor_256(b0, b2, b1); round_v1_inject_256(x, b0, 15);
    mef_v1_xor_256(b1, b0, b2); round_v1_inject_256(x, b1, 16);
    mef_v1_xor_256(b2, b1, b0); round_v1_inject_256(x, b2, 17);
    mef_v1_xor_256(b0, b2, b1); round_v1_inject_256(x, b0, 18);
    mef_v1_xor_256(b1, b0, b2); round_v1_inject_256(x, b1, 19);
    mef_v1_xor_256(b2, b1, b0);

    for (int i = 0; i < 9; ++i) {
        uint64_t tmp[4];
        __m256i h = _mm256_xor_si256(_mm256_xor_si256(x[i], b2[i]), vv[i]);
...
#define ROTL512I(x, n) ((n) == 0 ? (x) : _mm512_or_si512(_mm512_slli_epi64((x), (n)), _mm512_srli_epi64((x), 64 - (n))))
#define SBOX512(a, b, c) _mm512_ternarylogic_epi64((a), (b), (c), 0x2d)
#define XOR3_512(a, b, c) _mm512_ternarylogic_epi64((a), (b), (c), 0x96)
#define XOR5_512(a, b, c, d, e) _mm512_ternarylogic_epi64(_mm512_ternarylogic_epi64((a), (b), (c), 0x96), (d), (e), 0x96)

__attribute__((target("avx512f")))
static inline void sbox9_512(__m512i x[9]) {
    const __m512i a0 = x[0], a1 = x[1], a2 = x[2], a3 = x[3], a4 = x[4];
    const __m512i a5 = x[5], a6 = x[6], a7 = x[7], a8 = x[8];
    x[0] = SBOX512(a0, a1, a2);
    x[1] = SBOX512(a1, a2, a3);
    x[2] = SBOX512(a2, a3, a4);
    x[3] = SBOX512(a3, a4, a5);
    x[4] = SBOX512(a4, a5, a6);
    x[5] = SBOX512(a5, a6, a7);
    x[6] = SBOX512(a6, a7, a8);
    x[7] = SBOX512(a7, a8, a0);
    x[8] = SBOX512(a8, a0, a1);
}
...
__attribute__((target("avx512f")))
static inline void pi_mix_v1_512(__m512i x[9]) {
    const __m512i a0 = x[0], a1 = x[1], a2 = x[2], a3 = x[3], a4 = x[4];
    const __m512i a5 = x[5], a6 = x[6], a7 = x[7], a8 = x[8];
    x[0] = XOR5_512(ROTL512I(a0, 5),  ROTL512I(a4, 22), ROTL512I(a8, 3),  ROTL512I(a3, 28), ROTL512I(a1, 27));
    x[1] = XOR5_512(ROTL512I(a4, 39), ROTL512I(a8, 59), ROTL512I(a3, 45), ROTL512I(a7, 3),  ROTL512I(a5, 9));
    x[2] = XOR5_512(ROTL512I(a8, 54), ROTL512I(a3, 6),  ROTL512I(a7, 20), ROTL512I(a2, 8),  ROTL512I(a0, 48));
    x[3] = XOR5_512(a3,               ROTL512I(a7, 57), ROTL512I(a2, 55), ROTL512I(a6, 46), ROTL512I(a4, 28));
    x[4] = XOR5_512(ROTL512I(a7, 61), ROTL512I(a2, 38), a6,               ROTL512I(a1, 44), ROTL512I(a8, 52));
    x[5] = XOR5_512(ROTL512I(a2, 29), ROTL512I(a6, 10), ROTL512I(a1, 37), ROTL512I(a5, 19), ROTL512I(a3, 7));
    x[6] = XOR5_512(ROTL512I(a6, 56), ROTL512I(a1, 5),  ROTL512I(a5, 50), ROTL512I(a0, 27), ROTL512I(a7, 13));
    x[7] = XOR5_512(ROTL512I(a1, 40), ROTL512I(a5, 10), ROTL512I(a0, 11), ROTL512I(a4, 54), ROTL512I(a2, 14));
    x[8] = XOR5_512(ROTL512I(a5, 3),  ROTL512I(a0, 38), ROTL512I(a4, 36), ROTL512I(a8, 17), ROTL512I(a6, 13));
}

__attribute__((target("avx512f")))
static inline void round_v1_inject_512(__m512i x[9], const __m512i inject[9], int r) {
    const uint64_t *rc = PI16_ROT[r];
    x[0] = XOR3_512(x[0], inject[0], _mm512_set1_epi64((int64_t)rc[0]));
    x[1] = XOR3_512(x[1], inject[1], _mm512_set1_epi64((int64_t)rc[1]));
    x[2] = XOR3_512(x[2], inject[2], _mm512_set1_epi64((int64_t)rc[2]));
    x[3] = XOR3_512(x[3], inject[3], _mm512_set1_epi64((int64_t)rc[3]));
    x[4] = XOR3_512(x[4], inject[4], _mm512_set1_epi64((int64_t)rc[4]));
    x[5] = XOR3_512(x[5], inject[5], _mm512_set1_epi64((int64_t)rc[5]));
    x[6] = XOR3_512(x[6], inject[6], _mm512_set1_epi64((int64_t)rc[6]));
    x[7] = XOR3_512(x[7], inject[7], _mm512_set1_epi64((int64_t)rc[7]));
    x[8] = XOR3_512(x[8], inject[8], _mm512_set1_epi64((int64_t)rc[8]));
    sbox9_512(x);
    pi_mix_v1_512(x);
}
...
__attribute__((target("avx512f")))
WCHAIN_UNUSED static void mef_v1_512(__m512i x[9]) {
    x[1] = ROTL512I(x[1], 1);
    x[2] = ROTL512I(x[2], 10);
    x[3] = ROTL512I(x[3], 20);
    x[4] = ROTL512I(x[4], 25);
...
__attribute__((target("avx512f")))
static inline void mef_v1_xor_512(__m512i out[9], const __m512i prev1[9], const __m512i prev2[9]) {
    const __m512i zero = _mm512_setzero_si512();
    const __m512i a0 = prev1[0];
    const __m512i a1 = ROTL512I(prev1[1], 1);
    const __m512i a2 = ROTL512I(prev1[2], 10);
    const __m512i a3 = ROTL512I(prev1[3], 20);
    const __m512i a4 = ROTL512I(prev1[4], 25);
    const __m512i a5 = ROTL512I(prev1[5], 32);
    const __m512i a6 = ROTL512I(prev1[6], 41);
    const __m512i a7 = ROTL512I(prev1[7], 46);
    const __m512i a8 = ROTL512I(prev1[8], 50);
    out[0] = XOR3_512(SBOX512(a0, a1, a2), prev2[0], zero);
    out[1] = XOR3_512(SBOX512(a1, a2, a3), prev2[1], zero);
    out[2] = XOR3_512(SBOX512(a2, a3, a4), prev2[2], zero);
    out[3] = XOR3_512(SBOX512(a3, a4, a5), prev2[3], zero);
    out[4] = XOR3_512(SBOX512(a4, a5, a6), prev2[4], zero);
    out[5] = XOR3_512(SBOX512(a5, a6, a7), prev2[5], zero);
    out[6] = XOR3_512(SBOX512(a6, a7, a8), prev2[6], zero);
    out[7] = XOR3_512(SBOX512(a7, a8, a0), prev2[7], zero);
    out[8] = XOR3_512(SBOX512(a8, a0, a1), prev2[8], zero);
}
...
void wchain_v1_compress8_avx512(uint64_t out[8][9], uint64_t v[8][9], uint8_t blocks[8][144]) {
    __m512i b0[9], b1[9], b2[9], x[9], vv[9];
    for (int i = 0; i < 9; ++i) {
        ...
        x[i] = vv[i];
        b0[i] = _mm512_set_epi64((int64_t)load64_be(blocks[7] + 8 * i), (int64_t)load64_be(blocks[6] + 8 * i), (int64_t)load64_be(blocks[5] + 8 * i), (int64_t)load64_be(blocks[4] + 8 * i), (int64_t)load64_be(blocks[3] + 8 * i), (int64_t)load64_be(blocks[2] + 8 * i), (int64_t)load64_be(blocks[1] + 8 * i), (int64_t)load64_be(blocks[0] + 8 * i));
        b1[i] = _mm512_set_epi64((int64_t)load64_be(blocks[7] + 72 + 8 * i), (int64_t)load64_be(blocks[6] + 72 + 8 * i), (int64_t)load64_be(blocks[5] + 72 + 8 * i), (int64_t)load64_be(blocks[4] + 72 + 8 * i), (int64_t)load64_be(blocks[3] + 72 + 8 * i), (int64_t)load64_be(blocks[2] + 72 + 8 * i), (int64_t)load64_be(blocks[1] + 72 + 8 * i), (int64_t)load64_be(blocks[0] + 72 + 8 * i));
    }

    round_v1_inject_512(x, b0, 0);
    round_v1_inject_512(x, b1, 1);
    mef_v1_xor_512(b2, b1, b0); round_v1_inject_512(x, b2, 2);
    mef_v1_xor_512(b0, b2, b1); round_v1_inject_512(x, b0, 3);
    mef_v1_xor_512(b1, b0, b2); round_v1_inject_512(x, b1, 4);
    mef_v1_xor_512(b2, b1, b0); round_v1_inject_512(x, b2, 5);
    mef_v1_xor_512(b0, b2, b1); round_v1_inject_512(x, b0, 6);
    mef_v1_xor_512(b1, b0, b2); round_v1_inject_512(x, b1, 7);
    mef_v1_xor_512(b2, b1, b0); round_v1_inject_512(x, b2, 8);
    mef_v1_xor_512(b0, b2, b1); round_v1_inject_512(x, b0, 9);
    mef_v1_xor_512(b1, b0, b2); round_v1_inject_512(x, b1, 10);
    mef_v1_xor_512(b2, b1, b0); round_v1_inject_512(x, b2, 11);
    mef_v1_xor_512(b0, b2, b1); round_v1_inject_512(x, b0, 12);
    mef_v1_xor_512(b1, b0, b2); round_v1_inject_512(x, b1, 13);
    mef_v1_xor_512(b2, b1, b0); round_v1_inject_512(x, b2, 14);
    mef_v1_xor_512(b0, b2, b1); round_v1_inject_512(x, b0, 15);
    mef_v1_xor_512(b1, b0, b2); round_v1_inject_512(x, b1, 16);
    mef_v1_xor_512(b2, b1, b0); round_v1_inject_512(x, b2, 17);
    mef_v1_xor_512(b0, b2, b1); round_v1_inject_512(x, b0, 18);
    mef_v1_xor_512(b1, b0, b2); round_v1_inject_512(x, b1, 19);
    mef_v1_xor_512(b2, b1, b0);

    for (int i = 0; i < 9; ++i) {
        uint64_t tmp[8];
        __m512i h = _mm512_xor_si512(_mm512_xor_si512(x[i], b2[i]), vv[i]);
