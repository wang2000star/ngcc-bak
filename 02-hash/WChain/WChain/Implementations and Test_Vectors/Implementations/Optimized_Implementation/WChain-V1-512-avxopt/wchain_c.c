...
void wchain_v1_compress4_avx2(uint64_t out[4][9], uint64_t v[4][9], uint8_t blocks[4][144]) {
    ...
    mef_v1_xor_256(b0, b2, b1);

    for (int i = 0; i < 9; ++i) {
        uint64_t tmp[4];
        __m256i h = _mm256_xor_si256(_mm256_xor_si256(x[i], b0[i]), vv[i]);
...
void wchain_v1_compress8_avx512(uint64_t out[8][9], uint64_t v[8][9], uint8_t blocks[8][144]) {
    ...
    mef_v1_xor_512(b0, b2, b1);

    for (int i = 0; i < 9; ++i) {
        uint64_t tmp[8];
        __m512i h = _mm512_xor_si512(_mm512_xor_si512(x[i], b0[i]), vv[i]);
