...
static const uint64_t IV_1[8] = {0x34e0d42e61a33f99, 0x87abb9f2087207ed,
                                 0xec3fc3f38a10ea02, 0x610bebf29db2faf5,
                                 0x7420b49edc5a21ee, 0xd1fd8a3396bdeee8,
                                 0x092197f60194adc1, 0x1b530c95f8b3def8};

static const uint64_t IV_2[8] = {0x869d6342f6d22822, 0x11076689f6aff6b0,
                                 0x43ab9fb62162bb7f, 0x75a9f91d5813e9e8,
                                 0xd7cd8173f479197a, 0x07fe00ff606fac41,
                                 0x379f513f856fc7a9, 0x66b651a8ab0e883b};
...
static void store768_be(unsigned char out[96], const uint64_t in[12]) {
  int i;
...
int CryptHash(int digest_len_bits, const unsigned char *msg,
  ...
  /* Convert the final chaining state into the 768-bit digest. */
  finalization(t, b, tail_msg, tail_msg_bits, final_counter_bits, digest_words);
  store768_be(digest, digest_words);
