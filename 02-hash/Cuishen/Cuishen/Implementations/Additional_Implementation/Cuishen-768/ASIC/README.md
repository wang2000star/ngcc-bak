# Cuishen-768 — ASIC Implementation

Round-based ASIC implementation of the Cuishen-768 hash function, one
round per clock cycle, no pipelining, no loop unrolling. This README
reports post-synthesis PPA numbers from Synopsys Design Compiler.
...
- `tb_cuishen_2_23.v` — self-checking testbench (all-zero / all-one
  vectors; 8192 compression blocks each)
