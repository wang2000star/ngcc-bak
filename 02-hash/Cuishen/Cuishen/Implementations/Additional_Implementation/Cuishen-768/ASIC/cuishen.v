...
// cuishen.v
// ---------
// Top level wrapper for the Cuishen-1024 hash function providing a
// simple memory-like interface with 32-bit data access. Modelled on the
// 512-bit design's cuishen.v.
//
...
//   0x30..0x3f      TAIL    (16 x 32-bit = 512-bit finalization tail)
//   0x60..0x7f      DIGEST  (32 x 32-bit = 1024-bit digest, ro)
//
//======================================================================
...
module cuishen(
  ...
  localparam ADDR_TAIL15   = 8'h3f;

  localparam ADDR_DIGEST0  = 8'h60;
  localparam ADDR_DIGEST31 = 8'h7f;

  localparam CORE_NAME0    = 32'h63756973; // "cuis"
  localparam CORE_NAME1    = 32'h68656e31; // "hen1" (1024)
  ...
  always @*
    begin : api_logic
      ...
      tail_addr  = address[3 : 0] - ADDR_TAIL0[3 : 0];
        ...
        begin
          if (we)
            begin
              ...
              if ((address >= ADDR_TAIL0) && (address <= ADDR_TAIL15))
                tail_we = 1'h1;
            ...
            begin
              if ((address >= ADDR_DIGEST0) && (address <= ADDR_DIGEST31))
