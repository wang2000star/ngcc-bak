...
// tb_cuishen_2_23.v
// ------------------
// Self-checking testbench for the Cuishen-768 hash, covering all-zero
// and all-one 8388608-bit (8192 full 1024-bit block) messages.
//
//======================================================================
...
module tb_cuishen_2_23;
  ...
  // of the same 1024-bit fill pattern.
  //----------------------------------------------------------------
...
//----------------------------------------------------------------
  ...
  initial
    begin : main
      $display("==================================================");
      $display(" Cuishen-768 testbench (all-zero / all-one, 8192 blocks)");
      ...
      check("all-zero (8388608 bit)",
            768'hB50018EEC1223E26F1D94478AE01476B4F89D184F4A0FFBFF8E9D53D376FEAF2CCB4D94A21B03F177EFECF9B12DDCDA40A778C99E5FF794A4479A7E9177A5D5601EFD300AF3D0619BA98D5DC4686C18C3BEDF387C95F8A35677FDDE0B8F41E7E);
      ...
      check("all-one (8388608 bit)",
            768'h4F597323F67552BECADA51C619805152D9F1D9478B99C73F5B4475E4A0FB802E91CA0C57E1823C303CE0F14E9D51F506950EEB6C09B9171FBDD2A507D0F3BA374433DB3087D70AE21F8A284AE7D857EBF3A42C358405655CD23FAE6B6CBE50B5);
