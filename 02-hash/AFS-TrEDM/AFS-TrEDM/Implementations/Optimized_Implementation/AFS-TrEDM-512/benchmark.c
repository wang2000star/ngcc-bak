...
/* === AFS-TrEDM Session-2 patch: add avx2-r2 implementation tag === */
#if defined(AFS_TREDM_BENCH_IMPL_DISPATCH)
    printf("# implementation=runtime-dispatch\n");
#elif defined(AFS_TREDM_USE_AVX512_R10_TERNLOG)
    printf("# implementation=avx512-r10\n");
#elif defined(AFS_TREDM_USE_AVX512_R8_LINEARVEC)
    printf("# implementation=avx512-r8\n");
#elif defined(AFS_TREDM_BENCH_IMPL_AVX2)
    printf("# implementation=avx2\n");
#elif defined(AFS_TREDM_USE_AVX2_R11_SPLITSTATE)
    printf("# implementation=avx2-r11\n");
#elif defined(AFS_TREDM_USE_AVX2_R9_MASKVEC)
    printf("# implementation=avx2-r9\n");
#elif defined(AFS_TREDM_USE_AVX2_R7_LINEARVEC)
    printf("# implementation=avx2-r7\n");
#elif defined(AFS_TREDM_USE_AVX2_R6_LOADSPLIT)
    printf("# implementation=avx2-r6\n");
#elif defined(AFS_TREDM_AVX2_DEFAULT_R4)
    printf("# implementation=avx2\n");
#elif defined(AFS_TREDM_USE_AVX2_R4)
    printf("# implementation=avx2-r4\n");
#elif defined(AFS_TREDM_USE_AVX2_R3)
    printf("# implementation=avx2-r3\n");
#elif defined(AFS_TREDM_USE_AVX2_R2)
    printf("# implementation=avx2-r2\n");
#elif defined(AFS_TREDM_USE_AVX2)
    printf("# implementation=avx2\n");
#elif defined(AFS_TREDM_OPT64_PORTABLE)
    printf("# implementation=portable-opt64\n");
#else
    printf("# implementation=reference\n");
#endif
/* === end AFS-TrEDM Session-2 patch === */
#if defined(AFS_TREDM_USE_AVX2) && defined(__AVX2__)
    printf("# sbox_backend=avx2\n");
#else
    printf("# sbox_backend=opt64\n");
#endif
