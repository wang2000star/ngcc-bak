AFS-TrEDM-S6 reference implementation for AFS-TrEDM-1024
====================================================

This directory contains the ISO C99 reference implementation for the S6
variant of AFS-TrEDM-1024.  The implementation keeps the AFS-TrEDM aligned TrEDM
...
Default split: g = 12 rounds, h = 12 rounds
Effective permutation: AFS-p-S6[1600,24]
...
afs_p1600.c / afs_p1600.h
    AFS-p-S6[1600,24] reference permutation.  The public RC32(round,lane)
...
afs_tredm.c / afs_tredm.h
    ...
    was re-derived with the domain string:
        AFS-TrEDM-v2|d=1024|r=512|c=1088|b=1600|nr=24|sbox=AFS64_t5_k2|linear=AFS-LMDS-1600-S6
