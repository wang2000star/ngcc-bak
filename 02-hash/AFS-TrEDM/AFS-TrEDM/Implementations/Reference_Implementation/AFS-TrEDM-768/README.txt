AFS-TrEDM-S6 reference implementation for AFS-TrEDM-768
====================================================

This directory contains the ISO C99 reference implementation for the S6
variant of AFS-TrEDM-768.  The implementation keeps the AFS-TrEDM aligned TrEDM
...
Default split: g = 10 rounds, h = 10 rounds
Effective permutation: AFS-p-S6[1600,20]
...
afs_p1600.c / afs_p1600.h
    AFS-p-S6[1600,20] reference permutation.  The public RC32(round,lane)
...
afs_tredm.c / afs_tredm.h
    ...
    was re-derived with the domain string:
        AFS-TrEDM-v2|d=768|r=768|c=832|b=1600|nr=20|sbox=AFS64_t5_k2|linear=AFS-LMDS-1600-S6
