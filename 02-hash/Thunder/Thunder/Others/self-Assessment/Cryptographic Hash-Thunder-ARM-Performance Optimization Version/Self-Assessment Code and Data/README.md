...
~~~~bash
cd Thunder_ARM64/API_CryptHash/Implementations/Optimized_Implementation/Thunder512
sh build.sh
~~~~
...
~~~~bash
sudo ./ngcc_bench \
  --lib ../../Thunder_ARM64/API_CryptHash/Implementations/Optimized_Implementation/Thunder512/libThunder512Opt.so \
  --test hash \
  --mode all \
  --digest-len-bits 512 \
  --kat ../../Thunder_ARM64/API_CryptHash/Test_Vector/Thunder512 \
  --json-out Thunder512opt_A64_report.json
~~~~
