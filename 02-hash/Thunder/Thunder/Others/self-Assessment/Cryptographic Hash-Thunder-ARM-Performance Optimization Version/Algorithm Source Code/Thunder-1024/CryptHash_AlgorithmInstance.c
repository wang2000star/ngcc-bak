...
{   
    ...
    s00=IV[16];  s10=IV[11];s20=IV[6];	s30=IV[1];	s40=0;
	s01=IV[15];  s11=IV[10];s21=IV[5];	s31=IV[0];	s41=0;
	s02=IV[14];  s12=IV[9];	s22=IV[4];	s32=0;	s42=0;
	s03=IV[13];  s13=IV[8];	s23=IV[3];	s33=0;	s43=0;
	s04=IV[12];  s14=IV[7];	s24=IV[2];	s34=0;	s44=0;  
 
 
    /* --- 2. Absorbing Phase --- */
   
    while (rem_bits >= RATE_BITS) {
  S[16]=s00; S[15]=s01;S[14]=s02; S[13]=s03; S[12]=s04;
        S[11]=s10; S[10]=s11; S[9]=s12; S[8]=s13;  S[7]=s14;
        S[6]=s20; S[5]=s21; S[4]=s22;  S[3]=s23; S[2]=s24;
		S[1]=s30; S[0]= s31; 
	...
	s00^=S[16]; 	s10^=S[11];  s20^=S[6];  s30^=S[1];	 
	s01^=S[15];   s11^=S[10];  s21^=S[5];    s31^=S[0];
	s02^=S[14];  s12^=S[9]; s22^=S[4];
	s03^=S[13];  s13^=S[8]; s23^=S[3];
	s04^=S[12];  s14^=S[7]; s24^=S[2]; 
   ...
   if(need_extra_zero_block)
   {
    ...
    /* --- 5. Squeezing Phase --- */
    *((uint64_t *)(digest ))= SWAP64(s30);
    *((uint64_t *)(digest +8 ))= SWAP64(s24);
    *((uint64_t *)(digest +16))= SWAP64(s23);
    *((uint64_t *)(digest +24))= SWAP64(s22);
    *((uint64_t *)(digest +32))= SWAP64(s21);
    *((uint64_t *)(digest +40 ))= SWAP64(s20);
    *((uint64_t *)(digest +48))= SWAP64(s14);
    *((uint64_t *)(digest +56))= SWAP64(s13);
    *((uint64_t *)(digest +64))= SWAP64(s12);
    *((uint64_t *)(digest+72 ))= SWAP64(s11);
    *((uint64_t *)(digest+80 ))= SWAP64(s10);
    *((uint64_t *)(digest+88 ))= SWAP64(s04);
    *((uint64_t *)(digest+96 ))= SWAP64(s03);
    *((uint64_t *)(digest+104 ))= SWAP64(s02);
    *((uint64_t *)(digest+112 ))= SWAP64(s01);
