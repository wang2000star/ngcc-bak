Thunder x86 Implementations
==========================

This directory contains the x86 implementations of the Thunder hash family.
...
Implementations/
  ...
  Optimized_Implementation/
    Performance-optimized x86 implementations of the fixed-output Thunder hash
    instances.
  ...
  Additional_Implementation/
    Resource-optimized x86 implementations of the fixed-output Thunder hash
    instances.
