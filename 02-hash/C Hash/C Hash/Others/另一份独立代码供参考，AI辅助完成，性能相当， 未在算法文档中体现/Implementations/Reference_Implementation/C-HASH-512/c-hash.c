/*
 * C-Hash-512 Reference Implementation
 *
 * Architecture: C-Engine (pure permutation P) + unified VIL/FIL mode.
 * The VIL and FIL structures are identical to C-Hash-1024;
...
/* ================================================================
   ...
   Unified structure shared with C-Hash-1024.
   ================================================================ */
...
/* ================================================================
   Public API
   ================================================================ */
int c_hash_512_bits(const unsigned char *msg,unsigned long long mlen_bits,unsigned char *digest)
{
...
{
    return c_hash_512_bits(msg,(unsigned long long)msg_len<<3,digest);
}
