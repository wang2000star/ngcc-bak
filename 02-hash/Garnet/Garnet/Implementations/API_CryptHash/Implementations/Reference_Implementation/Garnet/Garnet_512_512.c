...
/* 规范对角线 512 比特吸收函数 */
static inline void absorb_message2_4x4(garnet_u128_t state[STATE_4x4], garnet_u128_t msg[4]) {
...
/* 规范的 C 语言版主哈希函数（速率=512比特，512位摘要） */
void garnet_512(const uint8_t* message, uint64_t mlength, uint8_t* digest, garnet_u128_t state[STATE_4x4]) {
    ...
    state[0].v[0] = 0x782b1463e5b448c2ULL; state[0].v[1] = 0xde30d1b89ddaa011ULL;
    state[1].v[0] = 0xd92183bde01eaf39ULL; state[1].v[1] = 0x634ee0b3bf88f484ULL;
    state[2].v[0] = 0xf8fb07c0f0d96f62ULL; state[2].v[1] = 0x149d3ee603859d70ULL;
    state[3].v[0] = 0x4c92e211237707efULL; state[3].v[1] = 0xf48dce216aa60cacULL;

    state[4].v[0] = 0xd2543469c3db12b7ULL; state[4].v[1] = 0x7396d12e4c6dbbb7ULL;
    state[5].v[0] = 0x6d127c0b76361e62ULL; state[5].v[1] = 0x8a6a75f1e6bbc959ULL;
    state[6].v[0] = 0x833bfb64f3bce994ULL; state[6].v[1] = 0x530cf1efa5661a70ULL;
    state[7].v[0] = 0x0e267b18c6f6db4cULL; state[7].v[1] = 0xb0389a5d5e9c9970ULL;

    state[8].v[0] = 0x05239d1166b906cbULL; state[8].v[1] = 0x67117fbd723084d2ULL;
    state[9].v[0] = 0xe907c5dd6ca25474ULL; state[9].v[1] = 0xcbbac776493d5c27ULL;
    state[10].v[0] = 0x6d0064b8f5707068ULL; state[10].v[1] = 0xaff5e27600e5bc3fULL;
    state[11].v[0] = 0xc58584622d4b401eULL; state[11].v[1] = 0x9b1ac6e440a1ef11ULL;

    state[12].v[0] = 0x42e77c2f23ac28fbULL; state[12].v[1] = 0x92918651c356f4b8ULL;
    state[13].v[0] = 0x09e68e582255f277ULL; state[13].v[1] = 0x7e5c987ec3973036ULL;
    state[14].v[0] = 0x87947a0718e95f65ULL; state[14].v[1] = 0x8b07f08ed4e24d6cULL;
    state[15].v[0] = 0xf742ee05141a3f41ULL; state[15].v[1] = 0xfa7f68f3b89fc0c7ULL;
