...
/* 规范对角线 768 比特吸收函数 */
static inline void absorb_message4_4x4(garnet_u128_t state[STATE_4x4], garnet_u128_t msg[6]) {
...
/* 规范的 C 语言版主哈希函数（速率=768比特，512位摘要） */
void garnet_512(const uint8_t* message, uint64_t mlength, uint8_t* digest, garnet_u128_t state[STATE_4x4]) {
    ...
    state[0].v[0] = 0x2ebf3abde3fb6116; state[0].v[1] = 0xbaa89618b47c4eee; // baa89618b47c4eee   2ebf3abde3fb6116
    state[1].v[0] = 0x077ad97232ad617b; state[1].v[1] = 0xbe0b0c92abdb3cda; // be0b0c92abdb3cda  077ad97232ad617b
    state[2].v[0] = 0x5950cdfba838e796; state[2].v[1] = 0x7e9b096bd65a5249; // 7e9b096bd65a5249  5950cdfba838e796
    state[3].v[0] = 0xaf4541046e765fac; state[3].v[1] = 0x83b61edc223526ee; // 83b61edc223526ee   af4541046e765fac

    state[4].v[0] = 0x5c62cda23fe20d1e; state[4].v[1] = 0xbca55cfac429c860; // bca55cfac429c860   5c62cda23fe20d1e
    state[5].v[0] = 0x7f579965691de336; state[5].v[1] = 0x05881a1f883f16ff; // 05881a1f883f16ff  7f579965691de336
    state[6].v[0] = 0x9c15f5b5b93ff854; state[6].v[1] = 0xf38538686ae0eb4e; // f38538686ae0eb4e  9c15f5b5b93ff854
    state[7].v[0] = 0xfd0a7691efac606a; state[7].v[1] = 0xd9c35429b75fe28a; // d9c35429b75fe28a  fd0a7691efac606a

    state[8].v[0] = 0x292b1d791af6aec8; state[8].v[1] = 0xcab740a879db30cd; // cab740a879db30cd  292b1d791af6aec8
    state[9].v[0] = 0xd3b38b44b3c9d1eb; state[9].v[1] = 0x417579fcb695694e; // 417579fcb695694e   d3b38b44b3c9d1eb
    state[10].v[0] = 0x46538867280ecd92; state[10].v[1] = 0xf727a8e7871d5fb9; // f727a8e7871d5fb9  46538867280ecd92
    state[11].v[0] = 0xf673c20f669d63ac; state[11].v[1] = 0x36b161e3e03a98e7; // 36b161e3e03a98e7  f673c20f669d63ac

    state[12].v[0] = 0x566cc32dd61c5169; state[12].v[1] = 0x6eefd4f36d1bd0a0; // 6eefd4f36d1bd0a0  566cc32dd61c5169
    state[13].v[0] = 0xb095703d0d4e2db5; state[13].v[1] = 0x0e3adafb2f9ad32e; // 0e3adafb2f9ad32e  b095703d0d4e2db5
    state[14].v[0] = 0x8a5c72a07dd7088e; state[14].v[1] = 0x25ec1ece9c94d6b5; // 25ec1ece9c94d6b5   8a5c72a07dd7088e
    state[15].v[0] = 0x1e79e0199d994a74; state[15].v[1] = 0x616156ebe4b971e6; // 616156ebe4b971e6   1e79e0199d994a74
    ...
    /* 3. 吸收阶段（按 96 字节 步长吸入） */
    for (i = 0; (i + 96) <= (int)byte_num; i += 96) {
