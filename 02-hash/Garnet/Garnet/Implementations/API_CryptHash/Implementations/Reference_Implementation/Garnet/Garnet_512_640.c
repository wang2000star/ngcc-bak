...
/* 规范对角线 640 比特吸收函数 */
static inline void absorb_message3_4x4(garnet_u128_t state[STATE_4x4], garnet_u128_t msg[5]) {
...
/* 规范的 C 语言版主哈希函数（速率=640比特，512位摘要） */
void garnet_512(const uint8_t* message, uint64_t mlength, uint8_t* digest, garnet_u128_t state[STATE_4x4]) {
    ...
    state[0].v[0] = 0x311cceecf76770f1; state[0].v[1] = 0xffdfea80e8157eb4; //ffdfea80e8157eb4    311cceecf76770f1
    state[1].v[0] = 0xa9af0b6d22d121bd; state[1].v[1] = 0x486dae24482aa00a; // 486dae24482aa00a    a9af0b6d22d121bd
    state[2].v[0] = 0x9f2fe6c33ab00be5; state[2].v[1] = 0x306eda4994baba9c; // 306eda4994baba9c   9f2fe6c33ab00be5
    state[3].v[0] = 0x190a811b2f39580e; state[3].v[1] = 0x5c2173082db5ddea; // 5c2173082db5ddea   190a811b2f39580e

    state[4].v[0] = 0xf6818434230a38a3; state[4].v[1] = 0xc4f59e2ab098316c; // c4f59e2ab098316c   f6818434230a38a3
    state[5].v[0] = 0xb2f34e3108b93899; state[5].v[1] = 0x8452307e9b13b8ae; // 8452307e9b13b8ae  b2f34e3108b93899
    state[6].v[0] = 0x8cd00f5e6f965b39; state[6].v[1] = 0xd6559e703c0ffad4; // d6559e703c0ffad4   8cd00f5e6f965b39
    state[7].v[0] = 0xb9bc125c20abb2a6; state[7].v[1] = 0xf4139d666be07b74; // f4139d666be07b74  b9bc125c20abb2a6

    state[8].v[0] = 0xb9e97c07cb92a584; state[8].v[1] = 0xf1c65f707fb1d7a7; // f1c65f707fb1d7a7  b9e97c07cb92a584
    state[9].v[0] = 0x0c8649adbb445f7b; state[9].v[1] = 0xa217af9dc3b9c169; // a217af9dc3b9c169   0c8649adbb445f7b
    state[10].v[0] = 0xe33cd10720739e0a; state[10].v[1] = 0x0dc0cdb2822afe55; // 0dc0cdb2822afe55   e33cd10720739e0a
    state[11].v[0] = 0x728e9fc267980396; state[11].v[1] = 0xe060d07351d77ec8; // e060d07351d77ec8   728e9fc267980396

    state[12].v[0] = 0xe900478b90718d8f; state[12].v[1] = 0x8cc7e03f0c09af90;// 8cc7e03f0c09af90   e900478b90718d8f
    state[13].v[0] = 0x533a33dac888ed08; state[13].v[1] = 0x80dd4e1f759fa6b9; // 80dd4e1f759fa6b9  533a33dac888ed08
    state[14].v[0] = 0xd626dbde1d3bbe21; state[14].v[1] = 0x454bf20854edf819; // 454bf20854edf819   d626dbde1d3bbe21
    state[15].v[0] = 0x1a9fe56ae1482d24; state[15].v[1] = 0xa8dd28acb21d7197; // a8dd28acb21d7197  1a9fe56ae1482d24
    ...
    /* 3. 吸收阶段（按 80 字节 步长吸入） */
    for (i = 0; (i + 80) <= (int)byte_num; i += 80) {
