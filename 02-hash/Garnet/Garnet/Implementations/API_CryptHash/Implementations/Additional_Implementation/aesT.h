...
// 兼容原版的数据类型定义 (建议后续使用 uint64_t 和 uint8_t 等标准库类型)
...
#endif // custom_types_defined

const unsigned char TE0[1024] GARNET_FAST_TABLE = {
...
const unsigned char TE1[1024] GARNET_FAST_TABLE = {
...
const unsigned char TE2[1024] GARNET_FAST_TABLE = {
...
const unsigned char TE3[1024] GARNET_FAST_TABLE = {
