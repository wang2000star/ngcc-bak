...
int Wish1024Absorb(u128 *state, u128 counter, int last_block, const unsigned char *block) {
    ...
    for (int i = 0; i < WISH_1024_NSTEPS; ++i) {
        ...
        lstate[WISH_1024_NLANES / 2] = vaesmcq_u8(vaeseq_u8(lstate[WISH_1024_NLANES / 2], counter));
        ...
        lstate[WISH_1024_NLANES - 1] = vaesmcq_u8(vaeseq_u8(lstate[WISH_1024_NLANES - 1],
