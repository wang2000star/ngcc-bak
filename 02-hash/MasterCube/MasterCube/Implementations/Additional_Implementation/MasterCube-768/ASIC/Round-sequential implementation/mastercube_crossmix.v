...
assign state_o[128*0  +: 128] = row0  ^ row2  ^ row8;
assign state_o[128*1  +: 128] = row1  ^ row3  ^ row9;
assign state_o[128*2  +: 128] = row2  ^ row4  ^ row10;
assign state_o[128*3  +: 128] = row3  ^ row5  ^ row11;
assign state_o[128*4  +: 128] = row4  ^ row6  ^ row0;
assign state_o[128*5  +: 128] = row5  ^ row7  ^ row1;
assign state_o[128*6  +: 128] = row6  ^ row8  ^ row2;
assign state_o[128*7  +: 128] = row7  ^ row9  ^ row3;
assign state_o[128*8  +: 128] = row8  ^ row10 ^ row4;
assign state_o[128*9  +: 128] = row9  ^ row11 ^ row5;
assign state_o[128*10 +: 128] = row10 ^ row0  ^ row6;
assign state_o[128*11 +: 128] = row11 ^ row1  ^ row7;
