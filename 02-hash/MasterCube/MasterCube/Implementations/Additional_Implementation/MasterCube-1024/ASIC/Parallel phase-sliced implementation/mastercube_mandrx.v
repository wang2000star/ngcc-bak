...
module mastercube_mandrx_const2 #(
    parameter [3:0] ALPHA0 = 4'd0,
    parameter [3:0] BETA0  = 4'd1,
    parameter [3:0] GAMMA0 = 4'd8,
    parameter [3:0] ALPHA1 = 4'd0,
    parameter [3:0] BETA1  = 4'd1,
    parameter [3:0] GAMMA1 = 4'd8
) (
    input  wire [127:0] src_row_i,
    input  wire [127:0] dst_row_i,
    input  wire         phase_i,
...
function [15:0] ror16_const2;
    input [15:0] value_i;
    input [3:0]  amount_i;
    begin
        case (amount_i)
            4'd0  : ror16_const2 = value_i;
            4'd1  : ror16_const2 = {value_i[0],    value_i[15:1]};
            4'd2  : ror16_const2 = {value_i[1:0],  value_i[15:2]};
            4'd3  : ror16_const2 = {value_i[2:0],  value_i[15:3]};
            4'd4  : ror16_const2 = {value_i[3:0],  value_i[15:4]};
            4'd5  : ror16_const2 = {value_i[4:0],  value_i[15:5]};
            4'd6  : ror16_const2 = {value_i[5:0],  value_i[15:6]};
            4'd7  : ror16_const2 = {value_i[6:0],  value_i[15:7]};
            4'd8  : ror16_const2 = {value_i[7:0],  value_i[15:8]};
            4'd9  : ror16_const2 = {value_i[8:0],  value_i[15:9]};
            4'd10 : ror16_const2 = {value_i[9:0],  value_i[15:10]};
            4'd11 : ror16_const2 = {value_i[10:0], value_i[15:11]};
            4'd12 : ror16_const2 = {value_i[11:0], value_i[15:12]};
            4'd13 : ror16_const2 = {value_i[12:0], value_i[15:13]};
            4'd14 : ror16_const2 = {value_i[13:0], value_i[15:14]};
            default : ror16_const2 = {value_i[14:0], value_i[15]};
        endcase
    end
endfunction

function [15:0] andrx_cell_const2;
    input [15:0] src_i;
    input [15:0] dst_i;
    input        phase_sel_i;
    begin
        andrx_cell_const2 =
            ((phase_sel_i ? ror16_const2(src_i, ALPHA1) : ror16_const2(src_i, ALPHA0)) &
             (phase_sel_i ? ror16_const2(src_i, BETA1)  : ror16_const2(src_i, BETA0))) ^
             (phase_sel_i ? ror16_const2(src_i, GAMMA1) : ror16_const2(src_i, GAMMA0)) ^
             dst_i;
    end
endfunction

assign row_o[16*0 +: 16] = andrx_cell_const2(src_row_i[16*0 +: 16], dst_row_i[16*0 +: 16], phase_i);
assign row_o[16*1 +: 16] = andrx_cell_const2(src_row_i[16*1 +: 16], dst_row_i[16*1 +: 16], phase_i);
assign row_o[16*2 +: 16] = andrx_cell_const2(src_row_i[16*2 +: 16], dst_row_i[16*2 +: 16], phase_i);
assign row_o[16*3 +: 16] = andrx_cell_const2(src_row_i[16*3 +: 16], dst_row_i[16*3 +: 16], phase_i);
assign row_o[16*4 +: 16] = andrx_cell_const2(src_row_i[16*4 +: 16], dst_row_i[16*4 +: 16], phase_i);
assign row_o[16*5 +: 16] = andrx_cell_const2(src_row_i[16*5 +: 16], dst_row_i[16*5 +: 16], phase_i);
assign row_o[16*6 +: 16] = andrx_cell_const2(src_row_i[16*6 +: 16], dst_row_i[16*6 +: 16], phase_i);
assign row_o[16*7 +: 16] = andrx_cell_const2(src_row_i[16*7 +: 16], dst_row_i[16*7 +: 16], phase_i);
