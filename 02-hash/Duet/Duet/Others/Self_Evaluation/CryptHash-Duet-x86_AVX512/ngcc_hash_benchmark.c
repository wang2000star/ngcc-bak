...
#define NGCC_TARGET_VARIANT "ARMv8-NEON"
...
#define NGCC_TARGET_VARIANT "x86-AVX2-C"
#else
...
#if defined(__aarch64__) || defined(_M_ARM64)
#define NGCC_HASH_HEADER                                                       \
  "Duet-1024/CryptHash_Duet-1024.h"
#elif defined(__AVX512F__) && defined(__AVX512VL__)
#define NGCC_HASH_HEADER                                                       \
  "Duet-1024/CryptHash_Duet-1024.h"
#else
...
static void usage(const char *program) {
  fprintf(stderr,
          ...
          "  -DNGCC_HASH_HEADER='\"path/to/CryptHash_Duet-*.h\"'\n",
          program);
}
