...
DUET_FORCE_INLINE duet_neon6_t duet_neon6_xor(duet_neon6_t a,
                                               duet_neon6_t b) {
  duet_neon6_t r;
  r.p0 = veorq_u64(a.p0, b.p0);
  r.p1 = veorq_u64(a.p1, b.p1);
  r.p2 = veorq_u64(a.p2, b.p2);
  return r;
}

DUET_FORCE_INLINE duet_neon6_t duet_neon6_and(duet_neon6_t a,
                                               duet_neon6_t b) {
  duet_neon6_t r;
  r.p0 = vandq_u64(a.p0, b.p0);
  r.p1 = vandq_u64(a.p1, b.p1);
  r.p2 = vandq_u64(a.p2, b.p2);
  return r;
}

DUET_FORCE_INLINE duet_neon6_t duet_neon6_not(duet_neon6_t a) {
  duet_neon6_t r;
  const uint64x2_t ones = vdupq_n_u64(~UINT64_C(0));
  r.p0 = veorq_u64(a.p0, ones);
  r.p1 = veorq_u64(a.p1, ones);
  r.p2 = veorq_u64(a.p2, ones);
  return r;
}

DUET_FORCE_INLINE void duet_neon6_sbox5(
    duet_neon6_t r0, duet_neon6_t r1, duet_neon6_t r2,
    duet_neon6_t r3, duet_neon6_t r4, duet_neon6_t x[5]) {
  duet_neon6_t t0 = duet_neon6_and(r3, r4);
  duet_neon6_t t1 = duet_neon6_and(r2, r4);
  duet_neon6_t t2 = duet_neon6_and(r2, r3);
  duet_neon6_t t3 = duet_neon6_and(r1, r4);
  duet_neon6_t t4 = duet_neon6_and(r1, r2);
  duet_neon6_t t5 = duet_neon6_and(r0, r1);
  duet_neon6_t t6 = duet_neon6_xor(r4, r2);
  duet_neon6_t t7 = duet_neon6_xor(r0, t0);
  duet_neon6_t t8 = duet_neon6_xor(t1, t2);
  duet_neon6_t t9 = duet_neon6_xor(t3, t4);
  duet_neon6_t t10 = duet_neon6_xor(t5, t6);
  duet_neon6_t t11 = duet_neon6_xor(t7, t8);
  duet_neon6_t t12 = duet_neon6_xor(t9, t10);
  duet_neon6_t t13 = duet_neon6_xor(t11, t12);
  duet_neon6_t t15 = duet_neon6_and(r1, r3);
  duet_neon6_t t16 = duet_neon6_and(r0, r2);
  duet_neon6_t t17 = duet_neon6_xor(r3, r2);
  duet_neon6_t t18 = duet_neon6_xor(r0, t1);
  duet_neon6_t t19 = duet_neon6_xor(t2, t15);
  duet_neon6_t t20 = duet_neon6_xor(t4, t16);
  duet_neon6_t t21 = duet_neon6_xor(t17, t18);
  duet_neon6_t t22 = duet_neon6_xor(t19, t20);
  duet_neon6_t t23 = duet_neon6_xor(t21, t22);
  duet_neon6_t t25 = duet_neon6_and(r0, r4);
  duet_neon6_t t26 = duet_neon6_xor(r2, r0);
  duet_neon6_t t27 = duet_neon6_xor(t0, t1);
  duet_neon6_t t28 = duet_neon6_xor(t3, t15);
  duet_neon6_t t29 = duet_neon6_xor(t4, t25);
  duet_neon6_t t30 = duet_neon6_xor(t16, t5);
  duet_neon6_t t31 = duet_neon6_xor(t26, t27);
  duet_neon6_t t32 = duet_neon6_xor(t28, t29);
  duet_neon6_t t33 = duet_neon6_xor(t30, t31);
  duet_neon6_t t35 = duet_neon6_and(r0, r3);
  duet_neon6_t t36 = duet_neon6_xor(r4, r3);
  duet_neon6_t t37 = duet_neon6_xor(r1, r0);
  duet_neon6_t t38 = duet_neon6_xor(t4, t35);
  duet_neon6_t t39 = duet_neon6_xor(t16, t5);
  duet_neon6_t t40 = duet_neon6_xor(t36, t37);
  duet_neon6_t t41 = duet_neon6_xor(t38, t39);
  duet_neon6_t t42 = duet_neon6_xor(t40, t41);
  duet_neon6_t t44 = duet_neon6_xor(r4, r2);
  duet_neon6_t t45 = duet_neon6_xor(r1, r0);
  duet_neon6_t t46 = duet_neon6_xor(t3, t15);
  duet_neon6_t t47 = duet_neon6_xor(t4, t25);
  duet_neon6_t t48 = duet_neon6_xor(t5, t44);
  duet_neon6_t t49 = duet_neon6_xor(t45, t46);
  duet_neon6_t t50 = duet_neon6_xor(t47, t48);
  x[0] = duet_neon6_not(t13);
  x[1] = duet_neon6_not(t23);
  x[2] = duet_neon6_xor(t32, t33);
  x[3] = duet_neon6_not(t42);
  x[4] = duet_neon6_xor(t49, t50);
}

DUET_FORCE_INLINE duet_neon6_t duet_neon6_rot(duet_neon6_t x,
                                               unsigned int k) {
  duet_neon6_t r;
  switch (k) {
  case 0:
    return x;
  case 1:
    r.p0 = vextq_u64(x.p0, x.p1, 1);
    r.p1 = vextq_u64(x.p1, x.p2, 1);
    r.p2 = vextq_u64(x.p2, x.p0, 1);
    return r;
  case 2:
    r.p0 = x.p1;
    r.p1 = x.p2;
    ...
    return r;
  case 3:
    r.p0 = vextq_u64(x.p1, x.p2, 1);
    r.p1 = vextq_u64(x.p2, x.p0, 1);
    r.p2 = vextq_u64(x.p0, x.p1, 1);
    return r;
  case 4:
    r.p0 = x.p2;
    r.p1 = x.p0;
    ...
    return r;
  default:
    r.p0 = vextq_u64(x.p2, x.p0, 1);
    r.p1 = vextq_u64(x.p0, x.p1, 1);
    r.p2 = vextq_u64(x.p1, x.p2, 1);
    return r;
  }
}

#define DUET_NEON6_L30_TERM(row, off)                                        \
  duet_neon6_rot(x[((row) + (off)) % 5], (((row) + (off)) / 5) % 6)

#define DUET_NEON6_BUILD_L30(row, dst)                                       \
  do {                                                                       \
    (dst) = DUET_NEON6_L30_TERM((row), 0);                                   \
    (dst) = duet_neon6_xor((dst), DUET_NEON6_L30_TERM((row), 3));            \
    (dst) = duet_neon6_xor((dst), DUET_NEON6_L30_TERM((row), 10));           \
    (dst) = duet_neon6_xor((dst), DUET_NEON6_L30_TERM((row), 13));           \
    (dst) = duet_neon6_xor((dst), DUET_NEON6_L30_TERM((row), 14));           \
    (dst) = duet_neon6_xor((dst), DUET_NEON6_L30_TERM((row), 15));           \
    (dst) = duet_neon6_xor((dst), DUET_NEON6_L30_TERM((row), 16));           \
    (dst) = duet_neon6_xor((dst), DUET_NEON6_L30_TERM((row), 18));           \
    (dst) = duet_neon6_xor((dst), DUET_NEON6_L30_TERM((row), 21));           \
    (dst) = duet_neon6_xor((dst), DUET_NEON6_L30_TERM((row), 26));           \
    (dst) = duet_neon6_xor((dst), DUET_NEON6_L30_TERM((row), 28));           \
  } while (0)

DUET_FORCE_INLINE duet_neon6_t duet_neon6_l64(duet_neon6_t y,
                                               unsigned int row) {
  duet_neon6_t r;
  r.p0 = duet_neon_set2(DUET_L64(vgetq_lane_u64(y.p0, 0), row),
                        DUET_L64(vgetq_lane_u64(y.p0, 1), row + 5U));
  r.p1 = duet_neon_set2(DUET_L64(vgetq_lane_u64(y.p1, 0), row + 10U),
                        DUET_L64(vgetq_lane_u64(y.p1, 1), row + 15U));
  r.p2 = duet_neon_set2(DUET_L64(vgetq_lane_u64(y.p2, 0), row + 20U),
                        DUET_L64(vgetq_lane_u64(y.p2, 1), row + 25U));
  return r;
}

DUET_FORCE_INLINE duet_neon6_t duet_neon6_load_row(const uint64_t *s,
                                                    unsigned int row) {
  duet_neon6_t r;
  uint64_t tmp0[2] = {s[row], s[5 + row]};
  uint64_t tmp1[2] = {s[10 + row], s[15 + row]};
  uint64_t tmp2[2] = {s[20 + row], s[25 + row]};
  r.p0 = vld1q_u64(tmp0);
  r.p1 = vld1q_u64(tmp1);
  r.p2 = vld1q_u64(tmp2);
  return r;
...
DUET_FORCE_INLINE void duet_neon6_store_row(uint64_t *s, unsigned int row,
                                             duet_neon6_t r) {
  uint64_t tmp0[2];
  uint64_t tmp1[2];
  uint64_t tmp2[2];
...
DUET_FORCE_INLINE void permutation1920_neon_round(
    duet_neon6_t *r0, duet_neon6_t *r1, duet_neon6_t *r2, duet_neon6_t *r3,
    duet_neon6_t *r4, uint64_t rc) {
  duet_neon6_t x[5];
  duet_neon6_t y0, y1, y2, y3, y4;

  duet_neon6_sbox5(*r0, *r1, *r2, *r3, *r4, x);

  DUET_NEON6_BUILD_L30(0, y0);
  DUET_NEON6_BUILD_L30(1, y1);
  DUET_NEON6_BUILD_L30(2, y2);
  DUET_NEON6_BUILD_L30(3, y3);
  DUET_NEON6_BUILD_L30(4, y4);

  y0.p0 = veorq_u64(y0.p0, vsetq_lane_u64(rc, vdupq_n_u64(0), 0));

  *r0 = duet_neon6_l64(y0, 0);
  *r1 = duet_neon6_l64(y1, 1);
  *r2 = duet_neon6_l64(y2, 2);
  *r3 = duet_neon6_l64(y3, 3);
  *r4 = duet_neon6_l64(y4, 4);
}

static DUET_NOINLINE void permutation1920_neon(uint64_t s[WORDS_PERM],
                                               const uint64_t rc[ROUNDS]) {
  duet_neon6_t r0 = duet_neon6_load_row(s, 0);
  duet_neon6_t r1 = duet_neon6_load_row(s, 1);
  duet_neon6_t r2 = duet_neon6_load_row(s, 2);
  duet_neon6_t r3 = duet_neon6_load_row(s, 3);
  duet_neon6_t r4 = duet_neon6_load_row(s, 4);
  unsigned int round;

  for (round = 0; round < ROUNDS; ++round) {
    permutation1920_neon_round(&r0, &r1, &r2, &r3, &r4, rc[round]);
  }

  duet_neon6_store_row(s, 0, r0);
  duet_neon6_store_row(s, 1, r1);
  duet_neon6_store_row(s, 2, r2);
  duet_neon6_store_row(s, 3, r3);
  duet_neon6_store_row(s, 4, r4);
}

#define permutation1920 permutation1920_neon
