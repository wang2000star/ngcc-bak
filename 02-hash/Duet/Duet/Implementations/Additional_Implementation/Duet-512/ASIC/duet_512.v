...
// duet_512.v
// ------
// Top level wrapper for the Duet-512 hash function providing a simple
// memory-like interface with 32-bit data access. Modelled on the
// SHA-512/Cuishen-512/1024 style wrapper (cuishen.v / sha512.v).
//
...
//   0x10..0x17      BLOCK   (12 x 32-bit = 384-bit message block, MSB word first)
//   0x40..0x4f      DIGEST  (16 x 32-bit = 512-bit digest, ro)
//
...
// writing it through BLOCK0..BLOCK11 and pulsing CTRL.absorb; this
// mirrors how the 512/1024-bit Cuishen wrappers expect a pre-padded
// tail block from the host rather than padding in hardware.
//
//======================================================================
...
module duet(
  ...
  always @*
    begin : api_logic
      ...
      block_addr = address[3 : 0] - ADDR_BLOCK0[3 : 0];
