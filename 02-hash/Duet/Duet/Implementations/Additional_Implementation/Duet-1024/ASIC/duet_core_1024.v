...
// duet_core_1024.v
// ------------------
// Verilog 2001 implementation of the Duet-1024 hash core (shared with
// Duet-768 at the permutation level via the common duet_perm_unit_768
// and duet_pi_constants_768 modules; only the rate/capacity split and
// the sigma word-permutation table differ between the two variants).
//
// Parameters: r = 768 bits (rate, A/B = 12 x 64-bit words),
// c = 1152 bits (capacity, C = 18 x 64-bit words), permutation
// width = 1920 bits (30 x 64-bit words), ROUNDS = 18.
// digest_len = 1024 bits, which is <= c, so a single capacity
// readout after the final absorb is sufficient (no extra squeeze
// rounds are ever needed for the fixed-length Duet-1024 digest).
//
// ARCHITECTURE: Single duet_perm_unit_768 instantiated to save area
// (the permutation datapath is identical to Duet-768's; only this
// core's rate/capacity wiring and the sigma table below differ).
// f1 and f2 are multiplexed onto the same physical 1920-bit
// datapath since they run strictly sequentially, exactly as in
// duet_core.v (Duet-512) and duet_core_768.v (Duet-768).
//
//======================================================================

`default_nettype none

module duet_core_1024(
                 input wire             clk,
                 input wire             reset_n,

                 input wire             init,   // clear A,B,C to zero
                 input wire             absorb, // absorb one padded 768-bit block

                 input wire [767 : 0]   block,  // Mi, MSB word first (12 x 64-bit)
  ...
  assign digest       = {C0_reg, C1_reg, C2_reg, C3_reg, C4_reg, C5_reg, C6_reg, C7_reg, C8_reg, C9_reg, C10_reg, C11_reg, C12_reg, C13_reg, C14_reg, C15_reg};
  ...
  // directly from the C reference's sigma_permutation() for r=768
  // (WORDS_r=12): [8, 2, 11, 0, 5, 9, 3, 10, 1, 7, 4, 6]
  //----------------------------------------------------------------
  always @*
    begin : sigma_logic
      ...
      if (latch_sigma_m)
        begin
          SM0_new = block[255:192]; // in[8]
          SM1_new = block[639:576]; // in[2]
          SM2_new = block[63:0]; // in[11]
          SM3_new = block[767:704]; // in[0]
          SM4_new = block[447:384]; // in[5]
          SM5_new = block[191:128]; // in[9]
          SM6_new = block[575:512]; // in[3]
          SM7_new = block[127:64]; // in[10]
          SM8_new = block[703:640]; // in[1]
          SM9_new = block[319:256]; // in[7]
          SM10_new = block[511:448]; // in[4]
          SM11_new = block[383:320]; // in[6]
          SM_we   = 1'b1;
        end
    end // sigma_logic
    ...
    begin : reg_update
      if (!reset_n)
        begin
          ...
          C12_reg<=64'h0; C13_reg<=64'h0; C14_reg<=64'h0; C15_reg<=64'h0; C16_reg<=64'h0; C17_reg<=64'h0;
          ...
          CL12_reg<=64'h0; CL13_reg<=64'h0; CL14_reg<=64'h0; CL15_reg<=64'h0; CL16_reg<=64'h0; CL17_reg<=64'h0;
        ...
        begin
          if (A_we) begin
              ...
              A10_reg<=A10_new; A11_reg<=A11_new;
          end
          if (B_we) begin
              ...
              B10_reg<=B10_new; B11_reg<=B11_new;
          end
          if (C_we) begin
              ...
              C10_reg<=C10_new; C11_reg<=C11_new; C12_reg<=C12_new; C13_reg<=C13_new; C14_reg<=C14_new;
              C15_reg<=C15_new; C16_reg<=C16_new; C17_reg<=C17_new;
          end
          if (CL_we) begin
              ...
              CL10_reg<=CL10_new; CL11_reg<=CL11_new; CL12_reg<=CL12_new; CL13_reg<=CL13_new; CL14_reg<=CL14_new;
              CL15_reg<=CL15_new; CL16_reg<=CL16_new; CL17_reg<=CL17_new;
          end
          if (SM_we) begin
              ...
              SM10_reg<=SM10_new; SM11_reg<=SM11_new;
          end
          if (ready_we)
            ready_reg <= ready_new;
          if (digest_valid_we)
  ...
  always @*
    begin : chain_logic
      ...
      C12_new=64'h0; C13_new=64'h0; C14_new=64'h0; C15_new=64'h0; C16_new=64'h0; C17_new=64'h0;
      ...
      CL12_new=64'h0; CL13_new=64'h0; CL14_new=64'h0; CL15_new=64'h0; CL16_new=64'h0; CL17_new=64'h0;
      ...
      if (capture_f1)
        begin
          ...
          CL0_new = perm_result[1151:1088] ^ C0_reg;
          CL1_new = perm_result[1087:1024] ^ C1_reg;
          CL2_new = perm_result[1023:960] ^ C2_reg;
          CL3_new = perm_result[959:896] ^ C3_reg;
          CL4_new = perm_result[895:832] ^ C4_reg;
          CL5_new = perm_result[831:768] ^ C5_reg;
          CL6_new = perm_result[767:704] ^ C6_reg;
          CL7_new = perm_result[703:640] ^ C7_reg;
          CL8_new = perm_result[639:576] ^ C8_reg;
          CL9_new = perm_result[575:512] ^ C9_reg;
          CL10_new = perm_result[511:448] ^ C10_reg;
          CL11_new = perm_result[447:384] ^ C11_reg;
          CL12_new = perm_result[383:320] ^ C12_reg;
          CL13_new = perm_result[319:256] ^ C13_reg;
          CL14_new = perm_result[255:192] ^ C14_reg;
          CL15_new = perm_result[191:128] ^ C15_reg;
          CL16_new = perm_result[127:64] ^ C16_reg;
          CL17_new = perm_result[63:0] ^ C17_reg;
          CL_we   = 1'b1;
        end
      ...
      if (capture_f2)
        begin
          ...
          C0_new = perm_result[1151:1088] ^ CL0_reg;
          C1_new = perm_result[1087:1024] ^ CL1_reg;
          C2_new = perm_result[1023:960] ^ CL2_reg;
          C3_new = perm_result[959:896] ^ CL3_reg;
          C4_new = perm_result[895:832] ^ CL4_reg;
          C5_new = perm_result[831:768] ^ CL5_reg;
          C6_new = perm_result[767:704] ^ CL6_reg;
          C7_new = perm_result[703:640] ^ CL7_reg;
          C8_new = perm_result[639:576] ^ CL8_reg;
          C9_new = perm_result[575:512] ^ CL9_reg;
          C10_new = perm_result[511:448] ^ CL10_reg;
          C11_new = perm_result[447:384] ^ CL11_reg;
          C12_new = perm_result[383:320] ^ CL12_reg;
          C13_new = perm_result[319:256] ^ CL13_reg;
          C14_new = perm_result[255:192] ^ CL14_reg;
          C15_new = perm_result[191:128] ^ CL15_reg;
          C16_new = perm_result[127:64] ^ CL16_reg;
          C17_new = perm_result[63:0] ^ CL17_reg;
          C_we    = 1'b1;
        end
    end // chain_logic
    ...
    begin : perm_input_logic
      if (is_f2) begin
        perm_load_state = {
                           ...
                           perm_result[1151:1088] ^ C0_reg, perm_result[1087:1024] ^ C1_reg,
                           perm_result[1023:960] ^ C2_reg, perm_result[959:896] ^ C3_reg,
                           perm_result[895:832] ^ C4_reg, perm_result[831:768] ^ C5_reg,
                           perm_result[767:704] ^ C6_reg, perm_result[703:640] ^ C7_reg,
                           perm_result[639:576] ^ C8_reg, perm_result[575:512] ^ C9_reg,
                           perm_result[511:448] ^ C10_reg, perm_result[447:384] ^ C11_reg,
                           perm_result[383:320] ^ C12_reg, perm_result[319:256] ^ C13_reg,
                           perm_result[255:192] ^ C14_reg, perm_result[191:128] ^ C15_reg,
                           perm_result[127:64] ^ C16_reg, perm_result[63:0] ^ C17_reg};
      end else begin
        perm_load_state = {
                           A0_reg ^ block[767:704], A1_reg ^ block[703:640], A2_reg ^ block[639:576],
                           A3_reg ^ block[575:512], A4_reg ^ block[511:448], A5_reg ^ block[447:384],
                           A6_reg ^ block[383:320], A7_reg ^ block[319:256], A8_reg ^ block[255:192],
                           A9_reg ^ block[191:128], A10_reg ^ block[127:64], A11_reg ^ block[63:0],
                           C0_reg, C1_reg, C2_reg, C3_reg, C4_reg,
                           C5_reg, C6_reg, C7_reg, C8_reg, C9_reg,
                           C10_reg, C11_reg, C12_reg, C13_reg, C14_reg,
                           C15_reg, C16_reg, C17_reg};
      end
...
endmodule // duet_core_1024

//======================================================================
// EOF duet_core_1024.v
//======================================================================
