...
#define FEILIAN_VERSION UINT64_C(0x400)
#define HASH_BYTES      128   /* 1024 / 8 */
#define HASH_ROWS       4     /* output all 4 rows */
...
/* ========================================================================== */
/*  BLAKE2 shuffle masks — ROT8/24/40 all 1-instruction VPSHUFB               */
/* ========================================================================== */
...
/* ========================================================================== */
/*  SBOX — 6 BLAKE2 rotations {5,8,11,63,48,41}, all HW shortcuts            */
/* ========================================================================== */

#define SBOX_SIMD(r0, r1, r2, r3)                                       \
do {                                                                     \
    /* First half: a+=b, c+=d, d^=a, d=ROT8(d) */                       \
...
/* ========================================================================== */
/*  Compression function — BLAKE2 rot + unrolled groups                       */
/*                                                                            */
/*  fab vector layout: {bits_mid, bits_lo, flag64, version64}                 */
/*    → state[3] = {version64, flag64, bits_lo, bits_mid}                    */
/* ========================================================================== */
    ...
    uint64_t bits_lo, uint64_t bits_mid)
{
    ...
    /* {bits_mid, bits_lo, flag64, version64} → lanes 3,2,1,0 */
    ...
    /* Identity permutation: load directly from block */
    ...
    /* 20 rounds — 5 groups × (1 msg + 3 non-msg) */
                                  ...
                                  uint8_t hash_out[HASH_BYTES])
{
    ...
    for (size_t i = 0; i < num_blocks; i++) {
        ...
        /* Pointer swap instead of copy_state */
        {
