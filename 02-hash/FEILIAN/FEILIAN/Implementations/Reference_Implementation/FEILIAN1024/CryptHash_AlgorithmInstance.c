...
/*  Round functions                                                           */
/*                                                                            */
/*  flag_and_bits[4] = {version64, flag64, bits_lo, bits_mid}                 */
/* ========================================================================== */
...
/*                                                                            */
/*  flag_and_bits layout:                                                     */
/*    [0] = version64                                                         */
/*    [1] = flag64 (0xFFFF... for last block, 0 otherwise)                    */
/*    [2] = hash_bits[0] (bits_lo)                                           */
/*    [3] = hash_bits[1] (bits_mid)                                          */
/* ========================================================================== */
                                  ...
                                  uint8_t hash_out[HASH_BYTES])
{
    ...
    for (size_t i = 0; i < num_blocks; i++) {
        /* Last block: accumulate actual message bits (excl. padding);
           other blocks: accumulate full 1024 bits */
              ...
              unsigned long long msg_len_bits, unsigned char *digest)
{
    ...
    /* Mask the last partial byte if not byte-aligned */
