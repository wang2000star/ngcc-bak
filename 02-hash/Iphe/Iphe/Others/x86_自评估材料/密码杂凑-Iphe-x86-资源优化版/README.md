# Iphe x86 资源优化版提交材料说明

本目录对应 Iphe x86 资源优化版 提交材料，包含源代码、自评估工程和数据、自评估报告、依赖说明。
...
进入 self_eval/ngcc_bench_iphe_resource/，按该目录 README.md 构建并运行。该工程只注册本版本算法 ID：iphe-512-res、iphe-768-res、iphe-1024-res。