# Iphe x86 性能优化版提交材料说明

本目录对应 Iphe x86 性能优化版 提交材料，包含源代码、自评估工程和数据、自评估报告、依赖说明。
...
进入 self_eval/ngcc_bench_iphe_performance/，按该目录 README.md 构建并运行。该工程只注册本版本算法 ID：iphe-512-perf、iphe-768-perf、iphe-1024-perf。