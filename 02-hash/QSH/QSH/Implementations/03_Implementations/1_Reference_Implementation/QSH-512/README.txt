QuantaSylva Hash (QSH) -- Reference Implementation: instance QSH-512
================================================================

Variant parameters
  word width w        : 32 bits
  ChaCha-Bahru rounds : 9 full R-rounds + 1 final column-only layer
  digest length       : 512 bits
  state h = 2048, message block m = h/2, chunk = 16 blocks, tree mode
...
Build & generate test vectors
  ...
  ./katgen           -> writes ./output/KAT_2_12_QSH-512.txt, KAT_2_23, KAT_2_33, KAT_Loop
