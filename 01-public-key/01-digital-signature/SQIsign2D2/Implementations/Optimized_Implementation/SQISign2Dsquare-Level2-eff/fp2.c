...
#if defined(SQISIGN_FP2_ASM_P255)
extern void fp2_mul255_asm(uint64_t *out, const uint64_t *a, const uint64_t *b);
extern void fp2_sqr255_asm(uint64_t *out, const uint64_t *a);
#define fp2_mul_asm fp2_mul255_asm
#define fp2_sqr_asm fp2_sqr255_asm
#define SQISIGN_USE_FP2_ASM 1
#elif defined(SQISIGN_FP2_ASM_P271)
extern void fp2_mul271_asm(uint64_t *out, const uint64_t *a, const uint64_t *b);
extern void fp2_sqr271_asm(uint64_t *out, const uint64_t *a);
#define fp2_mul_asm fp2_mul271_asm
#define fp2_sqr_asm fp2_sqr271_asm
#define SQISIGN_USE_FP2_ASM 1
#elif defined(SQISIGN_FP2_ASM_P320)
extern void fp2_mul320_asm(uint64_t *out, const uint64_t *a, const uint64_t *b);
extern void fp2_sqr320_asm(uint64_t *out, const uint64_t *a);
#define fp2_mul_asm fp2_mul320_asm
#define fp2_sqr_asm fp2_sqr320_asm
#define SQISIGN_USE_FP2_ASM 1
#elif defined(SQISIGN_FP2_ASM_P332)
extern void fp2_mul332_asm(uint64_t *out, const uint64_t *a, const uint64_t *b);
extern void fp2_sqr332_asm(uint64_t *out, const uint64_t *a);
#define fp2_mul_asm fp2_mul332_asm
#define fp2_sqr_asm fp2_sqr332_asm
#define SQISIGN_USE_FP2_ASM 1
#elif defined(SQISIGN_FP2_ASM_P511)
extern void fp2_mul511_asm(uint64_t *out, const uint64_t *a, const uint64_t *b);
extern void fp2_sqr511_asm(uint64_t *out, const uint64_t *a);
#define fp2_mul_asm fp2_mul511_asm
#define fp2_sqr_asm fp2_sqr511_asm
#define SQISIGN_USE_FP2_ASM 1
#elif defined(SQISIGN_FP2_ASM_P523)
extern void fp2_mul523_asm(uint64_t *out, const uint64_t *a, const uint64_t *b);
extern void fp2_sqr523_asm(uint64_t *out, const uint64_t *a);
#define fp2_mul_asm fp2_mul523_asm
#define fp2_sqr_asm fp2_sqr523_asm
#define SQISIGN_USE_FP2_ASM 1
#elif defined(SQISIGN_FP2_ASM_P1024)
extern void fp2_mul1024_asm(uint64_t *out, const uint64_t *a, const uint64_t *b);
extern void fp2_sqr1024_asm(uint64_t *out, const uint64_t *a);
#define fp2_mul_asm fp2_mul1024_asm
#define fp2_sqr_asm fp2_sqr1024_asm
#define SQISIGN_USE_FP2_ASM 1
#elif defined(SQISIGN_FP2_ASM_P1070)
extern void fp2_mul1070_asm(uint64_t *out, const uint64_t *a, const uint64_t *b);
extern void fp2_sqr1070_asm(uint64_t *out, const uint64_t *a);
#define fp2_mul_asm fp2_mul1070_asm
#define fp2_sqr_asm fp2_sqr1070_asm
#define SQISIGN_USE_FP2_ASM 1
#endif
...
{
#if defined(SQISIGN_USE_FP2_ASM)
    fp2_mul_asm((uint64_t *)x, (const uint64_t *)y, (const uint64_t *)z);
#else
    fp_t t0, t1;
...
{
#if defined(SQISIGN_USE_FP2_ASM)
    fp2_sqr_asm((uint64_t *)x, (const uint64_t *)y);
#else
    fp_t sum, diff;
...
{
    fp2_t *t1=(fp2_t*)malloc(sizeof(fp2_t)*len);
    fp2_t *t2=(fp2_t*)malloc(sizeof(fp2_t)*len);
    fp2_t inverse;
...
// square, then x0^2 + x1^2 must be a square in GF(p).
{
    ...
    uint8_t tmp_bytes[8*NWORDS_FIELD];
