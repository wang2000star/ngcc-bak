 ...
 */
void ibz_mat_init(int rows, int cols, ibz_t ***mat);
/** @brief finalize matrix with arbitrary dimensions
 */
void ibz_mat_finalize(int rows, int cols, ibz_t **mat);
...
void ibz_mat_print(int rows, int cols, const ibz_t **mat);
 ...
 */
static void ibz_content(ibz_t *content, const ibz_vec_4_t *v)
{
 ...
 * @return 1 if success, 0 otherwise
 */
int ibz_cornacchia_extended_modified(ibz_t *x,
                            ibz_t *y,
                            const ibz_t *n);
