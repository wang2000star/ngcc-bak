/*
 * fips202.c -- scalar FIPS-202 Keccak/SHAKE for SHUTTLE SHA3_MODE.
 *
 * Vendored verbatim from the Dilithium reference
 * (/home/jipengzhang/code/dilithium/ref/fips202.c); self-contained inside
 * SHUTTLE/.  All public symbols are re-namespaced via fips202.h (bound to the
 * SHUTTLE per-set/per-backend SHUTTLE_NAMESPACE).  Compiled ONLY under
 * SHA3_MODE.  Byte-identical FIPS-202 (SHAKE 0x1F domain byte, rates 168/136).
 */
