...
#define sign_shake256_absorb_twice                                             \
    DARTS_NAMESPACE(sign_shake256_absorb_twice)
void sign_shake256_absorb_twice(keccak_state *state, const uint8_t *in1,
...
#define xof256_absorbe_twice(STATE, IN, IN_LEN, IN2, IN2_LEN)                   \
    sign_shake256_absorb_twice(STATE, IN, IN_LEN, IN2, IN2_LEN)
...
#ifdef SIGN_USE_AES // stream: aes256
...
#define sign_shake128_stream_init                                              \
    DARTS_NAMESPACE(sign_shake128_stream_init)
void sign_shake128_stream_init(keccak_state *state,
                                 const uint8_t seed[SEEDBYTES], uint16_t nonce);

#define sign_shake256_stream_init                                              \
    DARTS_NAMESPACE(sign_shake256_stream_init)
void sign_shake256_stream_init(keccak_state *state,
...
#define stream128_init(STATE, SEED, NONCE)                                     \
    sign_shake128_stream_init(STATE, SEED, NONCE)
#define stream128_squeezeblocks(OUT, OUTBLOCKS, STATE)                         \
    shake128_squeezeblocks(OUT, OUTBLOCKS, STATE)
#define stream256_init(STATE, SEED, NONCE)                                     \
    sign_shake256_stream_init(STATE, SEED, NONCE)
#define stream256_squeezeblocks(OUT, OUTBLOCKS, STATE)                         \
    shake256_squeezeblocks(OUT, OUTBLOCKS, STATE)
