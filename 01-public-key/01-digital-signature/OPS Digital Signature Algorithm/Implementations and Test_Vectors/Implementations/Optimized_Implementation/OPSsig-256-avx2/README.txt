...
directory `OPSsig-256-avx2` for the OPS signature algorithm.

It corresponds to the C reference implementation in
`Implementations/Reference_Implementation/OPSsig-256` and uses the 256-bit
...
1.  The KAT generator writes
    `Test_Vectors/avx2/OPSsig-256/KAT_SIG_OPSsig-256-avx2.txt`.
...
6.  The algorithm instance string used by the API adapter is `OPSsig-256`,
