...
// KAT entry metadata for directory `OPSsig-256-avx2`, corresponding to
// `Implementations/Reference_Implementation/OPSsig-256`.
...
#define ALGORITHM_INSTANCE "OPSsig-256"
