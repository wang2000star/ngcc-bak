...
extern "C"
{
    ...
    /// @brief Four-lane pseudoXOF for equally sized inputs. It preserves the
    ///        single-lane output format while processing four streams in lockstep.
    /// @param[in] output_len_bits Total bits of each output stream
    /// @param[in] msg0-msg3 Base addresses of the four input byte arrays
    /// @param[in] msg_len_bits Total bits of each input stream
    /// @param[out] output0-output3 Base addresses of the four output byte arrays
    /// @return 0 for success, others for error
