...
// KAT entry metadata for directory `OPSsig-512-avx2`, corresponding to
// `Implementations/Reference_Implementation/OPSsig-512`.
// Set "ALGORITHM_INSTANCE" as your algorithm instance name (no more than 64 bytes).
// Only letters, numbers, '-' or '_' are permitted.
// This optimized directory emits the same instance-qualified test vector name
// as the corresponding reference implementation.
#define ALGORITHM_INSTANCE "OPSsig-512"
#define IMPLEMENTATION_VARIANT "avx2"
