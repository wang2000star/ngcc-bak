QingLuan-384 - Reference Implementation (single algorithm instance)
==================================================================
Security: classical 384-bit, quantum >= 192-bit. Post-quantum signature (R-SDP / MPC-in-the-Head / SM3).
...
KAT:    ./qingluan_kat  # writes KAT_SIG_QingLuan-384.txt: 10 deterministic, self-verified vectors
