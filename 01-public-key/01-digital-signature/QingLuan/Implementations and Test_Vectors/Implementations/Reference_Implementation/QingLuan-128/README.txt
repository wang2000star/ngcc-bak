QingLuan-128 - Reference Implementation (single algorithm instance)
==================================================================
Security: classical 128-bit; quantum 64-bit raw, meeting the NIST category-1 ("80-bit") floor as AES-128 under bounded-depth Grover (see ../../../Supporting_Documentation/parameters.md section 4.1). Post-quantum signature (R-SDP / MPC-in-the-Head / SM3).
...
KAT:    ./qingluan_kat  # writes KAT_SIG_QingLuan-128.txt: 10 deterministic, self-verified vectors
