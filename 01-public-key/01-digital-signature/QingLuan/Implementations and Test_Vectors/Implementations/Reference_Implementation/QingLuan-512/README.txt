QingLuan-512 - Reference Implementation (single algorithm instance)
==================================================================
Security: classical 512-bit, quantum >= 256-bit. Post-quantum signature (R-SDP / MPC-in-the-Head / SM3).
...
KAT:    ./qingluan_kat  # writes KAT_SIG_QingLuan-512.txt: 10 deterministic, self-verified vectors
