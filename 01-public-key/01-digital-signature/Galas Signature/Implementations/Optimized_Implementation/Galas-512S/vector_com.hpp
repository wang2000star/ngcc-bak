...
struct ggm_forest_bavc
{
    ...
    static void commit(const block_secpar<S> seed, const iv_t& iv,
    ...
    static void commit_from_roots(block_secpar<S>* roots, const iv_t& iv,
    ...
    static bool verify(const iv_t& iv, const uint8_t* __restrict__ opening,
...
struct one_tree_bavc
{
    ...
    static void commit(const block_secpar<S> seed, const iv_t& iv, block_secpar<S>* __restrict__ tree,
                        block_secpar<S>* __restrict__ leaves,
                        unsigned char* __restrict__ hashed_leaves);
    ...
    static bool verify(const iv_t& iv, const unsigned char* __restrict__ opening,
                        const uint8_t* __restrict__ delta, block_secpar<S>* __restrict__ leaves,
                        unsigned char* __restrict__ hashed_leaves);
};
