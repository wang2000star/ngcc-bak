/*
 * Protocol-core definitions for the SIG128_REF reference implementation.
...
#define SIG128_REF_PARAMETER_NOTE "Uses the current 128-bit parameter set as the submitted SIG128_REF instance with degree-10 extension arithmetic."
