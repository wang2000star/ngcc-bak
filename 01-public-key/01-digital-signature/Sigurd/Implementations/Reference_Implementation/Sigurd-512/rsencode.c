/*
 * GF(2^16) Reed-Solomon encoder for SIG512_REF.
 * The retained fixed transform covers the historical 18-to-144 packed shape;
...
enum
{
    ...
    kPrimitive = 0x1002D,
    kGenerator = 2,
    kFixedOriginalCount = 18,
    kFixedRecoveryCount = 144,
