/*
 * Protocol-core definitions for the SIG512_REF reference implementation.
...
#define SIG512_REF_PARAMETER_NOTE "Uses the current 512-bit parameter set as the submitted SIG512_REF instance."

/*
 * Optional compile-time sweep knobs; the checked-in default is rate factor 16
 * and 8 groups.  Only the combinations accepted below have matching Merkle and
 * opening-capacity derivations in this reference implementation.
 */
