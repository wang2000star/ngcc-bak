...
#define SPX_D 9
/* PORS+FP dimensions. */
#define SPX_PORS_FP_T 42429
#define SPX_PORS_FP_K 15
/* Winternitz parameter, */

#define SPX_WOTS_W_ARRAY {32, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64}
#define SPX_WOTS_LOGW_ARRAY {5, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6}

#define SPX_WOTS_LEN 26
#define WOTS_ZERO_BITS 5
#define WANTED_CHECKSUM  803  /*(SUM_W - SPX_WOTS_LEN) / 2)*/
...
#define SPX_PORS_FP_MAX_AUTH_NODES 160
