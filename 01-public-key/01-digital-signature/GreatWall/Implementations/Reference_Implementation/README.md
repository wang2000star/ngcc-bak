# GreatWall/Pylon Reference Implementation

This directory contains eight independent portable reference instances: `GreatWall128f/s`, `GreatWall192f/s`, `GreatWall256f/s`, and `GreatWall512f/s`.
...
```bash
cd /mnt/d/VsCode/AIMer/faest-one-tree-field-full/API_PKC/Implementations/Reference_Implementation
...
Benchmark and memory results are written to `benchmark_results.csv` and `memory_results.csv`. This version prioritizes portability and clarity over speed.
