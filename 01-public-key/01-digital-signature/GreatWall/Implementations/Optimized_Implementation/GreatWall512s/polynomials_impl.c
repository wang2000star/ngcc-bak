...
extern inline void poly512_words(uint64_t out[8], poly512_vec x);
extern inline poly512_vec poly512_from_words(const uint64_t in[8]);
extern inline void poly1024_words(uint64_t out[16], poly1024_vec x);
extern inline poly1024_vec poly1024_from_words(const uint64_t in[16]);
extern inline poly576_vec poly576_load(const void* s);
extern inline poly1024_vec poly1024_load(const void* s);
extern inline void poly576_store(void* d, poly576_vec x);
extern inline void poly1024_store(void* d, poly1024_vec x);
...
extern inline poly512_vec poly1x512_security_mul(poly1_vec x, poly512_vec y);
