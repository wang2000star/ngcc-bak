...
#ifndef SIG_RESOLVED_ALPHA_384F_H
#define SIG_RESOLVED_ALPHA_384F_H

#define OUTPUT_BLANK_TEST_VECTORS 0
#define ALGORITHM_INSTANCE "ReSolveD-alpha-384f"

#define SIG_PK_BYTES 288
#define SIG_SK_BYTES 96
#define SIG_SN_BYTES 40469
