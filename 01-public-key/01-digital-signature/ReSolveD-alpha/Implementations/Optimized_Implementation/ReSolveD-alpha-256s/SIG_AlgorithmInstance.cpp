...
using resolved_alpha_params = sig::resolved_alpha::resolved_alpha_256_s;
using resolved_alpha_scheme = sig::ngcc_sig_scheme<resolved_alpha_params>;

static_assert(resolved_alpha_scheme::sk_bytes == 64);
static_assert(resolved_alpha_scheme::pk_bytes == 194);
static_assert(resolved_alpha_scheme::sn_bytes == 13973);
