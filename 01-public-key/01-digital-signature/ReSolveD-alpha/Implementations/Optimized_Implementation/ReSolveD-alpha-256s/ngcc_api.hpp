#ifndef RESOLVED_ALPHA_NGCC_API_HPP
#define RESOLVED_ALPHA_NGCC_API_HPP
...
{
    static_assert(is_owf_with_rsd(P::owf_v),
                  "NGCC API supports Resolved-Alpha RSD parameters only");
