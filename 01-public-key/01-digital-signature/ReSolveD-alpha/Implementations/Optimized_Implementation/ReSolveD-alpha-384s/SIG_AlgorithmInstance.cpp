...
using resolved_alpha_params = sig::resolved_alpha::resolved_alpha_384_s;
using resolved_alpha_scheme = sig::ngcc_sig_scheme<resolved_alpha_params>;

static_assert(resolved_alpha_scheme::sk_bytes == 96);
static_assert(resolved_alpha_scheme::pk_bytes == 288);
static_assert(resolved_alpha_scheme::sn_bytes == 31575);
