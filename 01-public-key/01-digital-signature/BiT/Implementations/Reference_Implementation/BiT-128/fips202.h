/*
 * Header for fips202.c (Keccak / SHA-3 / SHAKE). Based on the public-domain
 * reference implementations by Ronny Van Keer (SUPERCOP) and the TweetFips202
 * authors (Gilles Van Assche, Daniel J. Bernstein, Peter Schwabe).
 * Public domain.
 */
#ifndef FIPS202_H
#define FIPS202_H
