/*
 * 4-way parallel Keccak (SHAKE128/256) for AVX2.
 * Taken from the pq-crystals reference implementation (Kyber / Dilithium,
 * https://github.com/pq-crystals), released by its authors to the public
 * domain (CC0 1.0; Apache-2.0 offered as an alternative upstream).
 * No copyright is asserted over this file by the BiT submitters.
 */
#ifndef FIPS202X4_H
#define FIPS202X4_H
