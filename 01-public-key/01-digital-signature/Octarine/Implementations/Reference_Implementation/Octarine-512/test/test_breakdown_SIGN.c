...
{
  switch(stage) {
  case SIGN_TEST_KEYGEN_MUL_AS1_NTT_A_X2:
  case SIGN_TEST_KEYGEN_MUL_AS1_NTT_S1_X2:
  case SIGN_TEST_KEYGEN_MUL_AS1_INVNTT_X2:
    return 2;
  case SIGN_TEST_KEYGEN_MUL_AS1_NTT_A_P1:
  case SIGN_TEST_KEYGEN_MUL_AS1_NTT_A_P2:
  case SIGN_TEST_KEYGEN_MUL_AS1_NTT_S1_P1:
  case SIGN_TEST_KEYGEN_MUL_AS1_NTT_S1_P2:
