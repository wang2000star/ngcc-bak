...
typedef enum {
  ...
  SIGN_TEST_KEYGEN_MUL_AS1_NTT_A_X2,
  SIGN_TEST_KEYGEN_MUL_AS1_NTT_A_P1,
  SIGN_TEST_KEYGEN_MUL_AS1_NTT_A_P2,
  SIGN_TEST_KEYGEN_MUL_AS1_NTT_S1_X2,
  SIGN_TEST_KEYGEN_MUL_AS1_NTT_S1_P1,
  SIGN_TEST_KEYGEN_MUL_AS1_NTT_S1_P2,
