...
void batch_S_FT_madd_gf16(unsigned char *P, const unsigned char *S, const unsigned char *FT,
        int m, int m_byte, int nb_monoms);

void batch_S_FT_madd_gf256(unsigned char *P, const unsigned char *S, const unsigned char *FT,
        int m, int m_byte, int nb_monoms);
