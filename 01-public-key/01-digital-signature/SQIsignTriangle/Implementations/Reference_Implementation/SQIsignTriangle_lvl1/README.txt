SQIsignTriangle_lvl1 — Reference_Implementation

This directory instantiates the ICCS API_PKC digital-signature interface for the
SQIsignTriangle "SQIsignTriangle_lvl1" parameter set, built with the "ref" backend.
...
- sqisigntriangle/        : self-contained SQIsignTriangle C source. Its
                            ...
                            call in the scheme uses SM3 (see Note 5 of the
                            template / §3.4(5) of the submission requirements).
