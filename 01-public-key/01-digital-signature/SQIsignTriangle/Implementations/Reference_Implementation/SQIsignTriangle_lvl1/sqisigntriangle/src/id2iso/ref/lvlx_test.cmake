...
add_executable(sqisign_id2iso_benchmark_qlapoti_normeq_${SVARIANT_LOWER} ${SOURCE_FILES_ID2ISO_QN_BENCH})
target_link_libraries(sqisign_id2iso_benchmark_qlapoti_normeq_${SVARIANT_LOWER} ${LIB_ID2ISO_${SVARIANT_UPPER}} sqisign_common_test)
target_include_directories(sqisign_id2iso_benchmark_qlapoti_normeq_${SVARIANT_LOWER} PRIVATE ${INC_PUBLIC} ${INC_EC} ${INC_PRECOMP_${SVARIANT_UPPER}} ${INC_QUATERNION} ${INC_HD} ${INC_ID2ISO} ${INC_GF} ${INC_GF_${SVARIANT_UPPER}} ${INC_COMMON} ./include/ )
set(BM_BINS ${BM_BINS} sqisign_id2iso_benchmark_qlapoti_normeq_${SVARIANT_LOWER} CACHE INTERNAL "List of benchmark executables")
...
target_link_libraries(sqisign_id2iso_benchmark_dim2id2iso_${SVARIANT_LOWER} ${LIB_ID2ISO_${SVARIANT_UPPER}} sqisign_common_test)
target_include_directories(sqisign_id2iso_benchmark_dim2id2iso_${SVARIANT_LOWER} PRIVATE ${INC_PUBLIC} ${INC_EC} ${INC_PRECOMP_${SVARIANT_UPPER}} ${INC_QUATERNION} ${INC_HD} ${INC_ID2ISO} ${INC_GF} ${INC_GF_${SVARIANT_UPPER}} ${INC_COMMON} ./include/ )
