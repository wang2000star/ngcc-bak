...
# This file was *autogenerated* from the file /home/xingtingyu/code/temp/C-implementation/scripts/precomp/precompute_quaternion_data.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4)#!/usr/bin/env sage
...
bad_prime_products = [_sage_const_1  for o in orders]

for i in range (len(orders)):
    newprime = _sage_const_2 
    q = orders[i][_sage_const_0 ]
    while(len(primes_with_mq_square[i])<primes_per_order):
        if(kronecker(-q,newprime)==_sage_const_1  and (q<newprime)):
...
objs =     [
        [
            ...
            [
                Ibz(_sage_const_1 ),
                [Ibz(c) for c in (_sage_const_0 ,_sage_const_0 ,_sage_const_1 ,_sage_const_0 )]
            ],
            q
        ]
...
idlobjs =     [
        [
            ...
            # norm
            Ibz(abs(idl.row_space(ZZ).intersection((ZZ**_sage_const_4 ).submodule([[_sage_const_1 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ]])).basis()[_sage_const_0 ][_sage_const_0 ])),
            # left order
            '&MAXORD_O0',
        ]
...
with open('include/quaternion_data.h','w') as hfile:
    with open('quaternion_data.c','w') as cfile:
        ...
        print(f'#define NUM_ALTERNATE_EXTREMAL_ORDERS {len(orders)-_sage_const_1 }', file=hfile)
