...
class FpEl:
    ...
    ref_p9309_radix_map    = { 16: 13, 32: 29, 64: 53 }  # lvl2: 9*2^309-1
    ref_p1131016_radix_map = { 16: 12, 32: 29, 64: 61 }  # lvl6: 113*2^1016-1
    ...
    def __get_radix(self, word_size, arith=None):
        if arith == "ref" or arith is None:
            ...
            # lvl2
            elif self.p == 0x11fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
                return self.ref_p9309_radix_map[word_size]
            # lvl6
            elif self.p == :
                return self.ref_p1131016_radix_map[word_size]
