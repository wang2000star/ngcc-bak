...
int main(void) {
  // 64 (was 32): the filename is "PQCsignKAT_<SECRETKEYBYTES>_<ALGNAME>.req".
  // For lvl6, SECRETKEYBYTES=1409 (4 digits) makes it 32 chars + NUL = 33 bytes,
  // which overflowed a 32-byte buffer (the existing levels have 3-digit sizes).
