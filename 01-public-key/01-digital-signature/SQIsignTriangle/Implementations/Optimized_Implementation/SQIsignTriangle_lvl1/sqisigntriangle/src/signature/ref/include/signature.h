...
/**
 * @brief SQIsignTriangle signature computation
 *
 * @param sig Output: will contain the SQIsignTriangle signature
 * @param sk secret key
 * @param pk public key
 * @param m message
 * @param l size
 * @returns 1 if success, 0 otherwise
 */
int new_protocols_sign(new_signature_t *sig, const public_key_t *pk, secret_key_t *sk, const unsigned char *m, size_t l);
