...
// Type for elements of GF(p)
#define fp_t gf1131016

// Constants (Assumed to be in Montgomery form)
// Constants (Assumed to be in Montgomery form)
#define ZERO gf1131016_ZERO
#define ONE gf1131016_ONE
...
// #define fp_div3 gf1131016_div3

// Constant time selection and swapping
static inline void
fp_select(fp_t *d, const fp_t *a0, const fp_t *a1, uint32_t ctl)
{
    gf1131016_select(d, a0, a1, ctl);
}
// #define fp_select gf1131016_select

static inline void
fp_cswap(fp_t *a, fp_t *b, uint32_t ctl)
{
    gf1131016_cswap(a, b, ctl);
}
// #define fp_cswap gf1131016_cswap

// Comparisons for fp elements
static inline uint32_t
fp_is_zero(const fp_t *a)
{
    return gf1131016_iszero(a);
}
// #define fp_is_zero gf1131016_iszero

static inline uint32_t
fp_is_equal(const fp_t *a, const fp_t *b)
{
    return gf1131016_equals(a, b);
}
// #define fp_is_equal gf1131016_equals

// Set a uint32 to an Fp value
static inline void
fp_set_small(fp_t *d, uint32_t x)
{
    gf1131016_set_small(d, x);
}
// #define fp_set_small gf1131016_set_small

// Encoding and decoding of bytes
static inline void
fp_encode(void *dst, const fp_t *a)
{
    gf1131016_encode(dst, a);
}
// #define fp_encode gf1131016_encode
static inline uint32_t
fp_decode(fp_t *d, const void *src)
{
    return gf1131016_decode(d, src);
}
// #define fp_decode gf1131016_decode
static inline void
fp_decode_reduce(fp_t *d, const void *src, size_t len)
{
    gf1131016_decode_reduce(d, src, len);
}
// #define fp_decode_reduce gf1131016_decode_reduce
