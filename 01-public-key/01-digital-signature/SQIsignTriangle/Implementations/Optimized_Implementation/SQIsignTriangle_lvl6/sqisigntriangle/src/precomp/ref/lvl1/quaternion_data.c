...
#if 0
#elif GMP_LIMB_BITS == 16
{{._mp_alloc = 0, ._mp_size = 8, ._mp_d = (mp_limb_t[]) {0x57d4, 0x6ea9, 0xb136, 0x8b2f, 0xcc90, 0x7f3b, 0x9e66, 0x16a0} }}
#elif GMP_LIMB_BITS == 32
{{._mp_alloc = 0, ._mp_size = 4, ._mp_d = (mp_limb_t[]) {0x6ea957d4, 0x8b2fb136, 0x7f3bcc90, 0x16a09e66} }}
#elif GMP_LIMB_BITS == 64
{{._mp_alloc = 0, ._mp_size = 2, ._mp_d = (mp_limb_t[]) {0x8b2fb1366ea957d4, 0x16a09e667f3bcc90} }}
#endif
;
