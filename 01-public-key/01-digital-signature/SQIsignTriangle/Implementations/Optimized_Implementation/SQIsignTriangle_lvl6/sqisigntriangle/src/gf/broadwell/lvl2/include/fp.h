...
// Constants (Assumed to be in Montgomery form)
#define ZERO gf9309_ZERO
#define ONE gf9309_ONE
...
// #define fp_div3 gf9309_div3

// Constant time selection and swapping
static inline void
fp_select(fp_t *d, const fp_t *a0, const fp_t *a1, uint32_t ctl)
{
    gf9309_select(d, a0, a1, ctl);
}
// #define fp_select gf9309_select

static inline void
fp_cswap(fp_t *a, fp_t *b, uint32_t ctl)
{
    gf9309_cswap(a, b, ctl);
}
// #define fp_cswap gf9309_cswap

// Comparisons for fp elements
static inline uint32_t
fp_is_zero(const fp_t *a)
{
    return gf9309_iszero(a);
}
// #define fp_is_zero gf9309_iszero

static inline uint32_t
fp_is_equal(const fp_t *a, const fp_t *b)
{
    return gf9309_equals(a, b);
}
// #define fp_is_equal gf9309_equals

// Set a uint32 to an Fp value
static inline void
fp_set_small(fp_t *d, uint32_t x)
{
    gf9309_set_small(d, x);
}
// #define fp_set_small gf9309_set_small
...
// #define fp_encode gf9309_encode
static inline uint32_t
fp_decode(fp_t *d, const void *src)
{
    return gf9309_decode(d, src);
}
// #define fp_decode gf9309_decode
static inline void
fp_decode_reduce(fp_t *d, const void *src, size_t len)
{
    gf9309_decode_reduce(d, src, len);
}
// #define fp_decode_reduce gf9309_decode_reduce
