...
/* SM3 XOF using pseudoXOF for arbitrary length output
 * Uses the deliverer's pseudoXOF function to generate arbitrary length output */
void sm3_xof(unsigned char *out, unsigned long outlen,
              const unsigned char *in, unsigned long inlen) {
    /* Use pseudoXOF for arbitrary length output (supports any length) */
