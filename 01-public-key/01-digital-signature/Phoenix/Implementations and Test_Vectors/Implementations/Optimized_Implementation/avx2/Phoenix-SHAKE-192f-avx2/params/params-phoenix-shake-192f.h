...
#define SPX_GWOTS_W1 8
#define SPX_GWOTS_LOGW1 3
#define SPX_GWOTS_W2 16
#define SPX_GWOTS_LOGW2 4

/* Address length in bytes. */
#define SPX_ADDR_BYTES 32

/* GWOTS chain lengths. */
#define SPX_GWOTS_W1_LEN 36
#define SPX_GWOTS_W2_LEN 21
