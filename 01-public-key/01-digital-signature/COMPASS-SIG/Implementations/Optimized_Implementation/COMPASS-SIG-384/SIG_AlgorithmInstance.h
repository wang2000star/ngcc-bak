...
// Only letters, numbers, '-' or '_' are permitted
    ...
    #define ALGORITHM_INSTANCE "COMPASS-SIG-128"
#elif COMPASS_SIG_MODE == 256
    #define ALGORITHM_INSTANCE "COMPASS-SIG-256"
#elif COMPASS_SIG_MODE == 384
    #define ALGORITHM_INSTANCE "COMPASS-SIG-384"
#elif COMPASS_SIG_MODE == 512
    #define ALGORITHM_INSTANCE "COMPASS-SIG-512"
#else
    #define ALGORITHM_INSTANCE "COMPASS-SIG-UNKNOWN"
#endif
