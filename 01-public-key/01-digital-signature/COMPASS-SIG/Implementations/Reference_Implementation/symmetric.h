...
#define COMPASS_SIG_shake128_stream_init COMPASS_SIG_NAMESPACE(COMPASS_SIG_shake128_stream_init)
void COMPASS_SIG_shake128_stream_init(keccak_state *state,
                                    const uint8_t seed[SEEDBYTES],
                                    uint16_t nonce);

#define COMPASS_SIG_shake256_stream_init COMPASS_SIG_NAMESPACE(COMPASS_SIG_shake256_stream_init)
