...
typedef struct {
  ...
  bf160_t pending_v_1;
  bf160_t pending_v_2;
  bf160_t pending2_v_0;
  bf160_t pending2_v_1;
  bf160_t pending2_v_2;
  bf160_t pending3_v_0;
  bf160_t pending3_v_1;
  bf160_t pending3_v_2;
  int pending;      /* number of buffered updates, 0..3 */
} zk_hash_160_3_ctx;
