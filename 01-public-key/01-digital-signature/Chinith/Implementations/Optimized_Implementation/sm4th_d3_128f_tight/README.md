# sm4th-d3-128f-tight - Optimized Implementation

Optimized implementation of **sm4th-d3-128f-tight** with x86-oriented
...
```bash
make clean
make NDEBUG=1 PRG_ACCE=0 SM4_OWF_ACCE=0 FIELD_PCLMUL=0 KAT_SIG sm4th_d3_128f_tight_bench
```
...
./sm4th_d3_128f_tight_bench 100 0
```
