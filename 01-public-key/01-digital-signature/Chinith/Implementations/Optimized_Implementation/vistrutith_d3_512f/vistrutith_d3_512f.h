#ifndef VISTRUTITH_D3_512F_H
#define VISTRUTITH_D3_512F_H
 ...
 */
#define VISTRUTITH_D3_512F_PUBLIC_KEY_SIZE 128
/**
 * Size of the private key in bytes.
 */
#define VISTRUTITH_D3_512F_PRIVATE_KEY_SIZE 128
/**
...
static inline size_t vistrutith_d3_512f_signature_size(void) {
  return (size_t)vistrutith_params_d3_512f()->sig_size;
}
#define VISTRUTITH_D3_512F_SIGNATURE_SIZE (vistrutith_d3_512f_signature_size())
...
typedef struct {
  ...
  uint8_t* witness;
} vistrutith_d3_512f_unpacked_private_key_t;
...
// int vistrutith_d3_512f_sign(const uint8_t* sk, const uint8_t* message, size_t message_len, uint8_t* signature, size_t* signature_len);
...
int vistrutith_d3_512f_unpacked_sign_with_randomness(const vistrutith_d3_512f_unpacked_private_key_t* unpacked_sk, const uint8_t* message, size_t message_len, const uint8_t* rho, size_t rho_len, uint8_t* signature, size_t* signature_len);
