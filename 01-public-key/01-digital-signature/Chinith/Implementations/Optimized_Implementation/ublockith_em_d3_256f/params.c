...
static params_t ublockith_params_em_d3_256f_g = {
    .lambda = 256,
    .ell = 3072,
    .ske = 0,
    .senc = 1536,
...
const params_t* ublockith_params_em_d3_256f(void) {
  static int initialized = 0;
  if (!initialized) {
    init_params(&ublockith_params_em_d3_256f_g);
    initialized = 1;
  }
  return &ublockith_params_em_d3_256f_g;
}
