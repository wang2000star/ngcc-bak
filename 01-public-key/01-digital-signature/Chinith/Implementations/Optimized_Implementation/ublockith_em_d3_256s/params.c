...
static params_t ublockith_params_em_d3_256s_g = {
    .lambda = 256,
    .ell = 3072,
    .ske = 0,
    .senc = 1536,
    ...
    .lambda_bytes = 256 / 8,
    .ell_bytes = 3072 / 8,
    .ell_hat_bits = 3072 + 3 * 256 + UNIVERSAL_HASH_B_BITS,
    .ell_hat_bytes = (3072 + 3 * 256 + UNIVERSAL_HASH_B_BITS) / 8,
...
const params_t* ublockith_params_em_d3_256s(void) {
  static int initialized = 0;
  if (!initialized) {
    init_params(&ublockith_params_em_d3_256s_g);
    initialized = 1;
  }
  return &ublockith_params_em_d3_256s_g;
}
