...
├── ublockith_em_d3_256s.c / .h                   # Public API wrapper
├── ublockith_em_d3_256s_AlgorithmInstance.c / .h # Algorithm instance entry points
├── ublockith_em_d3_256s_bench.c                  # Benchmark entry (ms + Mcyc)
...
```bash
make ublockith_em_d3_256s_bench
```
...
```bash
./ublockith_em_d3_256s_bench
./ublockith_em_d3_256s_bench 100
./ublockith_em_d3_256s_bench 100 8
```
...
- Thus `./ublockith_em_d3_256s_bench` and `./ublockith_em_d3_256s_bench 100` run 100 fixed-56-byte sign/verify iterations, while `./ublockith_em_d3_256s_bench 100 8` forces the increasing-message run.

Baseline check command:

```bash
make NDEBUG=1 PRG_ACCE=1 FIELD_PCLMUL=1 USE_BALLET=1 ublockith_em_d3_256s_bench && ./ublockith_em_d3_256s_bench 20
```
