# vistrutith-d3-512s - Reference Implementation

Portable C reference implementation of **vistrutith-d3-512s**. This directory
...
Protocol parameters: `lambda=512`, `ell=6912`, `tau=44`, `w_grind=5`,
`T_open=480`, `B=16`, `d=3`.
...
./vistrutith_d3_512s_bench 100 0
./vistrutith_d3_512s_bench 100 8
```

`./vistrutith_d3_512s_bench` runs 100 fixed-56-byte sign/verify iterations by
