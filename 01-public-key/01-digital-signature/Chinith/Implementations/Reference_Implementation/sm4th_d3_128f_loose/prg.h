 ...
 *   * `and_276`: emits 276-byte output (+ optional sd writeback)
 */
...
/* Fused batched path: seed writeback + 2 * Nblock + 276-byte output. */
...
/* XOR-mapped variant of fused (2 * Nblock + 276 + seed writeback). */
