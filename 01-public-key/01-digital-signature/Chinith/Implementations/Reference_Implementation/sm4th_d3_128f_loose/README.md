# sm4th-d3-128f-loose - Reference Implementation

Portable C reference implementation of **sm4th-d3-128f-loose**. This directory
...
`ell=1808`, `tau=16`, `w_grind=8`, `T_open=110`, `B=16`, `d=3`.
...
├── sm4th_d3_128f_loose.c / .h             # Public API wrapper
...
| `SM4_SBOX_TABLE` | `1` | Fixed in `CFLAGS`; uses the portable SM4 S-box lookup table |
...
`./sm4th_d3_128f_loose_bench` runs 100 fixed-56-byte sign/verify iterations by
default.
