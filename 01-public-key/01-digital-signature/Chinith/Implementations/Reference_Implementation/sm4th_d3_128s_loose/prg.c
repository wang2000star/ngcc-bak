...
void prg_2_lambda_and_276_fixed_tweak_independent_batch_with_sd(
  ...
  prg_2_lambda_and_fixed_tweak_independent_batch_with_sd(
      keys, key_stride, iv, tweak_2lambda, tweak_276, sd_out, sd_stride, out_2lambda,
      out_2lambda_stride, out_276, out_276_stride, PRG_276_BYTES, seclvl, count);
}
...
void prg_2_lambda_and_276_fixed_tweak_independent_batch_with_sd_xor_map(
  ...
  prg_2_lambda_and_fixed_tweak_independent_batch_with_sd_xor_map(
      keys, key_stride, iv, tweak_2lambda, tweak_276, sd_out, sd_stride, sd_index_base,
      sd_index_xor, out_2lambda, out_2lambda_stride, out_276, out_276_stride, PRG_276_BYTES,
      seclvl, count);
}
