# sm4th-d3-128s-tight - Reference Implementation

Portable C reference implementation of **sm4th-d3-128s-tight**. This directory
...
`lambda_prg=256`, `ell=1808`, `tau=14`, `w_grind=7`, `T_open=131`, `B=16`,
