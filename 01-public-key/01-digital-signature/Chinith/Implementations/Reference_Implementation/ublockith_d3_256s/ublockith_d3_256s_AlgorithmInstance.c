...
#include "ublockith_d3_256s_AlgorithmInstance.h"
#include "drng.h"
...
{
	return UBLOCKITH_D3_256S_PUBLIC_KEY_SIZE;
}

unsigned long long sig_get_sk_len_bytes(void)
{
	return UBLOCKITH_D3_256S_PRIVATE_KEY_SIZE;
}

unsigned long long sig_get_sn_len_bytes(void)
{
	return UBLOCKITH_D3_256S_SIGNATURE_SIZE;
}
	...
	unsigned char *sk, unsigned long long *sk_len_bytes)
{
	...
	return ublockith_d3_256s_keygen(pk, sk, sk_key, sk_input);
}
	...
	unsigned char *sn, unsigned long long *sn_len_bytes)
{
	...
	return ublockith_d3_256s_sign_with_randomness(sk, m, (size_t) m_len_bytes, rho, sizeof(rho), sn, (size_t*) sn_len_bytes);
}
	...
	unsigned char *m, unsigned long long m_len_bytes)
{
	...
	return ublockith_d3_256s_verify(pk, m, (size_t) m_len_bytes, sn, (size_t) sn_len_bytes);
}
