# ublockith-d3-256f - Reference Implementation

Portable C reference implementation of **ublockith-d3-256f**. This directory
...
Protocol parameters: `lambda=256`, `ell=4608`, `tau=32`, `w_grind=8`,
`T_open=246`, `B=16`, `d=3`.
...
├── ublockith_d3_256f_bench.c              # Benchmark entry
...
`./ublockith_d3_256f_bench` runs 100 fixed-56-byte sign/verify iterations by
