# sm4th-em-d2-128s-loose - Reference Implementation

Portable C reference implementation of **sm4th-em-d2-128s-loose**. This
...
`ell=1024`, `tau=11`, `w_grind=7`, `T_open=103`, `B=16`, `d=2`.
...
├── sm4th_em_d2_128s_loose.c / .h          # Public API wrapper
...
`./sm4th_em_d2_128s_loose_bench` runs 100 fixed-56-byte sign/verify iterations
by default.
