...
#ifndef SM4TH_EM_D2_S_LOOSE_H
#define SM4TH_EM_D2_S_LOOSE_H
 ...
 */
#define SM4TH_EM_D2_S_LOOSE_PUBLIC_KEY_SIZE 32
/**
 * Size of the private key in bytes.
 */
#define SM4TH_EM_D2_S_LOOSE_PRIVATE_KEY_SIZE 32
/**
 * Size of the signature in bytes.
 */
static inline size_t sm4th_em_d2_128s_loose_signature_size(void) {
  return (size_t)sm4th_params_em_128s()->sig_size;
}
#define SM4TH_EM_D2_S_LOOSE_SIGNATURE_SIZE (sm4th_em_d2_128s_loose_signature_size())
...
typedef struct {
  ...
  uint8_t* witness;
} sm4th_em_d2_128s_loose_unpacked_private_key_t;
...
int sm4th_em_d2_128s_loose_unpacked_sign_with_randomness(const sm4th_em_d2_128s_loose_unpacked_private_key_t* unpacked_sk, const uint8_t* message, size_t message_len, const uint8_t* rho, size_t rho_len, uint8_t* signature, size_t* signature_len);
