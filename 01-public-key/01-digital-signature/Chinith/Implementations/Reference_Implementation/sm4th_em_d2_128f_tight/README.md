# sm4th-em-d2-128f-tight - Reference Implementation

Portable C reference implementation of **sm4th-em-d2-128f-tight**. This
...
`lambda_prg=256`, `ell=1024`, `tau=21`, `w_grind=8`, `T_open=140`, `B=16`,
