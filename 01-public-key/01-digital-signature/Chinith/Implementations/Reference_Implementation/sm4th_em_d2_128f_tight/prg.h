 ...
 *   * `and_170`: this em-d2-128f/bf160 path emits 170-byte
...
/* Fused batched path: seed writeback + 2 * Nblock + 170-byte output. */
...
/* XOR-mapped variant of fused (2 * Nblock + 170 + seed writeback). */
