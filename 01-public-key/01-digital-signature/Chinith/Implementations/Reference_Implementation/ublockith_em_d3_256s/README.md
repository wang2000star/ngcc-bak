# ublockith-em-d3-256s - Reference Implementation

Portable C reference implementation of **ublockith-em-d3-256s**. This directory
...
Protocol parameters: `lambda=256`, `ell=3072`, `tau=22`, `w_grind=6`,
`T_open=218`, `B=16`, `d=3`.
...
├── ublockith_em_d3_256s_bench.c           # Benchmark entry
...
`./ublockith_em_d3_256s_bench` runs 100 fixed-56-byte sign/verify iterations by
