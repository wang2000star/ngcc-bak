...
static params_t sm4th_params_d3_f_g = {
    .lambda = 128,
    .lambda_q = 80,
    .lambda_f = 160,
    .lambda_iv = 256,
    ...
    .iv_bytes = IV_SIZE,
    .ell_bytes = 1808 / 8,
    .ell_hat_bits = 1808 + 3 * 160 + UNIVERSAL_HASH_B_BITS,
    .ell_hat_bytes = (1808 + 3 * 160 + UNIVERSAL_HASH_B_BITS) / 8,
...
const params_t* sm4th_params_d3_f(void) {
  ...
  if (!initialized) {
    init_params(&sm4th_params_d3_f_g);
    initialized = 1;
  }
  return &sm4th_params_d3_f_g;
}
