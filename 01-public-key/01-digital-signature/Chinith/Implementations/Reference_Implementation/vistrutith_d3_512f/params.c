...
/*
 * Fixed parameter set for vistrutith_d3_512f.
 * Chosen to mirror the ublockith_d3_256f style:
 * - tau = 64
 * - T_open = 481
 * - with lambda=512 and w_grind=8:
 *   k = 8, k1=tau1=56, k0=tau0=8
 */
static params_t vistrutith_params_d3_512f_g = {
    .lambda = 512,
    .ell = 6912,
    .ske = 0,
    .senc = 1152,
...
const params_t* vistrutith_params_d3_512f(void) {
  static int initialized = 0;
  if (!initialized) {
    init_params(&vistrutith_params_d3_512f_g);
    initialized = 1;
  }
  return &vistrutith_params_d3_512f_g;
}
