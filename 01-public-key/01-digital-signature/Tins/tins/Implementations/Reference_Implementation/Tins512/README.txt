...
SIG_TINS512.c        Source file of Tins SIG scheme 

SIG_TINS512.h        Header file of Tins SIG scheme 
...
>gcc ff_arith.c SIG_TINS512.c drng.c bavc_commit.c auxfunc.c main.c -o main -O2

>./main

You can generate test vectors using the following  command.


>gcc ff_arith.c SIG_TINS512.c drng.c bavc_commit.c auxfunc.c KAT_SIG.c -o main -O2
