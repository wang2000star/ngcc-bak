                                   ...
                                   const block_secpar<S>* keys_in, size_t num_keys)
{
             ...
             i += KEYGEN_WIDTH, keys_in += KEYGEN_WIDTH, aeses += KEYGEN_WIDTH, ++keygen_states)
    {
        ...
        // Get ready for next rounds (starting with round 1 for 128 or 192 bit keys, or round 2
        // for 256 bit keys).
        if constexpr (S == secpar::s128)
        {
...
ALWAYS_INLINE void aes_keygen_only_impl(aes_round_keys<S>* __restrict__ aeses,
                                        const block_secpar<S>* __restrict__ keys)
{
    aes_keygen_state<S> keygen_states[(num_keys + KEYGEN_WIDTH - 1) / KEYGEN_WIDTH];
    aes_keygen_init(keygen_states, aeses, keys, num_keys);
...
#define DEF_AES_KEYGEN_ONLY_IMPL_SK(secparam, num_keys)                                            \
    template void aes_keygen_only_impl<secparam, num_keys>(                                        \
        aes_round_keys<secparam>* __restrict__ aeses,                                              \
        const block_secpar<secparam>* __restrict__ keys);
#define DEF_AES_KEYGEN_IMPL_SK1(secparam)                                                          \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 1)                                                        \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 2)                                                        \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 3)                                                        \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 4)                                                        \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 5)                                                        \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 6)                                                        \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 7)                                                        \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 8)                                                        \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 9)                                                        \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 10)                                                       \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 11)                                                       \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 12)                                                       \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 13)                                                       \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 14)                                                       \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 15)                                                       \
    DEF_AES_KEYGEN_IMPL_SKB(secparam, 1, 16)
...
#define DEF_AES_KEYGEN_IMPL_S(secparam)                                                            \
    DEF_AES_KEYGEN_IMPL_SK1(secparam)                                                              \
...
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s128, 1)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s128, 2)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s128, 3)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s128, 4)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s128, 5)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s128, 6)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s128, 7)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s128, 8)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s192, 1)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s192, 2)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s192, 3)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s192, 4)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s192, 5)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s192, 6)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s192, 7)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s192, 8)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s256, 1)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s256, 2)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s256, 3)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s256, 4)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s256, 5)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s256, 6)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s256, 7)
DEF_AES_KEYGEN_ONLY_IMPL_SK(secpar::s256, 8)
                                      ...
                                      block192* round_key_out)
{
    ...
    t3 ^= static_cast<uint32_t>(_mm_extract_epi32(t1, 3));
    t3 ^= t3 << 32;
                                ...
                                size_t round)
{
    ...
    if (round < RIJNDAEL_ROUNDS<secpar::s192>)
    {
        state[0] = {_mm_aesenc_si128(state[0].data, round_key[0].data)};
        state[1] = {_mm_aesenc_si128(state[1].data, round_key[1].data)};
    }
                                ...
                                size_t round)
{
    ...
    if (round < RIJNDAEL_ROUNDS<secpar::s256>)
    {
        state[0] = {_mm_aesenc_si128(state[0].data, round_key[0].data)};
        state[1] = {_mm_aesenc_si128(state[1].data, round_key[1].data)};
    }
