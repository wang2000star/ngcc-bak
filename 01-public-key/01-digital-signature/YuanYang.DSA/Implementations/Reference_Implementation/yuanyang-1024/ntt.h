...
void qntt_forward_partial(uint32_t a[YUANYANG_D],int logn);
...
void qntt_pointwise_mul_partial(
	uint32_t a[YUANYANG_D],
	const uint32_t b[YUANYANG_D],int logn);

/* Convenience wrappers for complete pointwise products. */
void qntt_mul(uint32_t a[YUANYANG_D], uint32_t b[YUANYANG_D]);

void qntt_mul_int(uint32_t a[YUANYANG_D], uint32_t b[YUANYANG_D]);
void qntt_mul_int_partial(uint32_t a[YUANYANG_D], uint32_t b[YUANYANG_D],int logn);
