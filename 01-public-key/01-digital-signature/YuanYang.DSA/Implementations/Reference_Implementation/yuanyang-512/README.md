# YuanYang DSA YuanYang-512 Reference Implementation

This directory contains the submission-facing reference C implementation for
YuanYang DSA YuanYang-512. It contains only the signature API, signature codecs,
...
The signature KAT generator writes `output/KAT_SIG_yuanyang-512.txt`.
