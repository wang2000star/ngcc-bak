#ifndef YUANYANG_2048_KEYGEN_CONSTANTS_H
#define YUANYANG_2048_KEYGEN_CONSTANTS_H

#include <stdint.h>

/*
 * Keygen-local floating constants from the 2048 parameter table and the
 * PairGen/SamplerPrecomp algorithms in the specification.
 */
#define YYKG_Q                  7681.0
#define YYKG_QUALITY_ALPHA      1.43
#define YYKG_LOWER_RADIUS       82.63
#define YYKG_UPPER_RADIUS       103.98
#define YYKG_SIGMA_SIG          118.22
#define YYKG_SMOOTHING_ETA      0.928
#define YYKG_NORM_FG_MIN        9000u
