# YuanYang DSA YuanYang-2048 Reference Implementation

This directory contains the submission-facing reference C implementation for
YuanYang DSA YuanYang-2048. It contains only the signature API, signature codecs,
...
The signature KAT generator writes `output/KAT_SIG_yuanyang-2048.txt`.
