...
/*
 * yuanyang-1024 reference signature API.
 */

#ifndef YUANYANG_1024_SIG_ALGORITHM_INSTANCE_H
#define YUANYANG_1024_SIG_ALGORITHM_INSTANCE_H

#define OUTPUT_BLANK_TEST_VECTORS 0
#define ALGORITHM_INSTANCE "yuanyang-1024"
