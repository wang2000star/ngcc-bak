...
/*
 * yuanyang-2048 reference signature API.
 */

#ifndef YUANYANG_2048_SIG_ALGORITHM_INSTANCE_H
#define YUANYANG_2048_SIG_ALGORITHM_INSTANCE_H

#define OUTPUT_BLANK_TEST_VECTORS 0
#define ALGORITHM_INSTANCE "yuanyang-2048"
