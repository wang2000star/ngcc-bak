...
#ifndef KAT_SIG_COUNT
#define KAT_SIG_COUNT 10
#endif
...
int main()
{
	...
	max_m_len_bytes = 56
		+ 8 * (KAT_SIG_COUNT > 0 ? KAT_SIG_COUNT - 1 : 0);
	...
	m = (unsigned char *)calloc((size_t)max_m_len_bytes, sizeof(unsigned char));
	for (int i = 0; i < KAT_SIG_COUNT; i++)
	{
