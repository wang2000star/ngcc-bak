#ifndef YUANYANG_512_KEYGEN_CONSTANTS_H
#define YUANYANG_512_KEYGEN_CONSTANTS_H

#include <stdint.h>

/*
 * Keygen-local floating constants from the 512 parameter table and the
 * PairGen/SamplerPrecomp algorithms in the specification.
 */
#define YYKG_Q                  2689.0
#define YYKG_QUALITY_ALPHA      1.29
#define YYKG_LOWER_RADIUS       49.1
#define YYKG_UPPER_RADIUS       58.0
#define YYKG_SIGMA_SIG          69.76
#define YYKG_SMOOTHING_ETA      1.026
#define YYKG_NORM_FG_MIN        2840u
