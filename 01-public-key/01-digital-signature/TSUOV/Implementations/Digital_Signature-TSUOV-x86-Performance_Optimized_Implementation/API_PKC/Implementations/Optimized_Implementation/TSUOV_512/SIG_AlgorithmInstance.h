...
// TSUOV parameter set selection and sizes. tsuov_params.h also defines
// "ALGORITHM_INSTANCE" ("TSUOV-128" / "TSUOV-256" / "TSUOV-512") according
// to the compile-time macro TSUOV_VARIANT (default 128).
// Build other levels with -DTSUOV_VARIANT=256 or -DTSUOV_VARIANT=512.
#include "tsuov_params.h"

#define CEIL_DIV(a, b) (((a) + (b) - 1) / (b))

//  Set these three values apropriately for your algorithm
#define CRYPTO_SECRETKEYBYTES (2*TSUOV_SEED_LEN)
#define CRYPTO_PUBLICKEYBYTES (CEIL_DIV(TSUOV_L*TSUOV_m1*TSUOV_O*(TSUOV_O+1)*5, 16) + TSUOV_SEED_LEN)
#define CRYPTO_BYTES (CEIL_DIV(TSUOV_n*TSUOV_k*5, 8) + TSUOV_SALT_LEN)

#if (TSUOV_security_strength_category == 1)
#define CRYPTO_ALGNAME "TSUOV1"
#elif (TSUOV_security_strength_category == 3)
#define CRYPTO_ALGNAME "TSUOV3"
#elif (TSUOV_security_strength_category == 5)
#define CRYPTO_ALGNAME "TSUOV5"
#else
#define CRYPTO_ALGNAME "TSUOV"
#endif
