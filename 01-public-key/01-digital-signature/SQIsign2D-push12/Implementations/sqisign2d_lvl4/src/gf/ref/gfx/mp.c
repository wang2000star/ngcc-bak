...
void
mp_mul2X1(digit_t *c, const digit_t *a, const digit_t *b)
{ // Multiprecision multiplication  to two-digit and one-digit operands
    unsigned int carry = 0;
    digit_t t0[2], t1[2], t2[2];
...
void
mp_mul3X1(digit_t *c, const digit_t *a, const digit_t *b)
{ // Multiprecision multiplication  to two-digit and one-digit operands
    unsigned int carry = 0;
    digit_t t0[2], t1[2], t2[2];
    ...
    MUL(t2, a[2], b[0]);
    ADDC(t0[1], carry, t0[1], t1[0], carry);
    ADDC(t1[1], carry, t2[0], t1[1], carry);
    ADDC(t2[1], carry, 0, t2[1], carry);
...
void
mp_mul4X1(digit_t *c, const digit_t *a, const digit_t *b)
{
    unsigned int carry = 0;
    ...
    ADDC(t0[1], carry, t0[1], t1[0], carry);
    ADDC(t1[1], carry, t2[0], t1[1], carry);
    ADDC(t2[1], carry, t3[0], t2[1], carry);
    ADDC(t3[1], carry, 0, t3[1], carry);
...
void
mp_mul5X1(digit_t *c, const digit_t *a, const digit_t *b)
{
    unsigned int carry = 0;
    digit_t t0[2], t1[2], t2[2], t3[2], t4[2];
    ...
    ADDC(t1[1], carry, t2[0], t1[1], carry);
    ADDC(t2[1], carry, t3[0], t2[1], carry);
    ADDC(t3[1], carry, t4[0], t3[1], carry);
    ADDC(t4[1], carry, 0, t4[1], carry);
...
void
mp_mul6X1(digit_t *c, const digit_t *a, const digit_t *b)
{
    unsigned int carry = 0;
    digit_t t0[2], t1[2], t2[2], t3[2], t4[2], t5[2];
    ...
    ADDC(t2[1], carry, t3[0], t2[1], carry);
    ADDC(t3[1], carry, t4[0], t3[1], carry);
    ADDC(t4[1], carry, t5[0], t4[1], carry);
    ADDC(t5[1], carry, 0, t5[1], carry);
...
void
mp_mul7X1(digit_t *c, const digit_t *a, const digit_t *b)
{
    unsigned int carry = 0;
    digit_t t0[2], t1[2], t2[2], t3[2], t4[2], t5[2], t6[2];
    ...
    ADDC(t3[1], carry, t4[0], t3[1], carry);
    ADDC(t4[1], carry, t5[0], t4[1], carry);
    ADDC(t5[1], carry, t6[0], t5[1], carry);
    ADDC(t6[1], carry, 0, t6[1], carry);
...
void
mp_mul8X1(digit_t *c, const digit_t *a, const digit_t *b)
{
    unsigned int carry = 0;
    digit_t t0[2], t1[2], t2[2], t3[2], t4[2], t5[2], t6[2], t7[2];
    ...
    ADDC(t4[1], carry, t5[0], t4[1], carry);
    ADDC(t5[1], carry, t6[0], t5[1], carry);
    ADDC(t6[1], carry, t7[0], t6[1], carry);
    ADDC(t7[1], carry, 0, t7[1], carry);
