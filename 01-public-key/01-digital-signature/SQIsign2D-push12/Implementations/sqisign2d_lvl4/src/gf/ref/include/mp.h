...
void mp_mul2X1(digit_t *c, const digit_t *a, const digit_t *b);
void mp_mul3X1(digit_t *c, const digit_t *a, const digit_t *b);
void mp_mul4X1(digit_t *c, const digit_t *a, const digit_t *b);
void mp_mul5X1(digit_t *c, const digit_t *a, const digit_t *b);
void mp_mul6X1(digit_t *c, const digit_t *a, const digit_t *b);
void mp_mul7X1(digit_t *c, const digit_t *a, const digit_t *b);
void mp_mul8X1(digit_t *c, const digit_t *a, const digit_t *b);
