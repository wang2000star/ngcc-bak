...
extern const uint64_t TORSION_ODD_PRIMES[5];
extern const uint64_t TORSION_ODD_POWERS[5];
...
extern const size_t DEGREE_COMMITMENT_POWERS[5];
extern const ibz_t CHARACTERISTIC;
extern const ibz_t TORSION_ODD;
extern const ibz_t TORSION_ODD_PRIMEPOWERS[5];
