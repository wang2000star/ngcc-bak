#include <intbig.h>
#define TORSION_2POWER_BYTES 66
#define TORSION_3POWER_BYTES 65
#define TORSION_23POWER_BYTES 131
...
extern const uint64_t TORSION_MINUS_ODD_PRIMES[3];
extern const size_t TORSION_MINUS_ODD_POWERS[3];
