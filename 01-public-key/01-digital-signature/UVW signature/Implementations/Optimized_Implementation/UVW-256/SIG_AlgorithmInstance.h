...
#define ALGORITHM_INSTANCE "UVW-256"
...
extern "C"
{
	...
	/// @param[out] sk Private key: seed(32B) || nonce_x(2B) || nonce_y(2B) || nonce_z(2B) || nonce_d(2B)
	...
	/// @brief Sign
	/// @param[in] sk Private key: seed(32B) || nonce_x(2B) || nonce_y(2B) || nonce_z(2B) || nonce_d(2B)
