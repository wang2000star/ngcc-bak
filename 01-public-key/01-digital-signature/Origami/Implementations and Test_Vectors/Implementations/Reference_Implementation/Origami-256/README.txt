Origami submission note:

This directory contains one submitted SIG instance.  For the implementation
platform, build method, benchmark method, and performance-evaluation template,
see ../../PERFORMANCE.md.
