...
using lynx_params = sig::lynx::lynx_160_f;
using lynx_scheme = sig::ngcc_sig_scheme<lynx_params>;

static_assert(lynx_scheme::sk_bytes == 40);
static_assert(lynx_scheme::pk_bytes == 40);
static_assert(lynx_scheme::sn_bytes == 5801);
