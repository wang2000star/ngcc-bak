...
using lynx_params = sig::lynx::lynx_256_f;
using lynx_scheme = sig::ngcc_sig_scheme<lynx_params>;

static_assert(lynx_scheme::sk_bytes == 64);
static_assert(lynx_scheme::pk_bytes == 64);
static_assert(lynx_scheme::sn_bytes == 15097);
