...
#ifndef SIG_COMPAT_ENDIAN_H
#define SIG_COMPAT_ENDIAN_H
...
#if !defined(SIG_IS_LITTLE_ENDIAN) && !defined(SIG_IS_BIG_ENDIAN)
#if defined(BIG_ENDIAN) && defined(LITTLE_ENDIAN)
#if defined(BYTE_ORDER) && BYTE_ORDER == BIG_ENDIAN
#define SIG_IS_BIG_ENDIAN
...
#if defined(SIG_IS_LITTLE_ENDIAN)
...
#elif defined(SIG_IS_BIG_ENDIAN)
