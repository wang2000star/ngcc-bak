...
#define SPX_WOTS_W_ARRAY {32, 32, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64}
#define SPX_WOTS_LOGW_ARRAY {5, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6}
#define SPX_MAX_WOTS_W 64

#define SPX_WOTS_LEN 26
#define WOTS_ZERO_BITS 6
#define SPX_FORS_ZERO_LAST_BITS 15 
#define WANTED_CHECKSUM  787  /*(SUM_W - SPX_WOTS_LEN) / 2)*/
