...
extern "C"
{
    ...
    /// @brief Multiply two binary polynomials in R2 of degree less than 256 using a constant-time cyclic shift-and-XOR method
    ...
    void mul_in_R2_128(int16_t *a, int16_t *b, int16_t *res);
