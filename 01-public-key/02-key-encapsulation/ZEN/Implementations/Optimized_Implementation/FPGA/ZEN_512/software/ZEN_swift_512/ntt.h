...
extern "C"
{
    ...
    static const int16_t qinv[ZEN_SWIFT_Q] = 
    {
    ...
    /// @brief Reduce a 32-bit integer modulo ZEN_SWIFT_Q using Montgomery reduction
    /// @param[in] a Input 32-bit integer to be reduced
    /// @return 16-bit integer reduced modulo ZEN_SWIFT_Q in Montgomery domain
    ...
    /// @brief Compute the forward Number Theoretic Transform (NTT) of a polynomial and map coefficients into the standard range modulo ZEN_SWIFT_Q
    /// @param[in,out] a Base address of input polynomial coefficient array; replaced by its NTT representation with coefficients reduced modulo ZEN_SWIFT_Q
    /// @return None
    ...
    /// @brief Perform block-wise polynomial multiplication in the NTT domain and map coefficients into the standard range modulo ZEN_SWIFT_Q
    /// @param[out] r Base address of output polynomial coefficient array
    /// @param[in] a Base address of first input polynomial coefficient array in NTT domain
    /// @param[in] b Base address of second input polynomial coefficient array in NTT domain
    /// @return None
    ...
    /// @brief Compute the inverse of a degree-15 polynomial block in the NTT domain with a given twiddle factor
    /// @param[out] r Base address of output coefficient array of length 16
    /// @param[in] a Base address of input coefficient array of length 16
    ...
    /// @param[out] r Base address of output polynomial coefficient array in NTT domain
