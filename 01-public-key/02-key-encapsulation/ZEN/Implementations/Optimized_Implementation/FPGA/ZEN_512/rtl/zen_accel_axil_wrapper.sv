module zen_accel_axil_wrapper #(
  ...
  zen_accel_top #(
    .BUF_BANKS          (BUF_BANKS),
    .NTT_BFLY_LANES     (NTT_BFLY_LANES),
    .BASEMUL_LANES      (BASEMUL_LANES),
    .BASEINV_LANES      (BASEINV_LANES),
    .BINARY_LANES       (BINARY_LANES),
    .BINARY_COL_FACTOR  (BINARY_COL_FACTOR),
    .SAMPLE_COEFF_LANES (SAMPLE_COEFF_LANES)
  ) u_core (
    .clk     (s_axil_aclk),
