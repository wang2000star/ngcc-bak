...
module zen_pke_enc_path_tb;
  ...
  localparam int ENC_STALL_GUARD_CYCLES = 200000;
  ...
  logic [7:0] pk_packed_mem [0:2457];
...
`endif
  ...
  task automatic poll_done;
    ...
    begin : wait_done_block
      for (tries = 0; tries < 5000; tries++) begin
  ...
  task automatic launch_cmd(
    ...
    begin
      ...
      while (!(done || error) && (done_wait < 800000)) begin
        @(posedge clk);
  ...
  task automatic compare_ct_packed(
    ...
    begin
      ...
      if (mismatch_count != 0) begin
        ...
        $display("TB DEBUG: active_profile_id=%0d launch_bufs a=%0d b=%0d r=%0d",
                 dut.u_dut.active_profile_id,
  ...
  initial begin
    $readmemh("testdata/swift512/enc_h.mem", h_mem);
    $readmemh("testdata/swift512/enc_pk_packed.mem", pk_packed_mem);
    $readmemh("testdata/swift512/enc_seed.mem", seed_mem);
    $readmemh("testdata/swift512/enc_s.mem", s_mem);
    $readmemh("testdata/swift512/enc_e.mem", e_mem);
    $readmemh("testdata/swift512/enc_s_ntt.mem", s_ntt_mem);
    $readmemh("testdata/swift512/enc_hs_basemul.mem", hs_basemul_mem);
    $readmemh("testdata/swift512/enc_hs_intt.mem", hs_intt_mem);
    $readmemh("testdata/swift512/enc_msg.mem", msg_mem);
    $readmemh("testdata/swift512/enc_msg_poly.mem", msg_poly_mem);
    $readmemh("testdata/swift512/enc_final_poly.mem", final_poly_mem);
    $readmemh("testdata/swift512/enc_ct_packed.mem", ct_packed_mem);
    ...
    launch_cmd("PKE_ENC", 8'h91, 32'h8000_0000 | RAW_SEED_BASE, 32'd2048, 3'd0, 3'd4, 3'd5);
