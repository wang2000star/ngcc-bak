package zen_xcvu37p_profiles_pkg;
  ...
  localparam int XCVU37P_SAFE_BINARY_COL_FACTOR = ((zen_accel_pkg::ZEN_N >= 2048) ? 8 :
  ...
  localparam int XCVU37P_BAL_BINARY_COL_FACTOR = ((zen_accel_pkg::ZEN_N >= 2048) ? 10 :
  ...
  localparam int XCVU37P_TIMING_BINARY_COL_FACTOR = ((zen_accel_pkg::ZEN_N >= 2048) ? 10 :
                                                     ((zen_accel_pkg::ZEN_N > 512) ? 5 : 3));
  ...
  localparam int XCVU37P_AGGR_BINARY_COL_FACTOR = ((zen_accel_pkg::ZEN_N >= 2048) ? 10 :
                                                   ((zen_accel_pkg::ZEN_N > 512) ? 5 : 3));
