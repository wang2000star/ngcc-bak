...
#define ZEN_SWIFT_N 1024
#define ZEN_SWIFT_N_LEN_BYTES ZEN_SWIFT_N/8
#define ZEN_SWIFT_N2 ZEN_SWIFT_N/2
#define ZEN_SWIFT_N4 ZEN_SWIFT_N/4
#define ZEN_SWIFT_N4_LOG2 8
#define ZEN_SWIFT_Q 769
#define ZEN_SWIFT_Q2 384

#define ZEN_SWIFT_SYM_LEN_BYTES 32 /* size in bytes of hashes, and seeds */
#define ZEN_SWIFT_SHAREDKEY_LEN_BYTES 32 /* size in bytes of shared key */
#define ZEN_SWIFT_F_NTT_PACK 1280
#define ZEN_SWIFT_F2_PACK 32

#define ZEN_SWIFT_INDCPA_MSG_LEN_BYTES 32
#define ZEN_SWIFT_INDCPA_PUBLICKEY_LEN_BYTES 1229
#define ZEN_SWIFT_INDCPA_SECREKEY_LEN_BYTES ZEN_SWIFT_F_NTT_PACK+ZEN_SWIFT_F2_PACK
#define ZEN_SWIFT_INDCPA_CIPHERTEXT_LEN_BYTES 1024
