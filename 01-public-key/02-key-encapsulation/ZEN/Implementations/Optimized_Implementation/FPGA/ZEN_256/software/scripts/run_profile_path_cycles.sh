...
This 256-only workspace compiles and runs:
  - zen_pke_enc_path_tb
  - zen_pke_keygen_path_tb
  - zen_pke_dec_path_tb

These root testbenches are fixed to swift256 vectors under testdata/.
