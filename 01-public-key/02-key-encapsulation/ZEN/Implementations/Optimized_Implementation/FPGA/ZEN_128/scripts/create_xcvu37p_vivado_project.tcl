...
set rtl_files [zen_collect_top_project_rtl_files $root_dir $top_name $iface xcvu37p]
...
zen_apply_verilog_defines_to_project $profile xcvu37p
...
puts "  verilog_define = [join [zen_verilog_defines $profile xcvu37p] { }]"
