...
#define ZEN_SWIFT_N 512
#define ZEN_SWIFT_N_LEN_BYTES ZEN_SWIFT_N/8
#define ZEN_SWIFT_N2 ZEN_SWIFT_N/2
#define ZEN_SWIFT_N4 ZEN_SWIFT_N/4
#define ZEN_SWIFT_N4_LOG2 7
#define ZEN_SWIFT_Q 769
#define ZEN_SWIFT_Q2 384

#define ZEN_SWIFT_SYM_LEN_BYTES 16 /* size in bytes of hashes*/
#define ZEN_SWIFT_SHAREDKEY_LEN_BYTES 16 /* size in bytes of shared key */
#define ZEN_SWIFT_F_NTT_PACK 640
#define ZEN_SWIFT_F2_PACK 16

#define ZEN_SWIFT_INDCPA_MSG_LEN_BYTES 16
#define ZEN_SWIFT_INDCPA_PUBLICKEY_LEN_BYTES 615
#define ZEN_SWIFT_INDCPA_SECREKEY_LEN_BYTES ZEN_SWIFT_F_NTT_PACK+ZEN_SWIFT_F2_PACK
#define ZEN_SWIFT_INDCPA_CIPHERTEXT_LEN_BYTES 512
