...
module zen_pke_keygen_path_tb;
  ...
  localparam int PK_PACK_BYTES = 615;
  localparam int SK_PACK_BYTES = 656;
`ifdef USE_XCV80
...
`endif
  ...
  task automatic poll_done;
    ...
    begin : wait_done_block
      for (tries = 0; tries < 20000; tries++) begin
  ...
  initial begin
    ...
    launch_cmd("PKE_KEYGEN", 8'h92, 32'h8000_0000 | RAW_SEED_BASE, 32'd512, 3'd0, 3'd1, 3'd5);
