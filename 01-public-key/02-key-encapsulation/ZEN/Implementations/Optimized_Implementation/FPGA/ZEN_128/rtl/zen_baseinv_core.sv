module zen_baseinv_core (
  ...
  localparam int BLOCK_LANES = BASEINV_LANES;
  ...
  logic signed [15:0] m13_342_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] m13_684_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] m02_342_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] m02_neg684_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] m03_342_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] dete_core_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  ...
  logic signed [15:0] r0mul0_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] r0mul1_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] r1mul0_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] r1mul1_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] r2mul0_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] r3mul0_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] r3mul1_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  ...
  logic signed [15:0] det_a_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] det_b_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] det_c0_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] det_c1_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] det_c2_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] det_d_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] det_e_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] det_f_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] det_mid0_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] det_mid1_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] det_norm_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] scale0_pre_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] scale1_pre_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] scale2_pre_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] scale3_pre_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  ...
  logic signed [15:0] block8_c0_stage2_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic signed [15:0] block8_c1_stage2_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  logic [15:0] block8_inv_word_reg [0:MAX_EXEC_SUBBLOCK_LANES-1];
  ...
  generate
    ...
    for (lane = 0; lane < MAX_EXEC_SUBBLOCK_LANES; lane++) begin : gen_baseinv_lane_blocks
      ...
      if ((BLOCK_COEFFS == 16) && (lane < BLOCK16_COMPUTE_LANES)) begin : gen_baseinv16_lane
  ...
  always_ff @(posedge clk) begin
    if (!rst_n) begin
      ...
      for (i = 0; i < MAX_EXEC_SUBBLOCK_LANES; i++) begin
        ...
        block8_c0_reg[i] <= '0;
        block8_c1_reg[i] <= '0;
        block8_c0_stage2_reg[i] <= '0;
        block8_c1_stage2_reg[i] <= '0;
        block8_inv_word_reg[i] <= '0;
      ...
      case (state)
        ...
        ST_COFACTOR_PRE: begin
          for (i = 0; i < MAX_EXEC_SUBBLOCK_LANES; i++) begin
            if (lane_active_reg[i] && (active_block_coeffs == 4)) begin
              m13_342_reg[i] <= fqmul(m13_reg[i], 16'sd342);
              m13_684_reg[i] <= fqmul(m13_reg[i], 16'sd684);
              m02_342_reg[i] <= fqmul(m02_reg[i], 16'sd342);
              m02_neg684_reg[i] <= fqmul(m02_reg[i], -16'sd684);
              m03_342_reg[i] <= fqmul(m03_reg[i], 16'sd342);
              dete_core_reg[i] <= fqmul(fqmul(m13_reg[i], 16'sd342) + sq2_reg[i], 16'sd342);
            end
          end
        end
        ...
        ST_COFACTOR: begin
          for (i = 0; i < MAX_EXEC_SUBBLOCK_LANES; i++) begin
            if (lane_active_reg[i] && (active_block_coeffs == 4)) begin
              ...
              u_r0a_reg[i] <= fqmul(sq2_reg[i] + m13_342_reg[i], a0_reg[i]);
              u_r0b_reg[i] <= fqmul(sq1_reg[i], a2_reg[i]);
              u_r0c_reg[i] <= fqmul(sq3_reg[i], a2_reg[i]);

              u_r1a_reg[i] <= fqmul(m12_reg[i] - m03_342_reg[i], a2_reg[i]);
              u_r1b_reg[i] <= fqmul(sq1_reg[i], a3_reg[i]);
              u_r1c_reg[i] <= fqmul(sq3_reg[i], a3_reg[i]);

              u_r2a_reg[i] <= fqmul(m13_342_reg[i] - sq2_reg[i], a2_reg[i]);
              u_r2b_reg[i] <= fqmul(sq3_reg[i], a0_reg[i]);
              u_r3a_reg[i] <= fqmul(sq2_reg[i] - m13_reg[i], a3_reg[i]);

              u_detA_reg[i] <= fqmul(sq2_reg[i] - m13_684_reg[i], a2_reg[i]);
              u_detB_reg[i] <= fqmul(m02_342_reg[i] + sq1_reg[i], a3_reg[i]);
              u_detC_reg[i] <= fqmul(sq3_reg[i], a3_reg[i]);
              u_detD_reg[i] <= fqmul(sq0_reg[i], a0_reg[i]);
              u_detE_reg[i] <= fqmul(dete_core_reg[i], a0_reg[i]);
              u_detF_reg[i] <= fqmul(sq1_reg[i] + m02_neg684_reg[i], a1_reg[i]);
            end
          end
          lookup_idx <= '0;
        end
        ...
        ST_BLOCK8_S2_PRE: begin
          for (i = 0; i < MAX_EXEC_SUBBLOCK_LANES; i++) begin
            if (lane_active_reg[i] && (active_block_coeffs == 8)) begin
              block8_c0_stage2_reg[i] <= block8_c0_stage2_comb[i];
              block8_c1_stage2_reg[i] <= block8_c1_stage2_comb[i];
              block8_inv_word_reg[i] <= block8_inv_data[i];
            end
          end
        end
        ...
        ST_BLOCK8_S2: begin
          for (i = 0; i < MAX_EXEC_SUBBLOCK_LANES; i++) begin
            if (lane_active_reg[i] && (active_block_coeffs == 8)) begin
              ...
              block8_c0_reg[i] <= fqmul(block8_inv_word_reg[i], block8_c0_stage2_reg[i]);
              scaled_c1 = fqmul(block8_inv_word_reg[i], block8_c1_stage2_reg[i]);
        ...
        ST_R_MUL: begin
          for (i = 0; i < MAX_EXEC_SUBBLOCK_LANES; i++) begin
            if (lane_active_reg[i] && (active_block_coeffs == 4)) begin
              r0mul0_reg[i] <= fqmul(u_r0a_reg[i] - u_r0b_reg[i], zeta_reg[i]);
              r0mul1_reg[i] <= fqmul(u_r0c_reg[i], zeta2_reg[i]);
              r1mul0_reg[i] <= fqmul(u_r1a_reg[i] - u_r1b_reg[i], zeta_reg[i]);
              r1mul1_reg[i] <= fqmul(u_r1c_reg[i], zeta2_reg[i]);
              r2mul0_reg[i] <= fqmul(u_r2a_reg[i] - u_r2b_reg[i], zeta_reg[i]);
              r3mul0_reg[i] <= fqmul(u_r3a_reg[i], zeta_reg[i]);
              r3mul1_reg[i] <= fqmul(m02a1_reg[i], 16'sd342);
            end
          end
        end
        ...
        ST_R_STAGE: begin
          for (i = 0; i < MAX_EXEC_SUBBLOCK_LANES; i++) begin
            if (lane_active_reg[i] && (active_block_coeffs == 4)) begin
              r0pre_reg[i] <= fqmul(r0mul0_reg[i] - r0mul1_reg[i] - a0cube_reg[i], 16'sd173);
              r1pre_reg[i] <= fqmul(r1mul0_reg[i] + r1mul1_reg[i] + sq0a1_reg[i], 16'sd173);
              r2pre_reg[i] <= fqmul(r2mul0_reg[i] + sq0a2_reg[i] - sq1a0_reg[i], 16'sd173);
              r3pre_reg[i] <= fqmul(r3mul0_reg[i] + a1cube_reg[i] - r3mul1_reg[i] + sq0a3_reg[i], 16'sd173);
            end
          end
        end
        ...
        ST_SCALE_PRE: begin
          for (i = 0; i < MAX_EXEC_SUBBLOCK_LANES; i++) begin
            if (lane_active_reg[i] && (active_block_coeffs == 4)) begin
              scale0_pre_reg[i] <= fqmul(r0pre_reg[i], lane_qinv[i]);
              scale1_pre_reg[i] <= fqmul(r1pre_reg[i], lane_qinv[i]);
              scale2_pre_reg[i] <= fqmul(r2pre_reg[i], lane_qinv[i]);
              scale3_pre_reg[i] <= fqmul(r3pre_reg[i], lane_qinv[i]);
            end
          end
        end
          ...
          if (active_block_coeffs != 16) begin
            for (i = 0; i < MAX_EXEC_SUBBLOCK_LANES; i++) begin
              if (lane_active_reg[i]) begin
                ...
                row_offset = base & (PACK_ROW_COEFFS - 1);
                if (active_block_coeffs == 4) begin
                  poly_r_rows[row_base][(row_offset + 0)*COEFF_W +: COEFF_W] <=
                    fqmul(scale0_pre_reg[i], 16'sd19);
                  poly_r_rows[row_base][(row_offset + 1)*COEFF_W +: COEFF_W] <=
                    fqmul(scale1_pre_reg[i], 16'sd19);
                  poly_r_rows[row_base][(row_offset + 2)*COEFF_W +: COEFF_W] <=
                    fqmul(scale2_pre_reg[i], 16'sd19);
                  poly_r_rows[row_base][(row_offset + 3)*COEFF_W +: COEFF_W] <=
                    fqmul(scale3_pre_reg[i], 16'sd19);
                end else begin
  ...
  always_comb begin
    cfg_block_coeffs = BLOCK_COEFFS;
    cfg_negate_twiddle = 1'b0;
    cfg_block_supported = SUPPORTS_BLOCK_INV;
    cfg_total_subblocks = SUBBLOCKS;
    if (BLOCK_COEFFS == 16) begin
      cfg_exec_subblock_lanes = BLOCK16_COMPUTE_LANES;
    end else begin
      cfg_exec_subblock_lanes = MAX_EXEC_SUBBLOCK_LANES;
    end
    cfg_profile_supported = SUPPORTS_BLOCK_INV;
  end
  ...
  always_comb begin
    ...
    unique case (state)
      ...
      ST_PRECOMP: begin
        if (active_block_coeffs == 4) state_n = ST_COFACTOR_PRE;
      ...
      ST_COFACTOR_PRE: state_n = ST_COFACTOR;
      ST_COFACTOR: state_n = ST_TWIDDLE;
      ST_TWIDDLE: begin
        if (lookup_reaches_end(lookup_idx, active_lane_count)) begin
          if (active_block_coeffs == 4) state_n = ST_R_MUL;
          else if (active_block_coeffs == 8) state_n = ST_BLOCK8_S0;
          else state_n = ST_BLOCK16_S0;
        end
      end
      ST_BLOCK8_S0: state_n = ST_BLOCK8_S1;
      ST_BLOCK8_S1: state_n = ST_BLOCK8_S2_PRE;
      ST_BLOCK8_S2_PRE: state_n = ST_BLOCK8_S2;
      ...
      ST_R_MUL: state_n = ST_R_STAGE;
      ST_R_STAGE: state_n = ST_DET_STAGE;
      ST_DET_PRE: state_n = ST_DET_STAGE;
      ST_DET_MID: state_n = ST_DET_STAGE;
      ST_DET_TAIL: state_n = ST_DET_STAGE;
      ST_DET_STAGE: state_n = ST_LOOKUP;
      ST_LOOKUP: begin
        if (lookup_reaches_end(lookup_idx, active_lane_count)) begin
          if (active_block_coeffs == 4) state_n = ST_SCALE_PRE;
          else state_n = ST_SCALE;
        end
      end
      ST_SCALE_PRE: state_n = ST_SCALE;
