...
extern "C"
{
    ...
    /// @brief Check whether a polynomial satisfies the inversion-failure condition modulo ZEN_Q
    ...
    /// @brief Multiply two binary polynomials in R2 of degree 1023
    ...
    /// @brief Generate a polynomial g or f from a seed and nonce
    ...
    /// @brief Generate a small polynomial s or e from a seed and nonce
    /// @param[out] a Base address of output polynomial coefficient array
    /// @param[in] seed Base address of input seed byte array
    /// @param[in] nonce Domain-separation nonce used for pseudorandom generation
    /// @return None
    ...
    /// @brief Compress polynomial coefficients from modulo ZEN_Q representation to 8-bit representation
    ...
    /// @brief Decompress polynomial coefficients from 8-bit representation to modulo ZEN_Q representation
