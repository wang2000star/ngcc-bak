	...
	const unsigned char *seed)
{
	...
	if(pk_len_bytes != NULL) *pk_len_bytes = ZEN_PUBLICKEY_LEN_BYTES;
	if(sk_len_bytes != NULL) *sk_len_bytes = ZEN_SECREKEY_LEN_BYTES;
	...
	unsigned char *ct, unsigned long long *ct_len_bytes)
{
	...
	(void)pk_len_bytes;
	if(ss_len_bytes != NULL) *ss_len_bytes = ZEN_SHAREDKEY_LEN_BYTES;
	if(ct_len_bytes != NULL) *ct_len_bytes = ZEN_CIPHERTEXT_LEN_BYTES;
	//m
