...
#define ZEN_N4_LOG2 7
#define ZEN_Q 769
#define ZEN_Q2 384

#define ZEN_SYM_LEN_BYTES 16 /* size in bytes of hashes*/
#define ZEN_SHAREDKEY_LEN_BYTES 16 /* size in bytes of shared key */
#define ZEN_F_NTT_PACK 640
#define ZEN_F2_PACK 16

#define ZEN_INDCPA_MSG_LEN_BYTES 16
#define ZEN_INDCPA_PUBLICKEY_LEN_BYTES 615
#define ZEN_INDCPA_SECREKEY_LEN_BYTES ZEN_F_NTT_PACK+ZEN_F2_PACK
#define ZEN_INDCPA_CIPHERTEXT_LEN_BYTES 512
