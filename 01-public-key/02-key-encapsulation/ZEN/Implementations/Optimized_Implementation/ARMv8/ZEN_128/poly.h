...
extern "C"
{
    ...
    /// @brief Multiply two binary polynomials in R2 of degree less than ZEN_N2
    /// @param[in] a Base address of first input polynomial coefficient array of length ZEN_N2
    /// @param[in] b Base address of second input polynomial coefficient array of length ZEN_N2
    /// @param[out] res Base address of output polynomial coefficient array of length ZEN_N2
    /// @return None
    ...
    /// @brief Generate the s-role noise polynomial by summing a CBD-1 polynomial and a ternary polynomial from an input seed and nonce
    ...
    /// @brief Generate the e-role noise polynomial whose coefficients follow a centered binomial distribution with parameter eta = 2 from an input seed and nonce
    /// @param[out] a Base address of output polynomial coefficient array
    /// @param[in] seed Base address of input seed byte array
    /// @param[in] nonce Single-byte nonce used to diversify the pseudoXOF input
    /// @return None
