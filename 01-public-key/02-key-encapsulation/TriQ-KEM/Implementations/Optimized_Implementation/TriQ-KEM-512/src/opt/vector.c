 ...
 * \f]
 *
 * @param[in,out] ctx     API_PKC pseudoXOF-backed context used for random byte generation.
 ...
 *
 * @param[in,out] ctx     Initialized API_PKC pseudoXOF-backed context used for randomness.
 ...
 * the vectors **x** and **y**
 *
 * @param[in,out] ctx     Pointer to a previously initialized API_PKC pseudoXOF-backed context.
