/**
 * @file vector.c
 * @brief Implementation of vector sampling and utilities for the TriQ scheme.
 */
 ...
 * \f]
 *
 * @param[in,out] ctx     TriQ XOF context backed by the API_PKC pseudoXOF function.
 ...
 *
 * @param[in,out] ctx     Initialized TriQ XOF context used for randomness.
 ...
 * the vectors **x** and **y**
 *
 * @param[in,out] ctx     Pointer to a previously initialized TriQ XOF context.
