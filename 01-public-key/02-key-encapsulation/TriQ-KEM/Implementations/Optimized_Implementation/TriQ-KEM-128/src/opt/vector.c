 ...
 *
 * Computes 鈱圥ARAM_N / 256鈱? i.e. how many 256-bit 鈥渓oop iterations鈥?are required
 ...
 *
 * Reduces \p x modulo PARAM_N using the precomputed value PARAM_N_MU = 鈱?^32 / PARAM_N鈱?
 *
 ...
 *
 * Internally, it samples 24-bit random values and rejects any value 鈮?UTILS_REJECTION_THRESHOLD,
 ...
 * @param[out]    v       Pointer to an array of 鈱圥ARAM_N/64鈱?64-bit words.
