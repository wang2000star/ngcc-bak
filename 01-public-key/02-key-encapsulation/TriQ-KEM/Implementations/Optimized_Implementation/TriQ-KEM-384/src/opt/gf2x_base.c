...
uint64_t bloc64[PARAM_OMEGA_MAX];  // Allocation with the biggest possible weight
 ...
 static inline void karat_mult3(__m256i *C, __m256i *A, __m256i *B) __attribute__((unused));
 static inline void divide_by_x_plus_one_256(__m256i *out, __m256i *in, int32_t size) __attribute__((unused));
...
static inline void reduce(__m256i *o, const __m256i *a256) {
    ...
    int32_t i, i2;
     ...
     for (i = LAST64; i < (PARAM_N >> 5) - 4; i += 4) {
        ...
        r256 ^= carry256;
        i2 = (i - LAST64) >> 2;
        _mm256_storeu_si256(o + i2, a256[i2] ^ r256);
    }
 ...
 void toom_3_mult(__m256i *Out, const __m256i *A256, const __m256i *B256) {
     karat_mult_64(Out, (__m256i *)A256, (__m256i *)B256);
 }

 static inline void old_toom_3_mult_unused(__m256i *Out, const __m256i *A256, const __m256i *B256) __attribute__((unused));
 static inline void old_toom_3_mult_unused(__m256i *Out, const __m256i *A256, const __m256i *B256) {
