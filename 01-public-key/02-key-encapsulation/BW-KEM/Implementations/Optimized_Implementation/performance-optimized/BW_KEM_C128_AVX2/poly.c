...
void poly_getnoise_eta1_4x(poly *r0,
                           ...
                           uint8_t nonce0)
{
  uint8_t buf0[BWKEM128_ETA_S * BWKEM128_N / 4];
  uint8_t buf1[BWKEM128_ETA_S * BWKEM128_N / 4];
  uint8_t buf2[BWKEM128_ETA_S * BWKEM128_N / 4];
  uint8_t buf3[BWKEM128_ETA_S * BWKEM128_N / 4];
