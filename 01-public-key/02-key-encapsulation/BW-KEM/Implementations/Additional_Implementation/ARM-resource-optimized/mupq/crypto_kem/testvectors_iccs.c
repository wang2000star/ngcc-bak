...
//
// ICCS-format KAT generator for BW-KEM, designed to run on the target
...
// to the scheme's Test_Vectors/KAT_KEM_BW_KEM_C*.txt file.
...
static char line[2 * CRYPTO_SECRETKEYBYTES + 64];
