...
/* Compress v and constant-time compare against serialized r without
 * materializing the result. Returns accumulated byte diff (0 == equal). */
#define cmp_poly_compress KYBER_NAMESPACE(cmp_poly_compress)
...
#define poly_cache_prime KYBER_NAMESPACE(poly_cache_prime)
...
void poly_frombytes_mul_32_16(poly *r, const poly *b, const uint8_t a[KYBER_POLYBYTES], const int32_t *r_tmp);

#define poly_basemul_opt_16_16_noprime KYBER_NAMESPACE(poly_basemul_opt_16_16_noprime)
void poly_basemul_opt_16_16_noprime(poly *r, const poly *a, const poly *b);
#define poly_basemul_acc_opt_16_16_noprime KYBER_NAMESPACE(poly_basemul_acc_opt_16_16_noprime)
void poly_basemul_acc_opt_16_16_noprime(poly *r, const poly *a, const poly *b);

#define poly_frombytes_mul_16_16 KYBER_NAMESPACE(poly_frombytes_mul_16_16)
void poly_frombytes_mul_16_16(poly *r, const poly *b, const uint8_t a[KYBER_POLYBYTES]);
#define poly_frombytes_mul_acc_16_16 KYBER_NAMESPACE(poly_frombytes_mul_acc_16_16)
void poly_frombytes_mul_acc_16_16(poly *r, const poly *b, const uint8_t a[KYBER_POLYBYTES]);
