...
#error "ALGORITHM_INSTANCE must be supplied by the NGCC PIKE CMake target"
#endif

#ifndef NGCC_PIKE_LEVEL
#error "NGCC_PIKE_LEVEL must be supplied by the NGCC PIKE CMake target"
#endif

#if NGCC_PIKE_LEVEL == 3
#if PIKE_COMPRESSED_SHARED_SECRET_BYTES != 64
#error "NGCC-3 must use a 64-byte shared secret"
#endif
#else
#if PIKE_COMPRESSED_SHARED_SECRET_BYTES != 32
#error "NGCC-1 and NGCC-2 must use a 32-byte shared secret"
#endif
#endif
