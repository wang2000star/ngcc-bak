/*
 * Field arithmetic for p479 using modarith unsaturated-radix Montgomery multiplication.
 * Internal representation: 8 limbs x 61-bit unsaturated radix.
 */
#include "modarith_p479.c"
#include <fp.h>

const uint64_t p[NWORDS_FIELD] = {
    0x1ffffffffffffffful, 0x0ul, 0x12f82d0000000000ul, 0x15d42d2e97233d29ul, 0x43dadd9997fbe0dul, 0xe05f9ddcd482c43ul, 0x154bdefa808a1ac6ul, 0xb11dd235847deul
};
const uint64_t ZERO[NWORDS_FIELD] = {0, 0, 0, 0, 0, 0, 0, 0};
const uint64_t ONE[NWORDS_FIELD] = {
    0x2e4ul, 0x0ul, 0xa9dec0000000000ul, 0x6ad65531e2333c5ul, 0x1db577004abea073ul, 0x16b9bada9b600df1ul, 0x10af73e470ca9a63ul, 0x5cc5d4d0405bul
};
