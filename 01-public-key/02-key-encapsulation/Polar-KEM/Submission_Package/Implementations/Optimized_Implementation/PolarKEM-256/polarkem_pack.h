 ...
 * @brief Nine-bit quantization and batch packing for PolarKEM-256 ciphertexts.
 */
...
/**
 * Quantize one canonical coefficient from Z_q to a nine-bit representative.
 *
...
/**
 * Dequantize one nine-bit representative to its nearest canonical Z_q value.
 *
 ...
 *
 * The compile-time-specialized path consumes eight coefficients and emits nine
 * bytes per iteration; it is exactly the scalar contiguous-bit encoding.
 *
