/**
 * @file polarkem_ct.h
 * @brief Deterministic ciphertext construction and recovery helpers.
 */
...
/**
 * Write the canonical 16-byte PolarKEM-128 object header.
 *
...
/**
 * Validate a canonical PolarKEM-128 object header.
 *
