...
typedef uint64_t rbc_elt[RBC_127_ELT_SIZE];
typedef uint64_t rbc_elt_ur[RBC_127_ELT_UR_SIZE];
...
extern uint64_t RBC_127_SQR_LOOKUP_TABLE[256];
static const rbc_elt RBC_127_ELT_MODULUS = {0x0000000000000003, 0x8000000000000000};
