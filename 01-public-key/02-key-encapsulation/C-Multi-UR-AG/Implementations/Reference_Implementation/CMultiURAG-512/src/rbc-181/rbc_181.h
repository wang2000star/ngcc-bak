...
typedef uint64_t rbc_elt[RBC_181_ELT_SIZE];
typedef uint64_t rbc_elt_ur[RBC_181_ELT_UR_SIZE];
...
extern uint64_t RBC_181_SQR_LOOKUP_TABLE[256];
static const rbc_elt RBC_181_ELT_MODULUS = {0x00000000000000c3, 0x0000000000000000, 0x0020000000000000};
