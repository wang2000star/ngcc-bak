...
#undef CHECK_QP
  ...
  fill(a,VIPER_N,12); fill(b,VIPER_N,12); viper_poly_mul(c,a,b); viper_poly_mul_schoolbook_oracle(d,a,b); if (memcmp(c,d,sizeof(c))) return fail("basebackend polymul oracle");
