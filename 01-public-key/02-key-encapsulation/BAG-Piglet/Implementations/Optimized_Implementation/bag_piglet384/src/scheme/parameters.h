...
#define PARAM_M 103/**< Parameter m of the scheme (finite field GF(q^m)) */ //(m-k+espilon)2
#define PARAM_K 4 /**< Parameter k of the scheme (code dimension) */
#define PARAM_N 106 /**< Parameter n of the scheme (code length) */
#define PARAM_N_ 103
#define PARAM_N_1 2
#define PARAM_epsilon 77
...
#define PARAM_SECURITY 384 /**< Expected security level */
...
#define SEEDEXPANDER_SEED_BYTES 48 /**< Seed size at this security level */
...
#define SEEDEXPANDER_MAX_LENGTH 49152 /**< Max length of the NIST seed expander */
...
#define WEIGHT_X_VALUES 7
#define WEIGHT_Y1_VALUES 7
#define WEIGHT_Y2_VALUES 7

#define WEIGHT_R1_VALUES 4
#define WEIGHT_R21_VALUES 4
#define WEIGHT_R22_VALUES 4
#define WEIGHT_E_VALUES 4 
