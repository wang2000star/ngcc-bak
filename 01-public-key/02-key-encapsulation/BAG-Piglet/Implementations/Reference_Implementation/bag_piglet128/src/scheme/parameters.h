...
#define PARAM_M 47/**< Parameter m of the scheme (finite field GF(q^m)) */ //(m-k+espilon)2
#define PARAM_K 3 /**< Parameter k of the scheme (code dimension) */
#define PARAM_N 43 /**< Parameter n of the scheme (code length) */
#define PARAM_N_ 43
#define PARAM_N_1 2
#define PARAM_epsilon 30
...
#define SEEDEXPANDER_SEED_BYTES 16 /**< Seed size at this security level */
...
#define SEEDEXPANDER_MAX_LENGTH 6144 /**< Max length of the NIST seed expander */
...
#define WEIGHT_Y1_VALUES 4
#define WEIGHT_Y2_VALUES 4

#define WEIGHT_R1_VALUES 2
#define WEIGHT_R21_VALUES 3
#define WEIGHT_R22_VALUES 3
#define WEIGHT_E_VALUES 3 
