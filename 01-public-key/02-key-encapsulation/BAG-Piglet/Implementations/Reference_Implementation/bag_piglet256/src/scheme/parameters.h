...
#define PARAM_M 79/**< Parameter m of the scheme (finite field GF(q^m)) */ //(m-k+espilon)2
#define PARAM_K 4 /**< Parameter k of the scheme (code dimension) */
#define PARAM_N 78 /**< Parameter n of the scheme (code length) */
#define PARAM_N_ 78
#define PARAM_N_1 2
#define PARAM_epsilon 54
...
#define SEEDEXPANDER_SEED_BYTES 32 /**< Seed size at this security level */
...
#define SEEDEXPANDER_MAX_LENGTH 12288 /**< Max length of the NIST seed expander */
...
#define WEIGHT_X_VALUES 6
#define WEIGHT_Y1_VALUES 6
#define WEIGHT_Y2_VALUES 6

#define WEIGHT_R1_VALUES 3
#define WEIGHT_R21_VALUES 3
