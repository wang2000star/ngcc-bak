                    ...
                    uint8_t sk[NOISE_POLY_BYTES])
{
    ...
    encode_10bit_lsb(b, CHEETAH_K*N, pk+SEED_BYTES);
...
static void indcpa_encrypt(const uint8_t m[MSG_BYTES],
    ...
    int16_t b[CHEETAH_K*N];
    decode_10bit_lsb(pk+SEED_BYTES, CHEETAH_K*N, b);
    ...
    encode_10bit_lsb(u, CHEETAH_K*N, c);
                    ...
                    uint8_t m[MSG_BYTES]) 
{
    ...
    decode_10bit_lsb(c, CHEETAH_K*N, u);
