...
#define SEED_BYTES 64 // SHARED_KEY_BYTES+16

// Ciphertext and public key size (bytes)
#define CIPHERTEXT_BYTES 2832 // CHEETAH_K*N*d_u/8+SHARED_KEY_BYTES*d_v
#define PUBLICKEY_BYTES 2704 //  SEED_BYTES + (CHEETAH_K*N*d_u)/8

#define NOISE_POLY_BYTES 3120  // CHEETAH_K*N*QBITS/8
