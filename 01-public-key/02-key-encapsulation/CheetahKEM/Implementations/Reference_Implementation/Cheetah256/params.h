...
#define SEED_BYTES 48 // SHARED_KEY_BYTES+16

// Ciphertext and public key size (bytes)
#define CIPHERTEXT_BYTES 1728 // CHEETAH_K*N*d_u/8+SHARED_KEY_BYTES*d_v
#define PUBLICKEY_BYTES 1648 //  SEED_BYTES + (CHEETAH_K*N*d_u)/8

#define NOISE_POLY_BYTES 2080  // CHEETAH_K*N*QBITS/8
