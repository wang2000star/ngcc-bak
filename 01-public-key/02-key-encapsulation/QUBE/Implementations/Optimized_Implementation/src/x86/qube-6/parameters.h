...
#define PARAM_N                     42283       ///< Define the parameter n of the scheme
...
#define PARAM_OMEGA_X1              161          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_X2              161          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_Y1              128          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R11             70          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R21             51          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R22             51          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_E               120          ///< Define the parameter omega_e of the scheme
...
#define PARAM_OMEGA_MAX_1             161          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_MAX_2             70          ///< Define the parameter omega of the scheme
...
#define PARAM_N_MU 101576ULL   ///<  Define a precomputed multiplier for Barrett reduction mu = floor(2^32 / PARAM_N)
#define UTILS_REJECTION_THRESHOLD             16744068  ///< Rejection threshold for uniform sampling in [0, PARAM_N)
