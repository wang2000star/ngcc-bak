 ...
 **/
static const __m256i param256[3] = {{0x0017007100bf00d6, 0x005900d500c80077, 0x00f000710042007f, 0x001b001000160033},
                                    {0x00ab0015000f00e3, 0x009700a700860039, 0x007c000c003e000d, 0x00a4004300c0000c},
                                    {0x00000001008100f0,0,0,0}};
...
void compute_syndromes(__m256i *syndromes256, uint8_t *cdw) {
    syndromes256[0] = _mm256_set1_epi16(cdw[0]);//sizeof syndromes256 is SYND_SIZE_256=1
