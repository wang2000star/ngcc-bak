...
#define PARAM_N                     41651       ///< Define the parameter n of the scheme
#define PARAM_N1                    66          ///< Define the parameter n1 of the scheme (length of Reed–Solomon code)
#define PARAM_N2                    640         ///< Define the parameter n2 of the scheme (length of Duplicated Reed–Muller code)
#define PARAM_N1N2                  42240       ///< Define the length in bits of the concatenated code
#define PARAM_OMEGA_X1              146          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_X2              146          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_Y1              151          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R11             52          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R21             57          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R22             57          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_E               162          ///< Define the parameter omega_e of the scheme
...
#define PARAM_DFR_EXP               256         ///< Define the decryption failure rate exponent

#define PARAM_OMEGA_MAX_1             162          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_MAX_2             57          ///< Define the parameter omega of the scheme
...
#define RS_POLY_COEFS                                                                                                \
    179, 31, 62, 180, 25, 116, 230, 99, 141, 254, 171, 51, 136, 87, 67, 209, 203, 195, 1                                                     ///< Coefficients of the Reed–Solomon generator polynomial
#define SEED_BYTES                  32          ///< Define the size of the seed in bytes
#define SALT_BYTES                  16          ///< Define the size of a salt in bytes

#define PARAM_N_MU 103117ULL   ///<  Define a precomputed multiplier for Barrett reduction mu = floor(2^32 / PARAM_N)
#define UTILS_REJECTION_THRESHOLD             16743702  ///< Rejection threshold for uniform sampling in [0, PARAM_N)
