 ...
 *
 * The table length (29) matches the number of coefficients needed in the
 ...
 **/
static const __m256i param256[2] = {{0x00b4003e001f00b3, 0x006300e600740019, 0x003300ab00fe008d, 0x00d1004300570088},
                                    {0x0000000100c300cb, 0, 0, 0}};
