...
#define PARAM_N                     13109       ///< Define the parameter n of the scheme
#define PARAM_N1                    34          ///< Define the parameter n1 of the scheme (length of Reed–Solomon code)
#define PARAM_N2                    384         ///< Define the parameter n2 of the scheme (length of Duplicated Reed–Muller code)
#define PARAM_N1N2                  13056       ///< Define the length in bits of the concatenated code
#define PARAM_OMEGA_X1              74          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_X2              74          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_Y1              76          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R11             27          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R21             29          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R22             29          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_E               83          ///< Define the parameter omega_e of the scheme
...
#define PARAM_OMEGA_MAX_1             83          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_MAX_2             29          ///< Define the parameter omega of the scheme
...
#define RS_POLY_COEFS                                                                                                \
    214, 191, 113, 23, 119, 200, 213, 89, 127, 66, 113, 240, 51, 22, 16, 27, 227, 15, 21, 171, 57, 134, 167, 151, 13, 62, 12, 124, 12, 192, 67, 164, 240, 129, 1                                                     ///< Coefficients of the Reed–Solomon generator polynomial
#define SEED_BYTES                  32          ///< Define the size of the seed in bytes
#define SALT_BYTES                  16          ///< Define the size of a salt in bytes

#define PARAM_N_MU 327635ULL   ///<  Define a precomputed multiplier for Barrett reduction mu = floor(2^32 / PARAM_N)
#define UTILS_REJECTION_THRESHOLD             16766411  ///< Rejection threshold for uniform sampling in [0, PARAM_N)
