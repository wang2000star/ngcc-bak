...
#define PARAM_N                     145451       ///< Define the parameter n of the scheme
...
#define PARAM_OMEGA_X1              300          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_X2              300          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_Y1              288          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R11             135          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R21             111          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R22             115          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_E               177          ///< Define the parameter omega_e of the scheme
...
#define PARAM_OMEGA_MAX_1             300          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_MAX_2             135          ///< Define the parameter omega of the scheme
...
#define PARAM_N_MU 29528ULL   ///<  Define a precomputed multiplier for Barrett reduction mu = floor(2^32 / PARAM_N)
#define UTILS_REJECTION_THRESHOLD             16726865  ///< Rejection threshold for uniform sampling in [0, PARAM_N)
