...
void vect_generate_random_support1(shake256_xof_ctx *ctx, uint32_t *support, uint16_t weight) {
    ...
    uint8_t rand_bytes[3 * PARAM_OMEGA_MAX_1] = {0};
    uint8_t inc;
    size_t i, j;
...
void vect_generate_random_support2(shake256_xof_ctx *ctx, uint32_t *support, uint16_t weight) {
    uint32_t rand_u32[PARAM_OMEGA_MAX_2] = {0};
 ...
 */
void vect_write_support_to_vector1(__m256i *v, uint32_t *support, uint16_t weight) {
    __m256i bit256[PARAM_OMEGA_MAX_1];
    __m256i bloc256[PARAM_OMEGA_MAX_1];
...
void vect_write_support_to_vector2(__m256i *v, uint32_t *support, uint16_t weight) {
    __m256i bit256[PARAM_OMEGA_MAX_2];
    __m256i bloc256[PARAM_OMEGA_MAX_2];
    static __m256i posCmp256 = (__m256i){0UL, 1UL, 2UL, 3UL};
...
void vect_sample_fixed_weight1(shake256_xof_ctx *ctx, __m256i *v, uint16_t weight) {
    uint32_t support[PARAM_OMEGA_MAX_1] = {0};
    vect_generate_random_support1(ctx, support, weight);
    vect_write_support_to_vector1(v, support, weight);
}
...
void vect_sample_fixed_weight2(shake256_xof_ctx *ctx, __m256i *v, uint16_t weight) {
    uint32_t support[PARAM_OMEGA_MAX_2] = {0};
    vect_generate_random_support2(ctx, support, weight);
    vect_write_support_to_vector2(v, support, weight);
}
