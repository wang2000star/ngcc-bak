...
#define PARAM_N                     86027       ///< Define the parameter n of the scheme
...
#define PARAM_OMEGA_X1              210          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_X2              240          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_Y1              218          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R11             91          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R21             84          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_R22             84          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_E               155          ///< Define the parameter omega_e of the scheme
...
#define PARAM_OMEGA_MAX_1             240          ///< Define the parameter omega of the scheme
#define PARAM_OMEGA_MAX_2             91          ///< Define the parameter omega of the scheme
...
#define PARAM_N_MU 49925ULL   ///<  Define a precomputed multiplier for Barrett reduction mu = floor(2^32 / PARAM_N)
#define UTILS_REJECTION_THRESHOLD             16775265  ///< Rejection threshold for uniform sampling in [0, PARAM_N)
