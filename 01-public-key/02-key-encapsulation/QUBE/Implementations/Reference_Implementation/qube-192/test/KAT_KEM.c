...
int main()
{
	...
	const char *dir_name = "../KAT";
	char file_path[128] = "";
	sprintf(algoname_output, "KAT_KEM_%s_%d.txt", ALGORITHM_INSTANCE, PARAM_SECURITY);
	...
	printf("\nFiles have been saved in the 'KAT' folder within the working directory.\n");
