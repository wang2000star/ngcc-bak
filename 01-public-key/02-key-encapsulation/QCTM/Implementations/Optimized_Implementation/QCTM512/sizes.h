...
#if LENGTH == 38000 && GOPPA_DEGREE == 1007 && EXT_DEGREE == 18 && ORDER == 19
_Static_assert(QCTM_PK_BYTES == 2374727, "QCTM512 PK byte length mismatch");
_Static_assert(QCTM_GAMMA_BYTES == 87766, "QCTM512 GammaPrime byte length mismatch");
_Static_assert(QCTM_S_BYTES == 4750, "QCTM512 s byte length mismatch");
_Static_assert(QCTM_API_SK_BYTES == 2467243, "QCTM512 API sk byte length mismatch");
_Static_assert(QCTM_CT_BYTES == 2264, "QCTM512 CT byte length mismatch");
_Static_assert(QCTM_SS_BYTES == 64, "QCTM512 SS byte length mismatch");
_Static_assert(QCTM_RIGHT_WIDTH == 19893, "QCTM512 right-width mismatch");
_Static_assert(QCTM_PSI_T1_ROWS == 953, "QCTM512 psi(T1) row count mismatch");
_Static_assert(QCTM_T2_ROWS == 2, "QCTM512 T2 row count mismatch");
#endif
