...
#if LENGTH == 19000 && GOPPA_DEGREE == 513 && EXT_DEGREE == 18 && ORDER == 19
_Static_assert(QCTM_PK_BYTES == 595662, "QCTM256 PK byte length mismatch");
_Static_assert(QCTM_GAMMA_BYTES == 43905, "QCTM256 GammaPrime byte length mismatch");
_Static_assert(QCTM_S_BYTES == 2375, "QCTM256 s byte length mismatch");
_Static_assert(QCTM_API_SK_BYTES == 641942, "QCTM256 API sk byte length mismatch");
_Static_assert(QCTM_CT_BYTES == 1153, "QCTM256 CT byte length mismatch");
_Static_assert(QCTM_SS_BYTES == 32, "QCTM256 SS byte length mismatch");
_Static_assert(QCTM_RIGHT_WIDTH == 9785, "QCTM256 right-width mismatch");
_Static_assert(QCTM_PSI_T1_ROWS == 485, "QCTM256 psi(T1) row count mismatch");
_Static_assert(QCTM_T2_ROWS == 2, "QCTM256 T2 row count mismatch");
#endif
