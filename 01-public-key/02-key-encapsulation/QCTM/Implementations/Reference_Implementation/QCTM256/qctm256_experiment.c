...
#define REPORT_FILE "QCTM256_5000_report.md"
#define CSV_FILE "QCTM256_5000_results.csv"
                        ...
                        double max_elapsed_ms)
{
    ...
    fprintf(fp, "# Locally Quasi-Cyclic Twisted McEliece 3 5000-Run Experiment Report\n\n");
    fprintf(fp, "## Experiment Setup\n\n");
    fprintf(fp, "- Generated at: `%s`\n", time_buf);
    fprintf(fp, "- Instance: `QCTM256`\n");
