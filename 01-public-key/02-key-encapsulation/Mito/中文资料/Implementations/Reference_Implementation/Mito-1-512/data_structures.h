 ...
 * @brief   MITO-PKE and MITO-KEM ciphertext data structures.
 */

#ifndef MITO_DATA_STRUCTURES_H
#define MITO_DATA_STRUCTURES_H
 ...
 */
typedef struct {
    uint64_t u[PARAM_L][VEC_N_SIZE_64]; /**< first vector half */
