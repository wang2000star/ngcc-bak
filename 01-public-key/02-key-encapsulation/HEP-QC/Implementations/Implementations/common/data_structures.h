 ...
 * @brief   HEP-QC-PKE and HEP-QC-KEM ciphertext data structures.
 */

#ifndef HEP_QC_DATA_STRUCTURES_H
#define HEP_QC_DATA_STRUCTURES_H
...
#endif  // HEP_QC_DATA_STRUCTURES_H
