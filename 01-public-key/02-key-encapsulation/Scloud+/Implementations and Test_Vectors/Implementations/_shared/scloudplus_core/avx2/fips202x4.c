/**
 * @file fips202x4.c
 * @brief Scloud+ SHAKE128x4 wrapper used by the AVX2 SHAKE matrix backend.
 *
 * The Keccak permutation itself is provided by the third-party `keccak4x/`
 * files. This file keeps the Scloud+-specific absorb/squeeze and A-row helper
 * code in one place.
 */
