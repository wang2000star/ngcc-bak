/**
 * @file parameters.h
 * @brief Scloud+ level-192 KEM default parameters.
 *
...
#define scloudplus_l 192
#define SCLOUDPLUS_LEVEL_NAME "192"
#define SCLOUDPLUS_DIV_CEIL(num, den) (((num) + (den) - 1) / (den))

#define scloudplus_m 832
#define scloudplus_n 832
#define scloudplus_mbar 12
#define scloudplus_nbar 11
#define scloudplus_tau 3
#define scloudplus_secret_bd 2
