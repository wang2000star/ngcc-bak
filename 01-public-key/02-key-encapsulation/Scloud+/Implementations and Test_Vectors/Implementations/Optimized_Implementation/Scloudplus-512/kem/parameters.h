/**
 * @file parameters.h
 * @brief Scloud+ level-512 KEM default parameters.
 *
...
#define scloudplus_l 512
#define SCLOUDPLUS_LEVEL_NAME "512"
#define SCLOUDPLUS_DIV_CEIL(num, den) (((num) + (den) - 1) / (den))

#define scloudplus_m 2400
#define scloudplus_n 2400
#define scloudplus_mbar 16
#define scloudplus_nbar 16
#define scloudplus_tau 4
#define scloudplus_secret_bd 12
#define scloudplus_error_bd 12
#define scloudplus_msg_scale_bits 4
...
#define scloudplus_bw_k 7
#define scloudplus_mu 256
...
#define scloudplus_hash_bytes 128
#define scloudplus_G_bytes 256
#define scloudplus_kem_z_bytes 128
#define scloudplus_pke_keygen_coins_bytes 128
#define scloudplus_pke_keygen_r1_bytes 128
#define scloudplus_pke_keygen_r2_bytes 128
...
#define scloudplus_pke_enc_coins_bytes 128
#define scloudplus_pke_enc_r1_bytes 128
#define scloudplus_pke_enc_r2_bytes 128
