/**
 * @file parameters.h
 * @brief Scloud+ level-256 KEM default parameters.
 *
...
#define scloudplus_l 256
#define SCLOUDPLUS_LEVEL_NAME "256"
#define SCLOUDPLUS_DIV_CEIL(num, den) (((num) + (den) - 1) / (den))

#define scloudplus_m 1184
#define scloudplus_n 1184
