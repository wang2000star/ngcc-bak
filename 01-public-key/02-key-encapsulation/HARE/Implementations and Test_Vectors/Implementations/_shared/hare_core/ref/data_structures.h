 ...
 * @brief   HARE-PKE and HARE-KEM ciphertext data structures.
 */

#ifndef HARE_REF_DATA_STRUCTURES_H
#define HARE_REF_DATA_STRUCTURES_H
...
typedef struct {
    ...
    uint64_t v2[(VEC_NV2_SIZE_64 > 0 ? VEC_NV2_SIZE_64 : 1)];
} ciphertext_pke_t;
 ...
 * - salt:  extra randomness (SALT_BYTES bytes)
 */
typedef struct {
...
#endif  // HARE_REF_DATA_STRUCTURES_H
