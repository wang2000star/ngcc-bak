...
/*
 * AArch64/SVE erasure-aware Reed-Solomon implementation for HARE.
 *
 * This file is used by ARM/SVE optimized targets. It keeps the
 ...
 *   - ARM/SVE targets link aarch64/sve/gf.c, whose GF(2^8) path uses
 *     fixed-loop software arithmetic in this package;
