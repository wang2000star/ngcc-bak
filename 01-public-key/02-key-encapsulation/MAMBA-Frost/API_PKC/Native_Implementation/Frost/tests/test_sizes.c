...
int main(void)
{
    const profile_t profiles[] = {
        { "MAMBA-Frost-128", 512, 512, 8, 8, 15, 2, 2, 2, 10, 10, 5, PK128, CT128, SK128, SS128, 5152, 5192, 6736, 16 },
        { "MAMBA-Frost-192", 880, 880, 8, 8, 16, 1, 1, 3, 11, 11, 6, PK192, CT192, SK192, SS192, 9712, 9760, 11528, 24 },
        { "MAMBA-Frost-256", 1288, 1288, 8, 8, 16, 1, 1, 4, 13, 12, 8, PK256, CT256, SK256, SS256, 16776, 15552, 19416, 32 },
        { "MAMBA-Frost-384", 1928, 1928, 8, 12, 16, 1, 1, 4, 13, 13, 9, PK384, CT384, SK384, SS384, 25096, 37736, 29032, 48 },
        { "MAMBA-Frost-512", 2600, 2600, 8, 16, 16, 1, 1, 4, 14, 14, 7, PK512, CT512, SK512, SS512, 36432, 72944, 41728, 64 },
    };
    int ok = 1;
