/********************************************************************************************
* MAMBA-Frost-CC: known-answer-test driver for Frost-CC-256 with AES128 matrix expansion.
*********************************************************************************************/
...
char    AlgName[] = "MAMBA-Frost-CC-256-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_FrostCC256(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_FrostCC256(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_FrostCC256(ss1, ct, sk)) != 0) {
