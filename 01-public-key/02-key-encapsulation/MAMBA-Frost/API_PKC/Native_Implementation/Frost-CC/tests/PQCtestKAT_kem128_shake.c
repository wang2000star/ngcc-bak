/********************************************************************************************
* MAMBA-Frost-CC: known-answer-test driver for Frost-CC-128 with AES128 matrix expansion.
*********************************************************************************************/
...
char    AlgName[] = "MAMBA-Frost-CC-128-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_FrostCC128(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_FrostCC128(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_FrostCC128(ss1, ct, sk)) != 0) {
