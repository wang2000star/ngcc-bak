...
char    AlgName[] = "MAMBA-Frost-CC-192-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_FrostCC192(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_FrostCC192(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_FrostCC192(ss1, ct, sk)) != 0) {
