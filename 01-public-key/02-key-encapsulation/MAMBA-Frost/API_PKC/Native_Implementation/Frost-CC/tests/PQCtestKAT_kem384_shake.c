/********************************************************************************************
* MAMBA-Frost-CC: known-answer-test driver for Frost-CC-192 with AES128 matrix expansion.
*********************************************************************************************/
...
char    AlgName[] = "MAMBA-Frost-CC-384-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_FrostCC384(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_FrostCC384(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_FrostCC384(ss1, ct, sk)) != 0) {
