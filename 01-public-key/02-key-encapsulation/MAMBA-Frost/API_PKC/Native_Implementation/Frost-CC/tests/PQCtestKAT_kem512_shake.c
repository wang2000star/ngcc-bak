...
char    AlgName[] = "MAMBA-Frost-CC-512-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_FrostCC512(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_FrostCC512(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_FrostCC512(ss1, ct, sk)) != 0) {
