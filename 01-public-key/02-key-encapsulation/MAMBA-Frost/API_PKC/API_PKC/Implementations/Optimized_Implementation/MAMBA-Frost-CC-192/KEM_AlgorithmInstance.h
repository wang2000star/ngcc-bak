/* Official API_PKC KEM interface for MAMBA-Frost-CC-192. */
#ifndef KEM_ALGORITHM_INSTANCE_H
#define KEM_ALGORITHM_INSTANCE_H

#define OUTPUT_BLANK_TEST_VECTORS 0
#define ALGORITHM_INSTANCE "MAMBA-Frost-CC-192"

/* Exact byte lengths from Frost-CC/src/api_frostcc192.h. */
#define PUBLICKEYBYTES    9712ULL
#define SECRETKEYBYTES    11528ULL
#define SHAREDSECRETBYTES   24ULL
#define CIPHERTEXTBYTES   9760ULL
