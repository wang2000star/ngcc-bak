/* Parameter macro bridge for the API_PKC optimized MAMBA-Frost-512 KEM instance.
 * The byte lengths below are obtained from Frost/src/api_frost512.h through
...
#include "Frost/src/api_frost512.h"
