/* Parameter macro bridge for the API_PKC optimized MAMBA-Frost-192 KEM instance.
 * The byte lengths below are obtained from Frost/src/api_frost192.h through
...
#include "Frost/src/api_frost192.h"
