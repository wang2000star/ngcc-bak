# MAMBA-Frost-CC-384 optimized AVX2 API_PKC KEM instance

This directory wraps the existing Frost-CC-384 optimized AVX2 implementation under the official API_PKC KEM interface (KEM_AlgorithmInstance.h/.c). It does not change Frost-CC parameters, key formats, ciphertext formats, shared-secret formats, FO/implicit-rejection logic, or RNG call semantics.
