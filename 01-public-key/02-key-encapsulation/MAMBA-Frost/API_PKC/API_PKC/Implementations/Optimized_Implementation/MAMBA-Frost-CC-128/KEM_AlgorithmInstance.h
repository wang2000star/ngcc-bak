/* Official API_PKC KEM interface for MAMBA-Frost-CC-128. */
#ifndef KEM_ALGORITHM_INSTANCE_H
#define KEM_ALGORITHM_INSTANCE_H

#define OUTPUT_BLANK_TEST_VECTORS 0
#define ALGORITHM_INSTANCE "MAMBA-Frost-CC-128"

/* Exact byte lengths from Frost-CC/src/api_frostcc128.h. */
#define PUBLICKEYBYTES    5152ULL
#define SECRETKEYBYTES    6736ULL
#define SHAREDSECRETBYTES   16ULL
#define CIPHERTEXTBYTES   5192ULL
