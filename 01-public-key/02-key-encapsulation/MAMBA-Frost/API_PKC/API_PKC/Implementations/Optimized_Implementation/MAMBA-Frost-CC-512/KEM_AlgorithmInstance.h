/* Official API_PKC KEM interface for MAMBA-Frost-CC-512. */
#ifndef KEM_ALGORITHM_INSTANCE_H
#define KEM_ALGORITHM_INSTANCE_H

#define OUTPUT_BLANK_TEST_VECTORS 0
#define ALGORITHM_INSTANCE "MAMBA-Frost-CC-512"

/* Exact byte lengths from Frost-CC/src/api_frostcc512.h. */
#define PUBLICKEYBYTES    72832ULL
#define SECRETKEYBYTES    83328ULL
#define SHAREDSECRETBYTES   64ULL
#define CIPHERTEXTBYTES   36544ULL
