/* Parameter macro bridge for the API_PKC optimized MAMBA-Frost-128 KEM instance.
 * The byte lengths below are obtained from Frost/src/api_frost128.h through
