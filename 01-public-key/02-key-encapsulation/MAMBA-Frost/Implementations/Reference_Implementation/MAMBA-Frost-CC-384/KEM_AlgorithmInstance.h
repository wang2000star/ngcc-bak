/* Official API_PKC KEM interface for MAMBA-Frost-CC-384. */
#ifndef KEM_ALGORITHM_INSTANCE_H
#define KEM_ALGORITHM_INSTANCE_H

#define OUTPUT_BLANK_TEST_VECTORS 0
#define ALGORITHM_INSTANCE "MAMBA-Frost-CC-384"

/* Exact byte lengths from Frost-CC/src/api_frostcc384.h. */
#define PUBLICKEYBYTES    37628ULL
#define SECRETKEYBYTES    43492ULL
#define SHAREDSECRETBYTES   48ULL
#define CIPHERTEXTBYTES   25204ULL
