/* Parameter macro bridge for the API_PKC optimized MAMBA-Frost-256 KEM instance.
 * The byte lengths below are obtained from Frost/src/api_frost256.h through
