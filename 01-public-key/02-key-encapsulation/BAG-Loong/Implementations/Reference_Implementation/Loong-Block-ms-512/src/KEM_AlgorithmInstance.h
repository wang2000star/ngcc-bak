/*
 * BAG-Loong-512 API_PKC KEM interface.
 * This header keeps the API_PKC prototypes unchanged and only sets the
 * instance-specific submission macros.
 */
...
#define ALGORITHM_INSTANCE "BAG-Loong-512"
