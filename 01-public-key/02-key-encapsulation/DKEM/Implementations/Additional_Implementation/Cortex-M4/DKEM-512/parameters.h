...
#ifndef DKE_HASH
#define DKE_HASH 0    /* 0=SM3 (DKEM reference / KAT), 1=SHAKE128 all, 2=SHAKE128+SHA3-256+SHA3-512+SHAKE256 (ML-KEM suite) */
#endif

/* DKE_HASH_SHAKE: true when SHAKE-based operations are available (HASH=1 or HASH=2) */
#if DKE_HASH == 1 || DKE_HASH == 2
