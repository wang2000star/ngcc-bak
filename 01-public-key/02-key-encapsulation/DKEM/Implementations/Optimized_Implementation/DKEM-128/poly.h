 ...
 * extra values past DKE_N (ntt256 AVX2 known issue, pq-crystals/ntt256#21).
 */
typedef union {
 ...
 * order that the vendored ntt256 asm basemul expects. No-op unless DKE_AVX2_NTT256_ASM. */
