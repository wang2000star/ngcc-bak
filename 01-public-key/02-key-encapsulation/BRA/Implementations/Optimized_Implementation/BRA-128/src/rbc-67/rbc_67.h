...
typedef uint64_t rbc_elt[RBC_67_ELT_SIZE];
typedef uint64_t rbc_elt_ur[RBC_67_ELT_UR_SIZE];
...
static const rbc_elt RBC_67_ELT_MODULUS = {0x0000000000000027, 0x0000000000000008};
