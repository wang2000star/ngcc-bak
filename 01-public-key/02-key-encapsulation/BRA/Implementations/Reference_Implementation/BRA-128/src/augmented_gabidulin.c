...
/**
 * \fn void rbc_augmented_gabidulin_init(rbc_augmented_gabidulin* code, const rbc_vec g, uint32_t k, uint32_t n)
...
/**
 * \fn void rbc_augmented_gabidulin_encode(rbc_vec c, const rbc_augmented_gabidulin gc, const rbc_vec m)
...
/**
 * \fn void rbc_augmented_gabidulin_decode(rbc_vec m, const rbc_augmented_gabidulin gc, const rbc_vec y)
...
void rbc_augmented_gabidulin_decode(rbc_vec m, const rbc_augmented_gabidulin gc, const rbc_vec y) {
  ...
  for(size_t i = 0 ; i < gc.n ; ++i) {
    rbc_qpoly_evaluate(tmp1, A, gc.g[i]);
    rbc_qpoly_evaluate(tmp2, V0, y[i]);
    rbc_elt_add(tmp1, tmp1, tmp2);
    rbc_elt_set(u0[i], tmp1);

    rbc_qpoly_evaluate(tmp1, I, gc.g[i]);
    rbc_qpoly_evaluate(tmp2, V1, y[i]);
    rbc_elt_add(tmp1, tmp1, tmp2);
