/**
 * \file main_bra.c
 * \brief BRA KEM demonstration program
 *
...
int main() {
  ...
  printf("\n");
  printf("Q: %d   ", BRA_PARAM_Q);
  printf("M: %d   ", BRA_PARAM_M);
  printf("K: %d   ", BRA_PARAM_K);
  printf("N: %d   ", BRA_PARAM_N);
  printf("W_x: %d   ", BRA_PARAM_W_x);
  printf("W_y: %d   ", BRA_PARAM_W_y);
  printf("W_r1: %d   ", BRA_PARAM_W_r1);
  printf("W_r2: %d   ", BRA_PARAM_W_r2);
  printf("W_e: %d   ", BRA_PARAM_W_e);
  printf("Sec: %d bits\n", BRA_SECURITY);
