...
static const unsigned char kat0_expected_ss[CRYPTO_BYTES] = {
    0x3E, 0x1A, 0x89, 0x43, 0x6C, 0x80, 0x7E, 0xF0,
    0xF3, 0xB9, 0xC7, 0xAC, 0x28, 0x12, 0x40, 0xC9,
    0x8F, 0xCC, 0x52, 0xB3, 0x72, 0xA5, 0xBC, 0x49,
    0x47, 0x0D, 0x1C, 0xAD, 0x6D, 0xD9, 0x52, 0xD7,
    0x8F, 0xB6, 0x55, 0x0C, 0xC1, 0xD6, 0xA7, 0x1A,
    0x4A, 0xD1, 0x3A, 0x6A, 0x5F, 0xDA, 0xB4, 0x1E,
    0x89, 0x80, 0xCF, 0x5F, 0x9C, 0x11, 0x5A, 0x1F,
    0x8B, 0xC8, 0xAE, 0xF3, 0x07, 0xC2, 0xDE, 0x0A
};
...
static int run_kem_test(void)
{
    ...
    hal_send_str("==========================");
    hal_send_str("SCABBARD512 BOARD TEST KAT0 SEED");
