...
static const unsigned char kat0_expected_ss[CRYPTO_BYTES] = {
    0x7B, 0x5E, 0x39, 0x3D, 0x3B, 0xCD, 0xF8, 0xFB,
    0x97, 0xF1, 0x1D, 0xD7, 0xDB, 0x05, 0xC4, 0xC9,
    0x6E, 0x27, 0x23, 0xC2, 0x9B, 0xEC, 0x0F, 0xBD,
    0x48, 0xDA, 0x90, 0xFA, 0x81, 0x17, 0xA1, 0xCE
};
...
static int run_kem_test(void)
{
    ...
    hal_send_str("==========================");
    hal_send_str("SCABBARD256 BOARD TEST KAT0 SEED");
