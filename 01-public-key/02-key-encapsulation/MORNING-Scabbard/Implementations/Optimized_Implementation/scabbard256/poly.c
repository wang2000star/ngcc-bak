    ...
    const uint16_t acc[3][3][N_SM_16_RES])
{
    ...
    __m256i acc00, acc01, acc02, acc10, acc11, acc12, acc20, acc21, acc22;
    __m256i r0, r1, r2;
    __m256i old_w_i, old_w_i32, old_w_i64;
    for (i = 0; i < N_SM_16_RES; i+=16) {
        ...
        old_w_i32 = _mm256_loadu_si256((const __m256i*)&w0[i + 32]);
        _mm256_storeu_si256((__m256i*)&w0[i + 32], _mm256_add_epi16(old_w_i32, r0));
        
        old_w_i64 = _mm256_loadu_si256((const __m256i*)&w0[i + 64]);
        _mm256_storeu_si256((__m256i*)&w0[i + 64], _mm256_add_epi16(old_w_i64, acc00));

        old_w_i = _mm256_loadu_si256((const __m256i*)&w1[i]);
        _mm256_storeu_si256((__m256i*)&w1[i], _mm256_add_epi16(old_w_i, acc12));
        old_w_i32 = _mm256_loadu_si256((const __m256i*)&w1[i + 32]);
        _mm256_storeu_si256((__m256i*)&w1[i + 32], _mm256_add_epi16(old_w_i32, r1));
        old_w_i64 = _mm256_loadu_si256((const __m256i*)&w1[i + 64]);
        _mm256_storeu_si256((__m256i*)&w1[i + 64], _mm256_add_epi16(old_w_i64, acc10));
        old_w_i = _mm256_loadu_si256((const __m256i*)&w2[i]);
        _mm256_storeu_si256((__m256i*)&w2[i], _mm256_add_epi16(old_w_i, acc22));
        old_w_i32 = _mm256_loadu_si256((const __m256i*)&w2[i + 32]);
        _mm256_storeu_si256((__m256i*)&w2[i + 32], _mm256_add_epi16(old_w_i32, r2));
        old_w_i64 = _mm256_loadu_si256((const __m256i*)&w2[i + 64]);
        _mm256_storeu_si256((__m256i*)&w2[i + 64], _mm256_add_epi16(old_w_i64, acc20));
    }
    __m256i vr0, vr1, vr2, sum_r0_r2;
    __m256i old_res_i, old_res_i64, old_res_i128;
    for (i = 0; i < N_SM_RES; i+=16) {
        ...
        old_res_i64 = _mm256_loadu_si256((const __m256i*)&result_interp[i + 64]);
        _mm256_storeu_si256((__m256i*)&result_interp[i + 64], _mm256_add_epi16(old_res_i64, vr1));

        old_res_i128 = _mm256_loadu_si256((const __m256i*)&result_interp[i + 128]);
        _mm256_storeu_si256((__m256i*)&result_interp[i + 128], _mm256_add_epi16(old_res_i128, vr0));
    }
    __m256i res_low;
    __m256i res_high;
    __m256i diff;
    for (i = SCABBARD_N; i < 2 * SCABBARD_N; i=i+16) {
        res_low  = _mm256_loadu_si256((const __m256i*)&result_interp[i - SCABBARD_N]);
        res_high = _mm256_loadu_si256((const __m256i*)&result_interp[i]);

        diff = _mm256_sub_epi16(res_low, res_high);
