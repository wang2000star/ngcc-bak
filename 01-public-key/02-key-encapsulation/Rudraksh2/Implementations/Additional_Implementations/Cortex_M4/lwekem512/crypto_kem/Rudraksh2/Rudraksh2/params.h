...
#ifndef KEM_L
#define KEM_L 8 /* Change this for different security strengths */
#endif
...
//#define KEM_Q_2 (3840)				 // floor(KEM_Q/2)
#define KEM_Q_2 (3841)				 // round(KEM_Q/2)
//#define KEM_Q_DENOM (4368)		 // floor(2^(32-LOG2T)/KEM_Q)
#define KEM_Q_DENOM (8737)		 // round(2^(26)/KEM_Q)
#define KEM_32_LOG2T (16777216)// 2^(32-LOG2T-1)
#define LOG2T_BITMASK (0x7f)	 // Take the bottom LOG2T bits
#define LOG2P_BITMASK (0x1fff) // Take the bottom LOG2P bits
#define KEM_Q_232 (559168)		 // floor((2^32/KEM_Q) + 1)
#define KEM_Q_230 (139792)		 // floor((2^30/KEM_Q) + 1)
#define RLOG (18)							 // rlog for modular reduction
//#define RMASK (0x3ffff)				 // rlog for modular reduction
// #define INV_2_Q (2044)				 // 2^(-1) * 2^16 mod KEM_Q
#define KEM_Q_INV (7679)			 // -inverse_mod(KEM_Q, 2^16)
//#define RLOG (16)							 // rlog for modular reduction
//#define RMASK (0xffff)				 // rlog for modular reduction
#define INV_2_Q (2044)				 // 2^(-1) * 2^16 mod KEM_Q
#define KEM_2K_Q (8)           // 2^16 / KEM_Q
// #define INV_2_Q (1749) // (2^16)^-1 / 2 mod KEM_Q
// #define MONT (4088)		// 2^16 mod KEM_Q
#define MONT_2 (4613) // 2^18 * 2^18 mod KEM_Q

// NTT
// #define ROOT_OF_UNITY (62)

#define KEM_ETA 2

#define KEM_SYMBYTES 64 // 32   /* size in bytes of hashes, and seeds */
#define KEM_SSBYTES 64	// 32   /* size in bytes of shared key */
