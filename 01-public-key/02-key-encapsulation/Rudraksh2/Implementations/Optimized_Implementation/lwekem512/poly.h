...
void polyadd_avx(poly *r, const poly *a, const poly *b, const uint16_t qdata[QDATA_N]);

void polysub_avx(poly *r, const poly *a, const poly *b, const uint16_t qdata[QDATA_N]);

void polyreduce_avx(poly *r, const uint16_t qdata[QDATA_N]);

void basemul_mont_avx(poly *r, const poly *a, const poly *b, const uint16_t qdata[QDATA_N]);
