...
#define KEX_UAKE_SENDABYTES (KEM_PUBLICKEYBYTES + KEM_CIPHERTEXTBYTES)
#define KEX_UAKE_SENDBBYTES (KEM_CIPHERTEXTBYTES)

#define KEX_AKE_SENDABYTES (KEM_PUBLICKEYBYTES + KEM_CIPHERTEXTBYTES)
#define KEX_AKE_SENDBBYTES (2*KEM_CIPHERTEXTBYTES)

#define KEX_SSBYTES KEM_SSBYTES
