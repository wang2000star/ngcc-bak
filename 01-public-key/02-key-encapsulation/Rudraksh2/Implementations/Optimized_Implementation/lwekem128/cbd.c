...
cbd (poly *r, const unsigned char *buf)
{
	...
	// AVX2 implementation of the centered binomial distribution (CBD) function with ETA=2
	__m256i f0, f1, f2, f3;
    ...
    _mm256_storeu_si256((__m256i *)(r->coeffs + 16), f2);
    _mm256_storeu_si256((__m256i *)(r->coeffs + 32), f1);
    _mm256_storeu_si256((__m256i *)(r->coeffs + 48), f3);
}
