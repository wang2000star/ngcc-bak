...
#define polyvec_compress KEM_NAMESPACE (polyvec_compress)
void polyvec_compress (uint8_t r[KEM_POLYVECCOMPRESSEDBYTES],
											 const polyvec *a);
#define polyvec_decompress KEM_NAMESPACE (polyvec_decompress)
void polyvec_decompress (polyvec *r,
												 const uint8_t a[KEM_POLYVECCOMPRESSEDBYTES]);
