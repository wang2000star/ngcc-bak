...
*              16-bit unsigned integer congruent to a * R^-1 mod q, where R=2^18
*
* Arguments:   - uint32_t a: input integer to be reduced;
*                           has to be in {0,...,q2^18-1}
*
...
* Name:        barrett_reduce
*
* Description: Barrett reduction; given a 16-bit integer a, computes at most 14 bits
