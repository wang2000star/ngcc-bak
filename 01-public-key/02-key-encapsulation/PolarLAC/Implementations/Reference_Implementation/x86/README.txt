PolarLAC MLWE Reference Implementation for x86
=============================================

This directory contains the reference x86 implementations for the five
submitted PolarLAC MLWE KEM parameter sets.
...
Run make in a parameter-set directory to build that instance.  The Makefiles
default to BIT_USE_SHAKE=0 and can be built with BIT_USE_SHAKE=1 when SHAKE is
required.

The submitted reference test vectors are stored under:
../../../Test_Vector/Reference_Implementation/x86/
