...
File Description: Defines parameter constants for the reference POLARLAC-128 implementation.
*/
...
#define RL_KEM_K 2 // dimension of poly-matrix
#define RL_KEM_Q 257
#define QINV -255
#define RL_KEM_T (30 * 30)  // squared FFT threshold for r,s,e
#define CONJ_NTT_Q 769
#define CONJ_NTT_T 1681// conjugate-NTT rejection threshold for r,e,s,e1
