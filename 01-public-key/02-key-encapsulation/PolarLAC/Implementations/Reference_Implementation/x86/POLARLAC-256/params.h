...
File Description: Defines parameter constants for the reference POLARLAC-256 implementation.
*/
...
#define CONJ_NTT_T 3025 // conjugate-NTT rejection threshold for r,e,s,e1
