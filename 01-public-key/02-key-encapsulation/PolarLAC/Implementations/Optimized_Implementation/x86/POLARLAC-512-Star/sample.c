...
File Description: Implements polynomial sampling routines for the optimized POLARLAC-512-Star instance.
*/
...
#define TERNARY_SAMPLE_PLANES 4
#define sample_ternary_planes_avx2 sample_ternary_4planes_avx2
