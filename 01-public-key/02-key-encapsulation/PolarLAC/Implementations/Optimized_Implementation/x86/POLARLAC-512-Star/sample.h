...
File Description: Declares polynomial sampling routines for the optimized POLARLAC-512-Star instance.
*/
...
extern "C"
{
    ...
    /// @brief Generate four ternary polynomials from one seed and four nonces.
