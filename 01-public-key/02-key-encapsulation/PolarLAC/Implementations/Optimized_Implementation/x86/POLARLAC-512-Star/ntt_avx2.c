...
File Description: Implements AVX2 NTT arithmetic routines for the optimized POLARLAC-512-Star instance.
*/
...
inline int ntt_core_final_level(__m256i *U, __m256i *V, __m256i *S,__m256i *A1,__m256i *A2)
{
    __m256i tmp_c0, tmp_c1, tmp_x;
