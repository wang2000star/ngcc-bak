...
File Description: Implements AVX2 NTT arithmetic routines for the optimized POLARLAC-128 instance.
*/
...
int incom_mul_acc_avx2(int16_t *acc, const int16_t *a, const int16_t *b)
{
    ...
    for (int i = 0; i < RL_KEM_N; i += 16) {
        ...
        __m256i r = _mm256_blend_epi16(r0_candidate, r1_candidate, 0xAA);
