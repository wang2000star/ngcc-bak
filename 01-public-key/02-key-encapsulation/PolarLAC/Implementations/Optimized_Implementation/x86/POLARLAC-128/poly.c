...
void poly_compress_c2(uint8_t *code_c, const int16_t *c, unsigned int d)
{
    ...
    for (int i = 0; i < RL_KEM_Lv; i += 16) {
        ...
        __m256i x0 = avx2_mod_q257_epi32(_mm256_cvtepi16_epi32(_mm256_castsi256_si128(x16)));
        __m256i x1 = avx2_mod_q257_epi32(_mm256_cvtepi16_epi32(_mm256_extracti128_si256(x16, 1)));
...
void poly_decompress_c2(int16_t *c, const uint8_t *code_c, unsigned int d)
{
    ...
    const __m256i half = _mm256_set1_epi16(1 << (4 - 1));
