...
File Description: Implements the active NTT glue layer for the optimized POLARLAC-Light instance.
*/
...
void mq_poly_pointwise_mul(int16_t *r, int16_t *a, int16_t *b)
{
    ...
    incom_mul_mod_avx2(a_work, b_work, r_work);
