...
File Description: Implements integer fixed-point AVX2 FFT-based spectral rejection for the optimized POLARLAC-Light instance.
*/
...
/**
 * @file fft.c
 * @brief Integer fixed-point FFT implementation used by the POLARLAC-Light
 *        rejection sampler.
 *
...
#if RL_KEM_N != 256
#error "This integer AVX2 FFT kernel is specialized for RL_KEM_N=256."
#endif
