...
File Description: Declares polar encoding and decoding helpers for the optimized POLARLAC-Light instance.
*/
...
///          length, dimension and auxiliary storage size used by this instance.
