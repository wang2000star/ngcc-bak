...
#define DTRU_MSGBYTES 48 /* (DTRU_N / 4) bits = 384 bits = 48 bytes */
...
#define DTRU_COINBYTES_KEYGEN (DTRU_CBD2_BYTES + DTRU_CBD3_BYTES)
...
#if PK_PACK_OPT
    #define DTRU_PKE_PUBLICKEYBYTES 2259
#else
