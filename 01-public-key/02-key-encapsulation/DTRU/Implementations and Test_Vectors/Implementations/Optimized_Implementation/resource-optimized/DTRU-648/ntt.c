...
void basemul(int16_t *c, const int16_t *a, const int16_t *b, const int16_t zeta)
{
  ...
  a0[0] = a[0]; a1[0] = a[1]; a2[0] = a[2];
  a0[1] = a[3]; a1[1] = a[4]; a2[1] = a[5];
  a0[2] = a[6]; a1[2] = a[7]; a2[2] = a[8];
  b0[0] = b[0]; b1[0] = b[1]; b2[0] = b[2];
  b0[1] = b[3]; b1[1] = b[4]; b2[1] = b[5];
  b0[2] = b[6]; b1[2] = b[7]; b2[2] = b[8];

  a01[0] = a0[0] + a1[0]; a02[0] = a0[0] + a2[0]; a12[0] = a1[0] + a2[0];
  a01[1] = a0[1] + a1[1]; a02[1] = a0[1] + a2[1]; a12[1] = a1[1] + a2[1];
  a01[2] = a0[2] + a1[2]; a02[2] = a0[2] + a2[2]; a12[2] = a1[2] + a2[2];
  b01[0] = b0[0] + b1[0]; b02[0] = b0[0] + b2[0]; b12[0] = b1[0] + b2[0];
  b01[1] = b0[1] + b1[1]; b02[1] = b0[1] + b2[1]; b12[1] = b1[1] + b2[1];
  b01[2] = b0[2] + b1[2]; b02[2] = b0[2] + b2[2]; b12[2] = b1[2] + b2[2];
