...
int16_t zetas4inv[DTRU_N/4]={
428,-428,390,-390,202,-202,220,-220,236,-236,21,-21,212,-212,71,-71,
635,-635,151,-151,23,-23,657,-657,537,-537,227,-227,717,-717,621,-621,
244,-244,517,-517,532,-532,686,-686,652,-652,436,-436,703,-703,522,-522,
477,-477,352,-352,624,-624,238,-238,493,-493,575,-575,495,-495,699,-699,
209,-209,654,-654,670,-670,14,-14,29,-29,260,-260,391,-391,403,-403,
355,-355,478,-478,358,-358,664,-664,167,-167,357,-357,528,-528,438,-438,
421,-421,725,-725,691,-691,547,-547,419,-419,601,-601,611,-611,201,-201,
303,-303,330,-330,585,-585,127,-127,318,-318,491,-491,416,-416,415,-415
};
...
int baseinv_avx2(int16_t *b, const int16_t *a){
  ...
  for(int i = 0; i< DTRU_N/(4*16);i++){
    ...
    shuffle8_avx2(&a_vec[0], &a_vec[2]);
    shuffle8_avx2(&a_vec[1], &a_vec[3]);
    shuffle4_avx2(&a_vec[0], &a_vec[1]);
    shuffle4_avx2(&a_vec[2], &a_vec[3]);
    ...
    shuffle4_avx2(&b_vec[0], &b_vec[1]);
    shuffle4_avx2(&b_vec[2], &b_vec[3]);
    shuffle8_avx2(&b_vec[0], &b_vec[2]);
    shuffle8_avx2(&b_vec[1], &b_vec[3]);
    if(r != 0)   return r;
    for(int j = 0; j < 4; ++j)
    {
