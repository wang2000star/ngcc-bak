...
extern void doublebasemul_asm_4x4(int16_t * , const int16_t *, const int16_t *, const int16_t);
int rq_inverse_recursive8_asm(int16_t b[8], const int16_t a[8], const int16_t zeta)
{
    int16_t a0[4], a1[4], c0[4], c1[4], b0[4], b1[4];
    unsigned int i;
    int r;
    ...
    doublebasemul_asm_4x4(b0, c0, a1, zeta);
    doublebasemul_asm_4x4(b1, c1, a1, zeta);
...
#define _2P15 (1 << 15)
extern int jump16divsteps(int minusdelta, int32_t *M, int32_t *f, int32_t *g);

int rq_inverse_asm(int16_t finv[8], const int16_t f[8], const int16_t zeta)
{
    int i;
    int16_t scale;
    int16_t Phi[32] = {0};
    ...
    Phi[0] = 1;
    Phi[8] = -zeta;
    for (i = 0; i < 8; ++i) F[8 - 1 - i] = f[i];
    F[8] = 0;

    int minusdelta = -1;
    minusdelta = jump16divsteps(minusdelta, (int32_t *)V, (int32_t *)Phi, (int32_t *)F);
    ...
    for (i = 0; i < 8; ++i)
        finv[i] = fq_freeze(scale * (int32_t)V[56 - i]);
