...
#define DTRU_MSGBYTES 32 /* (DTRU_N / 4) bits = 256 bits = 32 bytes */
...
#define DTRU_COINBYTES_KEYGEN (DTRU_CBD2_BYTES + DTRU_CBD5_BYTES)
#define DTRU_COINBYTES_ENC (DTRU_CBD3_BYTES + DTRU_CBD2_BYTES)
...
#if PK_PACK_OPT
    #define DTRU_PKE_PUBLICKEYBYTES 1506
#else
