...
This directory contains the source code delivery for `KEM-DTRU-ARM-ResourceOpt`. The implementation maps to the `m4fstack` variant, covering all seven DTRU parameter sets.

| Parameter Set | Algorithm Source Directory |
| --- | --- |
| DTRU-Light | `crypto_kem/dtru-light/m4fstack` |
| DTRU-648 | `crypto_kem/dtru-648/m4fstack` |
| DTRU-768 | `crypto_kem/dtru-768/m4fstack` |
| DTRU-1024 | `crypto_kem/dtru-1024/m4fstack` |
| DTRU-1536 | `crypto_kem/dtru-1536/m4fstack` |
| DTRU-2048 | `crypto_kem/dtru-2048/m4fstack` |
| DTRU-Prime | `crypto_kem/dtru-prime/m4fstack` |
