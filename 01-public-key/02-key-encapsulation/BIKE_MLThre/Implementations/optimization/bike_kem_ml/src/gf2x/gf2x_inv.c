...
#elif(LEVEL == 7)
// The parameters below are hard-coded for experimental R=150001.
bike_static_assert((R_BITS == 150001), gf2x_inv_r_doesnt_match_parameters);
...
#  define EXP0_L_VALS \
     75001, 112501, 140626, 140040, 70860, 6126, 27626, 140789, 110379, 142419, 36341, 59477, 39946, \
     122279, 54161, 144366, 103014, 63451
#  define EXP1_K_VALS 0, 1, 3, 7, 0, 15, 47, 111, 239, 0, 0, 495, 0, 0, 2543, 0, 0, 18927
#  define EXP1_L_VALS 0, 75001, 131251, 130079, 0, 141720, 120933, 72786, 149839, 0, 0, 118722, 0, 0, 81320, 0, 0, 43158
