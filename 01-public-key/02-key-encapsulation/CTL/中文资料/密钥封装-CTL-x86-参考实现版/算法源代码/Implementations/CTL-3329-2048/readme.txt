CTL-3329-2048 KEM 参考实现
================================================================================

本目录是 CTL-3329-2048 参数集的密钥封装机制（KEM）参考实现。
...
--------------------------------------------------------------------------------
  ...
  - api.c, api_3329_2048.c        : CTL API 实现
  - drng.c/.h                   : 确定性随机数生成器
  - prng.c                      : CTL 内部随机接口
  - Makefile                    : 编译脚本
...
长度参数
--------------------------------------------------------------------------------
  - public key  : 3009 bytes
  - private key : 15617 bytes
  - ciphertext  : 2353 bytes
  - shared key  : 48 bytes
