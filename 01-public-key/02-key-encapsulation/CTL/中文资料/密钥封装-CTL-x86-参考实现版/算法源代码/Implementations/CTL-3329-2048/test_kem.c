...
int main() {
    unsigned char *pk = (unsigned char *)malloc(5000);
    unsigned char *sk = (unsigned char *)malloc(20000);
    unsigned char *ct = (unsigned char *)malloc(4000);
    ...
    printf("=== Testing CTL-3329-2048 KEM Implementation ===\n\n");
