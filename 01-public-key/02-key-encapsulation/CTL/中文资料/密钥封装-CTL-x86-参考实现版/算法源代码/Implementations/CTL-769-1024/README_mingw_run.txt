...
手工编译时，请将 CTL_SOURCE_FILES 替换为本目录实际源文件列表，并使用新的统一文件名：
    ...
    KEM_AlgorithmInstance.c api_769_1024.c codec.c fft.c fnr.c kem257.c kem769.c kem3329.c keygen.c ntru_solver.c ntru_utils.c ng_fxp.c ng_mp31.c ng_ntru.c ng_poly.c ng_zint31.c sha3.c modqp.c prng.c auxfunc.c drng.c
