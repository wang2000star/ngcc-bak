CTL-769-1024 KEM 参考实现
================================================================================

本目录是 CTL-769-1024 参数集的密钥封装机制（KEM）参考实现。
...
--------------------------------------------------------------------------------
  ...
  - api.c, api_769_1024.c        : CTL API 实现
  - drng.c/.h                   : 确定性随机数生成器
  - prng.c                      : CTL 内部随机接口
  - Makefile                    : 编译脚本
...
长度参数
--------------------------------------------------------------------------------
  - public key  : 1230 bytes
  - private key : 6030 bytes
  - ciphertext  : 1006 bytes
  - shared key  : 32 bytes
