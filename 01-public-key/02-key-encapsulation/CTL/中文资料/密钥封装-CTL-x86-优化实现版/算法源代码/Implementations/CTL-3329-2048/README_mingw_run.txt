CTL-3329-2048 optimized KEM self-evaluation files for MinGW/Windows
...
The Makefile also keeps the implementation feature macros for the optimized AVX2/x86 assembly path.
