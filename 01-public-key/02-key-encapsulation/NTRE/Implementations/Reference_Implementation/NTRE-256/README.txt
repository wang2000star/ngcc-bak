NTRE-256  -  Reference Implementation
=====================================

Algorithm : NTRE  (NTRU-based KEM)
Instance  : NTRE-256  (n = 1296, q = 2917, D = 4)
...
-----
    make
    ./bin/KAT_KEM
    # writes output/KAT_KEM_NTRE-256.txt

Byte lengths
------------
    NTRE_PUBLICKEYBYTES   = 1944
    NTRE_SECRETKEYBYTES   = 3920
    NTRE_CIPHERTEXTBYTES  = 1944
    NTRE_SSBYTES          = 64
