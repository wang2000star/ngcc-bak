...
{
    for (size_t i = 0; i < NTRE_N / 8; i++) {
        basemul(r->coeffs + 8 * i,     a->coeffs + 8 * i,     b->coeffs + 8 * i,     base_zetas[i]);
        basemul(r->coeffs + 8 * i + 4, a->coeffs + 8 * i + 4, b->coeffs + 8 * i + 4, -base_zetas[i]);
    }
}
...
{
    for (size_t i = 0; i < NTRE_N / 8; i++) {
        basemul_add(r->coeffs + 8 * i,     a->coeffs + 8 * i,     b->coeffs + 8 * i,     c->coeffs + 8 * i,     base_zetas[i]);
        basemul_add(r->coeffs + 8 * i + 4, a->coeffs + 8 * i + 4, b->coeffs + 8 * i + 4, c->coeffs + 8 * i + 4, -base_zetas[i]);
    }
}
