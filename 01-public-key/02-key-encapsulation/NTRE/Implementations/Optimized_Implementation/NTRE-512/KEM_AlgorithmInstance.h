...
/*
 * NTRE programming interface, conforming to the NGCC API_PKC template.
 * The two macros below are read by KAT_KEM.c (NGCC fixed) at compile time.
 */
#define OUTPUT_BLANK_TEST_VECTORS 0
#define ALGORITHM_INSTANCE        "NTRE-512"
...
#endif /* KEM_ALGORITHM_INSTANCE_H */
