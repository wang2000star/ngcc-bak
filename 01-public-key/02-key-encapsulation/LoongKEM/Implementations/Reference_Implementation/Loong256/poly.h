...
void encode_noise_vector(const int16_t * in, uint8_t* out, size_t inlen, uint8_t dbits);
void decode_noise_vector(const uint8_t* in, int16_t* out, size_t outlen, uint8_t dbits);
