...
#define INV_MAX_ITER 14

const size_t k0[] = {0, 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096};
const size_t t0[] = {0, 7791, 11686, 10712, 8460, 8067, 10233, 9969, 5343, 3257, 12969, 13647, 916, 13263};
const size_t k1[] = {0, 1, 0, 3, 11, 0, 27, 91, 0, 0, 219, 1243, 3291, 7387};
const size_t t1[] = {0, 7791, 0, 5843, 8848, 0, 255, 2392, 0, 0, 4036, 457, 13506, 10902};
