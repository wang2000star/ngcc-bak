...
const size_t t0[] = {0, 34846, 17423, 56624, 3539, 49832, 68203, 53723, 47346, 32701, 16697, 25809, 67594, 6876, 28878, 16378, 67916};
const size_t k1[] = {0, 0, 0, 1, 9, 25, 0, 0, 0, 0, 0, 0, 57, 0, 0, 0, 4153};
const size_t t1[] = {0, 0, 0, 34846, 36615, 18609, 0, 0, 0, 0, 0, 0, 46826, 0, 0, 0, 3156};
