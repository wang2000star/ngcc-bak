...
*              for CCA-secure FLIT key encapsulation mechanism
*
...
int crypto_kem_keypair(unsigned char *pk, unsigned char *sk)
{
    ...
    get_random_number(&drng_algorithm, sk + KEM_SECRETKEYBYTES - SEEDBYTES, SEEDBYTES * 8);
    return 0;
}
                   ...
                   const unsigned char *pk)
{
    ...
    get_random_number(&drng_algorithm, buf, SEEDBYTES * 8);
