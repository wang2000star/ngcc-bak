 ...
 *
 * Function routing:
 *   dke_xof        -- XOF for matrix/noise generation (SM3-iter / SHAKE128 / SHAKE128)
 *   dke_hash_pk    -- H(pk): fixed 32B hash of public key (pseudoXOF / SHAKE128 / SHA3-256)
 *   dke_hash_g     -- G(seed): seed expansion to 64B (pseudoXOF / SHAKE128 / SHA3-512)
 *   dke_xof_kdf    -- KDF for CCA kr derivation (pseudoXOF / SHAKE128 / SHAKE256)
 */
#ifndef DKE_HASH_H
#define DKE_HASH_H
 ...
 *   DKE_HASH=0,1: pseudoXOF/SHAKE128(pk) → 32B
 ...
 *   DKE_HASH=0,1: pseudoXOF/SHAKE128(seed) → 64B
 ...
 *   DKE_HASH=0,1: pseudoXOF/SHAKE128(in) → out_bytes
