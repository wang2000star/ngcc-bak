...
// Only letters, numbers, '-' or '_' are permitted. Mode-dependent (matches ref).
#include "ADKEX_parameters.h"
#if   ADKEX_MODE == 256
#define ALGORITHM_INSTANCE "DKEX-256"
#elif ADKEX_MODE == 512
#define ALGORITHM_INSTANCE "DKEX-512"
#else
#define ALGORITHM_INSTANCE "DKEX-128"
#endif
