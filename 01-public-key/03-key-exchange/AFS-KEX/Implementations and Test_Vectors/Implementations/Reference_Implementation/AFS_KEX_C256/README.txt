AFS_KEX_C256 Reference Implementation Bundle

This directory is a self-contained ISO C reference implementation bundle for
the AFS_KEX_C256 KEX instance.

File summary

  KEX_AlgorithmInstance.h/.c
      ICCS KEX programming interface and AFS_KEX_C256 wrapper implementation
  ...
  params.h, kem.*, indcpa.*, poly.*, polyvec.*, BWcoding.*
      AFS_KEX_C256 reference implementation core
...
Build and KAT generation
  ...
  make kat
      ...
      ../../../Test_Vector/KAT_KEX_AFS_KEX_C256.txt
