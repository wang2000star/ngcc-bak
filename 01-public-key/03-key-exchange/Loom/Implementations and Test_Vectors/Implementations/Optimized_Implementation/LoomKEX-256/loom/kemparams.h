...
#    define WEAVER_NAMESPACE(s) loom_kem128_avx2##s
#  else
...
#elif (WEAVER_MODE == 3)
#  if defined(LOOM_AVX2)
#    define WEAVER_NAMESPACE(s) loom_kem256_avx2##s
#  else
...
#elif (WEAVER_MODE == 5)
#  if defined(LOOM_AVX2)
#    define WEAVER_NAMESPACE(s) loom_kem512_avx2##s
#  else
...
/* AVX2 feature gates (LOOM kem/avx2/) */
