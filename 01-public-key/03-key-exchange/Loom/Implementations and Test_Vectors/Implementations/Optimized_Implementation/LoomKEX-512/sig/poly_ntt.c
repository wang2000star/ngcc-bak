...
#else /* !USE_AVX2_NTT && !USE_AVX512_NTT */

void poly_ntt_simd(poly16 *a) { (void)a; }
void poly_invntt_tomont_simd(poly16 *a) { (void)a; }
void poly_pointwise_montgomery_simd(poly16 *c, const poly16 *a, const poly16 *b)
{
    (void)c; (void)a; (void)b;
}
void poly_ntt_simd_import(poly16 *a) { (void)a; }

#endif /* USE_AVX2_NTT || USE_AVX512_NTT */
