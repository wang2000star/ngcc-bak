#!/usr/bin/env bash
# ADKEX-512 Optimized (AVX2 NTT; all hashing via auxfunc, sm3x8/sm3x4 removed).
set -e
CC=${CC:-gcc}
CF="-O3 -mavx2 -fcommon -DDKM_LINUX -DDKE_AVX2_NTT256_ASM -DDKE_NTT512_PACKED -DADKEX_MODE=512 -DDKE_MODE=512 -DDKE_HASH=0 -DDKE_RANDOM=0 -I. -std=c99 -Wpedantic -Wall -Wextra -flto -fomit-frame-pointer -march=x86-64 -mtune=native"
...
$CC -O3 -flto -fomit-frame-pointer build/*.o -o kat_ADKEX-512 -lm
./kat_ADKEX-512
