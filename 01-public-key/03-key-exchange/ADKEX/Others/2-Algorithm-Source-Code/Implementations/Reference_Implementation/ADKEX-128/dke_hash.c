 ...
 * DKE_HASH=2: SHAKE128 XOF + SHA3-256 H(pk) + SHA3-512 G + SHAKE256 KDF (ML-KEM suite)
 */
#include "dke_hash.h"
...
#else
#error "DKE_HASH must be 0 (SM3) or 2 (ML-KEM suite); HASH=1 (SHAKE128-all) was removed"
#endif /* DKE_HASH */
