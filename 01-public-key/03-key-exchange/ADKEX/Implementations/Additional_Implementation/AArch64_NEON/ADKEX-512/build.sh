#!/usr/bin/env bash
# ADKEX-512 Additional (arm64, ARMv8.4-A native). Build on an arm64 host (or cross + qemu).
set -e
CC=${CC:-gcc}
CF="-O3 -fcommon -march=armv8.2-a -DDKM_AARCH64 -DDKE_USE_AARCH64 -DDKE_USE_AARCH64_NATIVE -DADKEX_MODE=512 -DDKE_MODE=512 -DDKE_HASH=0 -DDKE_RANDOM=0 -I. -std=c99 -Wpedantic -Wall -Wextra -flto -fomit-frame-pointer"
...
$CC -O3 -flto -fomit-frame-pointer build/*.o -o kat_ADKEX-512 -lm $LRT
./kat_ADKEX-512
