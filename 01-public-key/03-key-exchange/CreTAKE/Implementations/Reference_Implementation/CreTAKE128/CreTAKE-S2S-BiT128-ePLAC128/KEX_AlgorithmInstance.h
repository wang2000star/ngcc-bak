...
#define ALGORITHM_INSTANCE "CreTAKE-S2S-BiT128-ePLAC128"
...
extern "C"
{
	...
	/// @brief Obtain the claimed byte length of the initiator's long-term public key
	/// @return If the authentication function is available, return the claimed byte length of the long-term public key; if not, return 0
	unsigned long long kex_get_pk_len_bytes_initiator();

	// Added beyond the ICCS interfaces to support different initiator and responder public-key lengths
	/// @brief Obtain the claimed byte length of the responder's long-term public key
	/// @return If the authentication function is available, return the claimed byte length of the long-term public key; if not, return 0
	...
	/// @brief Obtain the claimed byte length of the initiator's long-term private key
	/// @return If the authentication function is available, return the claimed byte length of the long-term private key; if not, return 0
	unsigned long long kex_get_sk_len_bytes_initiator();

	// Added beyond the ICCS interfaces to support different initiator and responder private-key lengths
	/// @brief Obtain the claimed byte length of the responder's long-term private key
	/// @return If the authentication function is available, return the claimed byte length of the long-term private key; if not, return 0
