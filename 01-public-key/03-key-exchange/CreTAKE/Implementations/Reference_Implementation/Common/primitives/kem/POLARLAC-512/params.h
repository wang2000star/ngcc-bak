...
File Description: Defines parameter constants for the optimized POLARLAC-512Light implementation.
*/
...
#define RL_KEM_Q 257
#define QINV -255
#define RL_KEM_T 1849
#define CONJ_NTT_Q 769
#define CONJ_NTT_T 4624 // conjugate-NTT rejection threshold for r,e,s,e1
...
/// @brief Byte length of the serialized ciphertext `c = byte(u_coeff_vec) || packed_c2`.
