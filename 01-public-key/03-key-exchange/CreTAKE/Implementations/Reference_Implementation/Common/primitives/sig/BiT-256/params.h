...
#define BIT_GAMMA2_BARRETT_MULT   6227976ULL  /* ceil(2^35/5517) */
...
/* Hint encoding — bitpack or base3+overflow */
#define BIT_HINT_BITPACK

/* --- base-3 + sparse overflow (compact; kept for later) --- */
#define BIT_H_PACK_GROUP            5
#define BIT_H_OVERFLOW_BITS         12   /* flat_idx 0..1535 (11b) + sign bit = 12b */
