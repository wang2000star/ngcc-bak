...
1.  Overview
    ...
    This directory contains the AVX2-optimized SM3-based implementation of ZEN
    for the 512-bit security level.

    Implementation family: AVX2+SM3
    Security level: 512-bit security level
    Symmetric primitive: SM3
    Vectorization: AVX2-optimized
...
4.  Notes
    ...
    This is an AVX2-optimized implementation. Make sure that the target
    platform supports AVX2 and that the compiler enables AVX2 code generation.
