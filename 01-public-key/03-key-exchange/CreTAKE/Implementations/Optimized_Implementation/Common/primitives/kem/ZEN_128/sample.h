...
extern "C"
{
    ...
    /// @brief Sample polynomial coefficients from a centered binomial distribution with parameter 1 using AVX2
    ...
    /// @brief Sample polynomial coefficients from a centered binomial distribution with parameter 2 using AVX2
    /// @param[out] r Base address of output polynomial coefficient array
    /// @param[in] buf Base address of input pseudorandom byte array
    /// @return None
    void cbd2(int16_t *r, const uint8_t *buf);

    /// @brief Sample ternary polynomial coefficients with probability 1/8 of being nonzero using AVX2
    /// @param[out] r Base address of output ternary polynomial coefficient array
    /// @param[in] buf Base address of input pseudorandom byte array
    /// @return None
    void tenary1_8(int16_t *r, const uint8_t *buf);

    /// @brief Sample ternary polynomial coefficients with probability 3/32 of being nonzero using AVX2
    /// @param[out] r Base address of output ternary polynomial coefficient array
    /// @param[in] buf Base address of input pseudorandom byte array
    /// @return None
