...
File Description: Declares the API_PKC KEM interface for the optimized POLARLAC-512 instance.
*/

#ifndef KEM_ALGORITHM_INSTANCE_H
#define KEM_ALGORITHM_INSTANCE_H

/// @brief Control whether the KAT generator prints actual byte lengths.
/// @details Set to 0 to output concrete lengths in the generated KAT file;
///          set to 1 to keep the blank template style required by the NGCC kit.
#define OUTPUT_BLANK_TEST_VECTORS 0

/// @brief Human-readable algorithm instance name used by the KAT tools.
/// @details The string must be at most 64 bytes long and may only contain
///          letters, digits, '-' or '_'.
#define ALGORITHM_INSTANCE "POLARLAC-512-Star"
