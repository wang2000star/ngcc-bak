...
{
#if ETA_E == 1
	poly_binomial_dist1(m, coins, nonce);
#elif ETA_E == 2
	poly_binomial_dist2(m, coins, nonce);
#elif ETA_E == 3
	poly_binomial_dist3(m, coins, nonce);
#elif ETA_E == 4
	poly_binomial_dist4(m, coins, nonce);
#elif ETA_E == 7
	poly_binomial_dist7(m, coins, nonce);
#endif
}
