...
#if defined(_MSC_VER)
#define TriQ_ALIGN32 __declspec(align(32))
#else
#define TriQ_ALIGN32 __attribute__((aligned(32)))
#endif
 ...
 */
static const TriQ_ALIGN32 __m256i mr0 = {0x0100010001000100UL, 0x0100010001000100UL, 0x0100010001000100UL,
                            0x0100010001000100UL}; /**< Replicates the 0x0100 coefficient mask in each 64-bit lane for
                                                      the low-half multiply step. */

static const TriQ_ALIGN32 __m256i lastMask = {
 ...
 */
static const TriQ_ALIGN32 __m256i red[7] = {
...
#ifndef TriQ_GF_C
static inline __m256i gf_mul_vect_inline(__m256i a, __m256i b) {
...
#define gf_mul_vect(a, b) gf_mul_vect_inline((a), (b))
#else
