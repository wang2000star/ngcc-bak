 ...
 */
 ...
 /**
  * @brief Precomputed 256-bit vectors of field elements 伪岬拷?for GF(2^8) operations (first half).
  *
  ...
  * 伪岬拷?power table for the chosen code parameters.
  */
 static const TriQ_ALIGN32 __m256i alpha_ij256_1[63] = {
 ...
 /**
  * @brief Precomputed 256-bit vectors of field elements 伪岬拷?for GF(2^8) operations (second half).
  *
  ...
  */
 static const TriQ_ALIGN32 __m256i alpha_ij256_2[63] = {
  ...
  **/
 static const TriQ_ALIGN32 __m256i param256[3] = {{0x001800ef00d8002d, 0x0028001b006800fd, 0x00d200a30032006b, 0x009e00e0008600e3},
